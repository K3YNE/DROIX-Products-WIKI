---
title: Retroid Pocket 3+ Review – A rival handheld gaming console for the Anbernic RG505?
source_url: "https://droix.net/blogs/retroid-pocket-3-plus-review/"
source_site: droix.net
type: review-blog
date: 2023-01-09
---

In our [Retroid Pocket 3+](https://droix.net/product/retroid-pocket-3-plus/) review we will be comparing it with the recently released Anbernic [RG505](https://droix.net/product/anbernic-rg505/) which has the same processor. Keep reading for unboxing, benchmarks, comparisons and emulator performance of this handheld gaming console.

Contents

[Retroid Pocket 3+ Review Video](#retroid-pocket-3-review-video)

[Unboxing the Retroid Pocket 3+](#unboxing-the-retroid-pocket-3)

[Overview of the Retroid Pocket 3+](#overview-of-the-retroid-pocket-3)

[Retroid Pocket 3+ Technical Specifications](#retroid-pocket-3-technical-specifications)

[Android Overview](#android-overview)

[System Benchmarks and comparison](#system-benchmarks-and-comparison)
...
[Where to buy the Retroid Pocket 3+?](#where-to-buy-the-retroid-pocket-3)
...
We have the [Retroid Pocket 3+](https://droix.net/product/retroid-pocket-3-plus/) handheld which we will show in more detail shortly. And last but not least is a USB Type-C charge cable.

## Overview of the Retroid Pocket 3+

The [Retroid Pocket 3+](https://droix.net/product/retroid-pocket-3-plus/) handheld gaming console is available in several colours, here we have the Clear Purple and Clear Blue models, but it will also be available in 16 Bit and 16 Bit US, Black, Indigo, Retro and Orange colours.
...
Retroid Pocket 3 Plus Bottom View
...
|  |  |
| --- | --- |
| **CPU** | Unisoc [Tiger T618](https://droix.net/product-attribute/processor-cpu-model/tiger-t618/) with 2x A75 @2.0GHz and 6x A55 @2.0GHz |
| **GPU** | [Mali G52 MC2](https://droix.net/product-attribute/graphics-gpu-model/mali-g52-mp2/) @850MHz |
| **RAM** | 4GB [LPDDR4x](https://droix.net/product-attribute/memory-ram-technology/lpddr4x/) @ 850MHz |
| **STORAGE** | 128GB internal eMMC 5.1 Micro SD Card slot for additional storage |
| **COMMUNICATIONS** | WiFi 5 [Bluetooth 5.0](https://www.whathifi.com/advice/bluetooth-5-everything-you-need-to-know) |
...
The [Retroid Pocket 3 Plus](https://droix.net/product/retroid-pocket-3-plus/) retro handheld emulator runs on Android 11 and has a fair number of emulators ready to go, generally they just need pointing to the respective ROM folders on the Micro SD Card.

Retroid Pocket 3 Plus OS and UI
...
The [Retroid Pocket 2+](https://droix.net/product/retroid-pocket-2-plus/) and [Retroid Pocket 3](https://droix.net/product/retroid-pocket-3/) share the same processor so we saw fairly similar scores for them both. The Retroid Pocket 3+ [retro handheld emulator](https://droix.net/blogs/product-category/handhelds/retro-handheld-emulators/) scores an average 115% increase over the previous two models which is very impressive!
...
We can see on the comparison that the Retroid Pocket 3+ benchmark scores are on par with the [Anbernic RG505](https://droix.net/product/anbernic-rg505/) handheld gaming console which shares the same processor. You could run benchmarks on both handhelds again and get better or worse scores than each other. This in my opinion is good to see as it means we could base which handheld to buy on the design, price or features, rather than which has the best performance.

## Emulator Performance

We continue the Retroid Pocket 3+ review with a closer look at the performance of the emulators. As with the [RG505](https://droix.net/product/anbernic-rg505/) the Retroid Pocket 3+ can run up to PlayStation 1 and Dreamcast games with full 60 FPS. This is a good increase compared to say the Retroid Pocket 2+ and 3 which struggled when we got to some Dreamcast and above. So let’s see how much more performance we get from the [Retroid Pocket 3+](https://droix.net/product/retroid-pocket-3-plus/) handheld gaming console.
...
Retroid Pocket 3+running AetherSX2
...
You will get mixed performance depending on the game you are trying whether or not it will be playable. Sonic Generations has shader cache lag the first time you play through the game but the second time around it is more playable on the [Retroid Pocket 3 Plus](https://droix.net/product/retroid-pocket-3-plus/) handheld gaming console. Less demanding games will initially perform better and are playable. Overall the emulator runs well and it’s definitely worth trying some games on it to see which work well or not.
...
As for which you should buy, the [Retroid Pocket 3+](https://droix.net/product/retroid-pocket-3-plus/) or [RG505 from Anbernic](https://droix.net/product/anbernic-rg505/), I will leave that decision up to you. They perform equally so it does come down to the design, features, price difference etc.

## Where to buy the Retroid Pocket 3+?

Talking about price, how does a discount on the Pocket 3+ sound? Use the discount **RP3P5OFF** on the Checkout when you [buy the Retroid Pocket 3+ here](https://droix.net/product/retroid-pocket-3-plus/). You can find our range of [retro handheld emulators here](https://droix.net/blogs/product-category/handhelds/retro-handheld-emulators/).

[BUY RETROID POCKET 3+ HERE](https://droix.net/product/retroid-pocket-3-plus/)
