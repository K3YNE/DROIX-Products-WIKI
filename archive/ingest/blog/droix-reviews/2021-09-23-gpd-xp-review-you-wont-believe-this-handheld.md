---
title: GPD XP Review – You won’t BELIEVE this handheld…
source_url: "https://droix.net/blogs/gpd-xp-review/"
source_site: droix.net
type: review-blog
date: 2021-09-23
---

In our [GPD XP](https://go.droix.co.uk/GPD-XP) review we take a look at the Android game and retro gaming handheld with an unboxing and overview. We then follow it up with some gameplay and emulator tests. We will have a pre-order page for the GPD XP soon!

Contents

[GPD XP Review Video](#gpd-xp-review-video)

[GPD XP Review](#gpd-xp-review)

[GPD XP Overview](#gpd-xp-overview)

[Modular Controllers](#modular-controllers)

[GPD XP Review: Technical Specifications](#gpd-xp-review-technical-specifications)
...
[Emulators Testing](#emulators-testing)
...
[GPD XP Review Summary](#gpd-xp-review-summary)

[Where to buy the GPD XP](#where-to-buy-the-gpd-xp)
...
Inside the box we have the GPD XP which we will show in more detail shortly. Next we have a user guide which is in Chinese and English. There is a [USB Type-C](https://en.wikipedia.org/wiki/USB-C) Charge cable.
...
The [GPD XP](https://go.droix.co.uk/GPD-XP) measures 9.17 x 3.2 x 1.6 inches (23.3 cm 8.3 cm 4.1 cm) at its largest thickness, including the grip. It weighs 370 grams with the Xbox style controller attachment.
...
As mentioned above, the [GPD XP](https://go.droix.co.uk/) comes with two controller addons which magnetically attach to the GPD XP.

The controller addons are very securely held in place on the GPD XP with magnets

They are very securely held in place and while gaming you won’t have any issues with them disconnecting or falling out.

The second controller addon
...
The third part is an end cap if you do not wish to use a controller

There is also a cap type part which can be used if you do not want to use one of the controllers.

## GPD XP Review: Technical Specifications
...
|  |  |
| --- | --- |
| **CPU** | MediaTek Helio G95, 8 cores. *(2×ARM Cortex-A76 @2050MHz + 6×ARM Cortex-A55 @2000MHz)* |
| **GPU** | ARM Mali-G76 MC4 @900MHz |
| **RAM** | 6GB LPDDR4x |
| **Storage** | 128GB UFS2.1 |
| **SD Card** | Yes (microSD, microSDHC, microSDXC) |
| **Storage Expansion** | Up to 2TB (microSDXC) |
| **Cooling** | Active cooling; single-fan |
| **Speaker** | AAC Stereo dual speaker |
| **Camera** | Single lens Front-facing 5.0 megapixels |
| **Interfaces** | 1x USB-C 1x 3.5mm microphone/headphone jack |
...
|  |  |
| --- | --- |
| **Type** | OGS capacitive touch screen (Supports up to 10 points of touch) Gorilla Glass 5 TFT LCD |
| **Size** | 6.81 Inches |
| **Resolution** | 1080x2400p |
...
|  |  |
| --- | --- |
| **SIM Support** | Yes (Nano-SIM) |
| **4G** | Data-only TD-LTE (CMCC), FDD-LTE (China Unicom, China Telecom) |
| **3G/2G** | Data-only China Unicom 3G (WCDMA), China Unicom 2G/CMCC 2G (GSM) |
| **Frequencies** | 2G: GSM B3/8  3G: WCDMA B1  4G: TDD-LTE B34/38/39/40/41  4G: FDD-LTE B1/2/3/5/7/8/12/17/20/26/28 |
| **Dual SIM** | Yes (2x Nano-SIM OR 1x Nano-SIM + 1x microSD) |
| **Wi-Fi** | 2.4/5Ghz Dual-Band IEEE 802.11 a/b/g/n/ac (Wi-Fi 5) |
| **Bluetooth** | Yes (5.0) |
| **GPS** | Yes (GPS, A-GPS technology, GLONASS, Beidou Navigation, Galileo) |
| **Hotspot** | Yes |
...
CSR 2 using gamepad to screen mapping
...
For more recent gaming consoles the GPD XP does a great job. The [Dreamcast](https://sega.fandom.com/wiki/Dreamcast) emulator blazes along at a full 60FPS on all the games I have tried. And forcing compatible games to widescreen ratio makes them look amazing on the display!

GPD XP Dreamcast emulation
...
We hope you have found our GPD XP review useful. You can learn more and [order the GPD XP here](https://go.droix.co.uk/GPD-XP). And browse the range of other great [GPD products here](https://go.droix.co.uk/GPD).

[BUY NOW](https://go.droix.co.uk/GPD-XP)