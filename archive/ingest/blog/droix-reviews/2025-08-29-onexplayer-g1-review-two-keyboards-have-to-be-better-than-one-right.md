---
title: ONEXPLAYER G1 Review  – Two keyboards have to be better than one, right?
source_url: "https://droix.net/blogs/onexplayer-g1-review/"
source_site: droix.net
type: review-blog
date: 2025-08-29
---

Why have one keyboard when you can have two? The [ONEXPLAYER](https://droix.net/product-attribute/brands/onexplayer/) G1 features a built-in touchpad style keyboard and a detachable keyboard. Lets find just what the point of it is in our ONEXPLAYER G1 review.

Contents

[ONEXPLAYER G1 Review Video](#onexplayer-g1-review-video)

[ONEXPLAYER G1 Overview](#onexplayer-g1-overview)

[ONEXPLAYER G1 Detachable Keyboard](#onexplayer-g1-detachable-keyboard)
...
[Tony Hawks Pro Skater 3+4](#tony-hawks-pro-skater-34)

[Elder Scrolls IV Oblivion Remastered](#elder-scrolls-iv-oblivion-remastered)
...
ONEXPLAYER G1 Closed



ONEXPLAYER G1 Display
...
ONEXPLAYER G1 Left View



ONEXPLAYER G1 Right View



ONEXPLAYER G1 Back View
...
ONEXPLAYER G1 Detachable Keyboard Installed
...
|  |  |
| --- | --- |
| **DISPLAY** | 8.8″ LTPS, 2560×1600, [144Hz](https://droix.net/product-attribute/refresh-rate/144hz/), [16:10](https://droix.net/product-attribute/aspect-ratio/1610/) Brightness: 500Cd/m2(typ) Colour gamut coverage: DCI-P3 97% Contrast: 1500:1 |
| **CPU** | AMD [Ryzen AI 9 HX 370](https://droix.net/product-attribute/processor-cpu-model/ryzen-ai-9-hx-370/) AMD [Ryzen 7 8840U](https://droix.net/product-attribute/processor-cpu-model/amd-ryzen-7-8840u/) Intel Ultra 7 255H |
| **GPU** | AMD [Radeon 890M](https://droix.net/product-attribute/graphics-gpu-model/radeon-890m/) AMD [Radeon 780M](https://droix.net/product-attribute/graphics-gpu-model/radeon-780m/) Intel Arc |
| **RAM** | 32GB/64GB [LPDDR5x](https://droix.net/product-attribute/memory-ram-technology/lpddr5x/) RAM |
| **STORAGE** | 1TB/2TB/4TB M.2 2280 [NVMe PCIe 4.0×4](https://droix.net/product-attribute/storage-technology/nvme-pci-e-gen-4-0/) SSD |
...
| **BATTERY** | 51.975Wh, 13500mAh rechargeable battery |
...
The [AMD](https://droix.net/product-attribute/processor-cpu-brand/amd/) GPUs show its power over [Intel](https://droix.net/product-attribute/processor-cpu-brand/intel/) in actual game performance, with both the HX 370 and 8840U outperforming the Intel 255H model. Even on lower TDP we do not see any changes in position.
...
Claire Obscure on the ONEXPLAYER G1



Tony Hawks Pro Skater on the ONEXPLAYER G1
...
Elder Scrolls IV on the ONEXPLAYER G1



Atomfall on the ONEXPLAYER G1
...
I do find the ONEXPLAYER G1 a little hard to recommend over other devices. The [ONEXPLAYER F1 Pro](https://droix.net/product/onexplayer-onexfly-f1-pro/) and X1 Pro for example, offer far greater comfort and slightly higher performance. And have a choice of keyboard or not. Perhaps you should consider these instead, if like me, you are undecided if you want a usable keyboard or a handheld without one.

While we do not sell the ONEXPLAYER G1, we do sell the [ONEXPLAYER F1 Pro](https://droix.net/product/onexplayer-onexfly-f1-pro/) and a wide variety of [handheld gaming PCs](https://droix.net/product-category/gaming-handheld/handheld-gaming-pcs/) suitable for all requirements.