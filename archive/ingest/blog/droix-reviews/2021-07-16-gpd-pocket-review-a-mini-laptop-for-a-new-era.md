---
title: GPD Pocket Review – A Mini Laptop for a New Era
source_url: "https://droix.net/blogs/gpd-pocket-a-review-of-a-mini-laptop-for-a-new-era/"
source_site: droix.net
type: review-blog
date: 2021-07-16
---

Welcome to our GPD Pocket review! If you’re interested in a [Mini Laptop](https://go.droix.co.uk/MINI-LAPTOPS) of your own. You can [buy a GPD Pocket here.](https://go.droix.co.uk/GPD-POCKET)

Contents

[GPD Pocket Review Video](#gpd-pocket-review-video)

[About The GPD Pocket](#about-the-gpd-pocket)

[GPD Pocket Technical Specifications](#gpd-pocket-technical-specifications)

[GPD Pocket build and design](#gpd-pocket-build-and-design)

[GPD Pocket touch screen](#gpd-pocket-touch-screen)

[GPD Pocket keyboard and navigation](#gpd-pocket-keyboard-and-navigation)

[GPD Pocket ports](#gpd-pocket-ports)

[GPD Pocket Audio](#gpd-pocket-audio)

[GPD Pocket performance and battery](#gpd-pocket-performance-and-battery)

[Conclusion: GPD Pocket may be a novelty, but it is impressive](#conclusion-gpd-pocket-may-be-a-novelty-but-it-is-impressive)
...
It should come as no surprise that the GPD Pocket packs only an Intel Atom processor. With a base speed of 1.6GHz and a resolution of up to 2.56GHz, it’s not very fast compared to an Ultrabook laptop, but it handles Windows 10 just fine, especially for this form factor. While Intel does not support older Atom processors (circa 2012) with Windows 10, the [Intel Atom x7-Z8750 processor](https://ark.intel.com/content/www/us/en/ark/products/93362/intel-atom-x7-z8750-processor-2m-cache-up-to-2-56-ghz.html) was only released in Q1 2016 and is supported for later Windows 10 updates.
...
[IPS display technology](https://www.viewsonic.com/library/photography/what-is-an-ips-monitor-panel/) is used in high-end laptops and desktops and guarantees excellent viewing angles, sharp colours and no opacity. Colour accuracy is high and text is very sharp and easy to read, even if you are still looking at a 7-inch screen as a laptop and not as a smartphone.
...
If you were expecting to pick up the [GPD Pocket](https://go.droix.co.uk/GPD-POCKET) to unpack papers or write long emails using the built-in keyboard, you would be disappointed.
...
Finally, keep an eye on the [GPD](https://go.droix.co.uk/GPD). The company is clearly moving into new territory by taking risks, but they also have the courage to make quality hardware. I can’t wait to see what they do next.

You can [buy a GPD Pocket here](https://go.droix.co.uk/GPD-POCKET) and browse our range of [Mini Laptop](https://go.droix.co.uk/MINI-LAPTOPS) here.

[BUY NOW](https://go.droix.co.uk/GPD-POCKET)