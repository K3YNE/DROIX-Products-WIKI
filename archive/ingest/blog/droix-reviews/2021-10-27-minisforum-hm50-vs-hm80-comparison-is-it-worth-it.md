---
title: MinisForum HM50 vs HM80 Comparison – Is it worth it?
source_url: "https://droix.net/blogs/minisforum-hm50-vs-hm80/"
source_site: droix.net
type: review-blog
date: 2021-10-27
---

Today we are checking out the [MinisForum HM50](https://go.droix.co.uk/MINISFORUM-HM50) Ryzen 5 and [MinisForum HM80](https://droix.net/product-category/mini-pcs/) Ryzen 7 mini PC’s. We will be unboxing it and taking a look at the features. Then running some system and gaming benchmarks to see their performance and compare the results. In this test between the MinisForum HM50 vs the HM80, we’ll find out if it’s **really** worth the upgrade.

Contents

[MinisForum HM50 vs HM80 Comparison Video](#minisforum-hm50-vs-hm80-comparison-video)

[MinisForum HM80 Unboxing](#minisforum-hm80-unboxing)

[MinisForum HM50 Overview](#minisforum-hm50-overview)

[Inside the MinisForum HM80](#inside-the-minisforum-hm80)

[MinisForum HM50 and HM80 Technical Specifications](#minisforum-hm50-and-hm80-technical-specifications)
...
[MinisForum HM50 vs HM80 Gaming Benchmarks](#minisforum-hm50-vs-hm80-gaming-benchmarks)
...
[MinisForum HM50 vs HM80: Which one should I buy?](#minisforum-hm50-vs-hm80-which-one-should-i-buy)

[Where to buy the MinisForum HM50 & HM80](#where-to-buy-the-minisforum-hm50-amp-hm80)
...
HM80 Mini PC Dimensions and Front View

On the back are four USB 3 ports. Beside those are two ethernet ports, one is 2.5 gigabit and the second is 1 gigabit. There are both [HDMI](https://www.hdmi.org/spec/index) and DisplayPort which can be used together for dual monitor display. And there is a second USB Type-C port which is used for the power.

HM80 Mini Computer Back View
...
Inside the MinisForum HM80 mini PC
...
MinisForum HM50 & HM80 Technical Specifications

A quick note that you can use the discount code **MINIS5** for 5% off any [MinisForum EliteForum Mini PC](https://droix.net/blogs/brand/minisforum/) on our store. We are based in the UK and ship and support from there.
...
The [MinisForum HM50 mini PC](https://go.droix.co.uk/MINISFORUM-HM50) scores 4,559

MinisForum HM50 PassMark Score

The [MinisForum HM80 mini computer](https://go.droix.co.uk/MINISFORUM-HM80) scores 4,699

MinisForum HM80 PassMark Score
...
MinisForum HM50 PC Mark Score

The HM80 scores 5,413.

MinisForum HM80 PC Mark Score
...
3DMark Scores for EliteMini HM50

And the MinisForum HM80 scores 1,361

3DMark Scores for EliteMini HM80
...
Although not a dedicated [gaming mini PC](https://go.droix.co.uk/GAMING-MINI-PC), the HM50 and HM80 can play Windows games with good results. For these tests we are running the games on the highest settings to stress the CPU and GPU, normally you would run them at lower settings.

### Forza Horizon 4

We start the gaming benchmarks with Forza Horizon 4 running at 1280×720 on the Ultra graphics settings.

The [MinisForum HM50](https://go.droix.co.uk/MINISFORUM-HM50) has an average 39 FPS at the end of the benchmark

MinisForum HM50 Forza Horizon 4 Benchmark Results

The [MinisForum HM80](https://go.droix.co.uk/MINISFORUM-HM80) has an average of 43 FPS.

MinisForum HM80 Forza Horizon 4 Benchmark Results
...
The [HM50](https://go.droix.co.uk/MINISFORUM-HM50) scores 51 FPS on Lowest settings, and 25 FPS on the Highest. And the [HM80](https://go.droix.co.uk/MINISFORUM-HM80) scores 53 FPS on Lowest settings, and 28 FPS on the Highest.

That’s around a 3.8 % difference for the Lowest and 11.3 % for the highest.

EliteMini HM80 Lowest Highest graphics settings FPS
...
That wraps up this MinisForum HM50 and HM80 review and comparison article, we hope you have found it useful. You can learn more and [buy the MinisForum HM50 here](https://go.droix.co.uk/MINISFORUM-HM50), and [buy the MinisForum HM80 here](https://go.droix.co.uk/MINISFORUM-HM80). You can browse the [range of MinisForum PC’s here](https://go.droix.co.uk/MINISFORUM).

[BUY NOW](https://go.droix.co.uk/MINISFORUM-HM80)