---
title: ONEXPLAYER Mini Gundam Review – Intel i7-1260P special edition gaming handheld
source_url: "https://droix.net/blogs/onexplayer-mini-gundam-review/"
source_site: droix.net
type: review-blog
date: 2022-06-02
---

Today we are checking out something quite special. It is a limited edition ONEXPLAYER Mini Gundam edition which is only available to [buy in China](https://go.droix.co.uk/Mj3OR1) due to licensing. As well as the amazing design it also features the brand new Intel i7-1260P processor. How does it perform, let’s find out?

Contents

[ONEXPLAYER Mini Gundam Review Video](#onexplayer-mini-gundam-review-video)

[Unboxing the ONEXPLAYER Mini Gundam Edition](#unboxing-the-onexplayer-mini-gundam-edition)

[ONEXPLAYER Mini Gundam Overview](#onexplayer-mini-gundam-overview)

[ONEXPLAYER Mini Gundam Technical Specifications](#onexplayer-mini-gundam-technical-specifications)
...
[Where to buy the ONEXPLAYER Mini Gundam Edition?](#where-to-buy-the-onexplayer-mini-gundam-edition)
...
ONEXPLAYER Mini Gundam Unboxed

And we have the [ONEXPLAYER Mini Gundam edition](https://go.droix.co.uk/Mj3OR1) in all its glory. We will take a closer look at it shortly.
...
ONEXPLAYER Mini Gundam unboxing

## ONEXPLAYER Mini Gundam Overview

The Gundam edition is based on the [ONEXPLAYER Mini](https://droix.net/product/onexplayer-mini/) and apart from the Gundam theme there are no other changes to the physical design.

ONEXPLAYER Mini Gundam Front
...
ONEXPLAYER Mini Gundam PassMark Result
...
ONEXPLAYER Mini Gundam PCMark Result
...
ONEXPLAYER Mini Gundam Forza Horizon 5 Benchmark Result

We get frames per second of 44, 64 and 68. For an intel based device they are good scores. Compared with the [ONEXPLAYER 1S](https://droix.net/product/onexplayer-1s/) with 1195G7 processor, it is faster at 11W, slower at 20W and faster at 35W.
...
ONEXPLAYER Mini Gundam Street Fighter V Benchmark Results
...
ONEXPLAYER Mini Gundam Final Fantasy XIV
...
11W TDP Benchmark Results and Handheld Comparison

At 11W the Mini Gundam does the best on 3DMark with the highest score we have for all our handheld benchmarks. It is the fastest Intel based processor for Forza Horizon 5, though the [AMD models](https://droix.net/blogs/brand/amd/) are still quite far in front . It is the outright fastest on Street Fighter V and Final Fantasy XIV benchmarks.

20W TDP Benchmark Results and Handheld Comparison

At 20W the Gundam model keeps the pace going with the highest scores on 3DMark, Street Fighter V and Final Fantasy XIV.

35W TDP Benchmark Results and Handheld Comparison

And at 35W it is again the fastest on the 3DMark, Street Fighter V and Final Fantasy XIV benchmarks.

There are a few discrepancies that we noticed such as lower frame rates on some benchmarks compared to the [ONEXPLAYER Mini](https://droix.net/product/onexplayer-mini/) with 1195G7 processor. This may be due to drivers or hardware differences. It could be how the TDP and processor work with some games. For example requiring more CPU than GPU processing, or vice versa.

Overall the ONEXPLAYER Mini Gundam is very impressive, with better if not similar scores to its 1195G7 equivalent. I do think we could see improvements on the Intel drivers for this fairly new processor which could speed things up a little. It gives us a great indication of how the 12th generation [Intel processors](https://www.intel.co.uk/) will perform in the future. Let’s hope that it’s not long before we see a new model!.
...
OutRun on PS2 emulator

### PSP

God of War on PSP emulator PPSSPP
...
Wipeout HD on PS3 emulator RPCS3
...
ONEXPLAYER Mini Gundam running RyuJinx and Crusin Blast

## Where to buy the ONEXPLAYER Mini Gundam Edition?

Unfortunately it is not licensed for sale outside China so we are not able to sell this model at DroiX. But you can order one [from here](https://go.droix.co.uk/Mj3OR1) if you are interested in buying one.

Alternatively you can browse and [buy our range of ONEXPLAYER models](https://droix.net/blogs/brand/onexplayer/) of which have similar or better performance then the Gundam edition.