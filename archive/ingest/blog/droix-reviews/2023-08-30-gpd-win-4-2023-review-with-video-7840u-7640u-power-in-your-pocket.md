---
title: GPD WIN 4 2023 Review with video – 7840U & 7640U power in your pocket!
source_url: "https://droix.net/blogs/gpd-win-4-2023-review-with-video/"
source_site: droix.net
type: review-blog
date: 2023-08-30
---

The GPD WIN 4 has a new revised model with Ryzen 7 and 5 7000 series processors as well as an Oculink port. In our [GPD WIN 4 2023](https://droix.net/product/gpd-win-4-2023/) review we will unbox them, have an overview of the features and compare some system and gaming benchmarks.

Contents

[GPD WIN 4 2023 Review Video](#gpd-win-4-2023-review-video)

[Unboxing the GPD WIN 4 2023](#unboxing-the-gpd-win-4-2023)

[Overview of the GPD WIN 4 2023](#overview-of-the-gpd-win-4-2023)

[GPD WIN 4 2023 Technical Specifications](#gpd-win-4-2023-technical-specifications)

[System & Game Benchmarks](#system-amp-game-benchmarks)
...
GPD WIN 4 2023 Review Unboxing
...
The [GPD WIN 4 2023](https://droix.net/product/gpd-win-4-2023/) is essentially the same visual design as the original model. It measures around 8.6 x 3.6 x 1.1 inches (20 x 9.2 x 2.8 cm) and weighs around 598g.

GPD WIN 4 2023 Dimensions
...
GPD WIN 4 2023 Keyboard

On either side of the [handheld gaming PC](https://droix.net/product-category/handhelds/handheld-gaming-pcs/) are the analogue sticks, D-Pad and gaming buttons. And at the bottom you have Select and Start buttons and a thumb sized sensor for mouse control.
...
|  |  |  |
| --- | --- | --- |
|  | **AMD Ryzen 7 7840U** | **AMD Ryzen 7640U** |
| **CPU** | [AMD Ryzen 7 7840U](https://www.amd.com/en/products/apu/amd-ryzen-7-7840u), ZEN 4, 8 cores 16 threads. Base clock 3.3Ghz, Boost Clock 5.1GHz, up to 30W TDP. | [AMD Ryzen 5 7640U,](https://droix.net/product-attribute/processor-cpu-model/ryzen-5-7640u/) ZEN 4, 6 cores 12 threads. Base clock 3.5Ghz, Boost Clock 4.9GHz, up to 30W TDP. |
| **GPU** | [AMD Radeon 780M](https://droix.net/product-attribute/graphics-gpu-model/radeon-780m/) | [AMD Radeon 760M](https://droix.net/product-attribute/graphics-gpu-model/amd-radeon-760m/) |
| **RAM** | 32GB / 64GB [LPDDR5x](https://semiconductor.samsung.com/dram/lpddr/lpddr5x/) 6400 MT/s | 16GB LPDDR5x 6400 MT/s |
| **STORAGE** | Up to 4TB M.2 NVME 2280 SSD | 512GB M.2 [NVME](https://en.wikipedia.org/wiki/NVM_Express) 2280 SSD |

There are two models of [GPD WIN 4 2023](https://droix.net/product/gpd-win-4-2023/). First we have the Ryzen 7 7840U with 780M graphics, and a choice of 32 or 64GB LPDDR5x RAM at 6400 MT/s. There is also the Ryzen 5 7640U with 760M and just the 16GB of LPDDR5x RAM also at 6400MT/s.
...
As part of our GPD WIN 4 2023 review we are running some system and gaming benchmarks. For both models we are using the [GPD](https://droix.net/product-attribute/brands/gpd/) supplied graphics drivers due to AMD still not releasing properly working drivers. As a result we will not be comparing with other devices until official drivers are released and we can benchmark them all equally.
...
Cyberpunk 2077 Benchmark results comparison
...
Our penultimate benchmark is Call of Duty: Modern Warfare 2 running on the Minimum graphics settings.

COD MW2 Benchmark results comparison

At 1080P we get around a 13.5% difference in performance between the two models. And at 720P we saw a 17% difference.
...
Street Fighter 6 Benchmark results comparison
...
With the revised 2023 model we also see the same pros and cons. As mentioned, we won’t be directly comparing benchmark scores with other devices as there’s no official drivers released. But in our initial tests we did see very comparable results with the [GPD WIN MAX 2 2023](https://droix.net/product/gpd-win-max-2-2023/), [AOKZOE A1 Pro](https://droix.net/product/aokzoe-a1-pro/) and [AYA NEO 2S](https://droix.net/product/aya-neo-2s/). Some scores were higher, some lower and some in between. Overall the GPD WIN 4 2023 is up there in terms of performance.

We will be covering Oculink and the [GPD G1 eGPU docking station](https://droix.net/product/gpd-g1/) performance in a separate video. We wanted to benchmark with the GPD supplied drivers before updating graphics drivers to support the GPD G1. Keep an eye out for that video as we will be able to compare performance with the GPD WIN MAX 2 2023 to see how they perform. The GPD G1 is a game changer, the massive jump in performance it provides is well worth considering if you buy a device with Oculink port.
...
Yuzu emulator runs great

If you are upgrading from any 6800U model then go for the Ryzen 7 for a noticeable performance increase. The Ryzen 5 is not worth it unless you plan to use it with the G1, see our [GPD G1 eGPU docking station review here](https://droix.net/blogs/gpd-g1-egpu-docking-station-review/). If you are new to handhelds then either model is worth considering depending on your budget. You have the Oculink port waiting if you do want to increase performance later.

You can learn more and [order your GPD WIN 4 2023 here](https://droix.net/product/gpd-win-4-2023/). Use the discount code WIN45OFF for a 5% discount. The code will be valid for one month and can not be used during store sales or promotions.

[BUY GPD WIN 4 2023 HERE](https://droix.net/product/gpd-win-4-2023/)
...
Check out our Getting started with the [GPD WIN 4 2023 guide here](https://droix.net/knowledge-base/article/getting-started-with-the-gpd-win-4-2023/) for all you need to know on setting up and using your gaming handheld.
