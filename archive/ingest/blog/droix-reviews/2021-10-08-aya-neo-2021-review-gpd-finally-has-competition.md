---
title: AYA NEO 2021 Review – GPD finally has competition!
source_url: "https://droix.net/blogs/aya-neo-2021-review/"
source_site: droix.net
type: review-blog
date: 2021-10-08
---

Today we are checking out the eagerly awaited revision of earlier this year’s [AYA NEO](https://go.droix.co.uk/AYANEO-2021). In our AYA NEO 2021 review we will be unboxing it, taking a look at the handheld gaming PC features and comparing the updates to the original model. Then we will run some system and gaming benchmarks to compare it with the latest i7-1195G7 [GPD Win 3,](https://go.droix.co.uk/GPD-WIN-3) [Win MAX 2021](https://go.droix.co.uk/GPD-WIN-MAX-2021) and [ONEXPLAYER 1S](https://go.droix.co.uk/ONEXPLAYER-1S) models.

Contents

[AYA NEO Review Video](#aya-neo-review-video)

[AYA NEO Review](#aya-neo-review)

[AYA NEO Overview](#aya-neo-overview)

[AYA NEO Technical Specifications](#aya-neo-technical-specifications)

[AYA NEO Comparison](#aya-neo-comparison)

[AYA NEO System Benchmarks](#aya-neo-system-benchmarks)
...
[AYA NEO Gaming Benchmarks](#aya-neo-gaming-benchmarks)
...
[AYA NEO Benchmark Results](#aya-neo-benchmark-results)

[Summary](#summary)

[Where to buy the AYA NEO](#where-to-buy-the-aya-neo)

[AYA NEO FAQ – Everything You Need To Know So Far](#aya-neo-faq-everything-you-need-to-know-so-far)

[What is the AYA NEO?](#what-is-the-aya-neo)

[AYA NEO 2021 Technical Specifications](#aya-neo-2021-technical-specifications)

[AYA NEO Peformance](#aya-neo-peformance)

[AYA NEO’s Design](#aya-neos-design)

[Screen Size](#screen-size)

[Is there an AYA NEO Hardware Revision (AYA NEO 2021)?](#is-there-an-aya-neo-hardware-revision-aya-neo-2021)

[Is the AYA NEO Pro real?](#is-the-aya-neo-pro-real)

[When is the AYA NEO release date?](#when-is-the-aya-neo-release-date)

[What is the AYA NEO’s Price?](#what-is-the-aya-neos-price)

[Aya Neo Preview – What to expect on this handheld gaming PC](#aya-neo-preview-what-to-expect-on-this-handheld-gaming-pc)

[Aya Neo Technical Specifications](#aya-neo-technical-specifications)

[Overview](#overview)

[Improvements to the new Aya Neo model](#improvements-to-the-new-aya-neo-model)

[Gameplay](#gameplay)

[Aya Neo Release Date](#aya-neo-release-date)

[Where to buy Aya Neo?](#where-to-buy-aya-neo)
...
And last but not least are two [USB Type-C](https://en.wikipedia.org/wiki/USB-C) to USB Type-A converters which you can use to connect peripherals to such as a keyboard and mouse.
...
Let’s take a brief look at the tech specs and differences between the original and new [AYA NEO](https://go.droix.co.uk/AYANEO-2021).
...
We are running the benchmarks at the AYA NEO’s default [TDP](https://en.wikipedia.org/wiki/Thermal_design_power) which is 15W. We will be showing the 20W scores further in our AYA NEO review in order to compare to the GPD and ONEXPLAYER which are default 20W.
...
The [AYA NEO](https://go.droix.co.uk/AYANEO-2021) scores 4,451 with around average scores on the tests and an above average on the storage speed. Overall they are good scores, above the i7 models.
...
Lets first have a reminder of the benchmark results. The scores for the default 15W TDP are shown, as well as the tests for 20W to keep more in line with the [GPD](https://go.droix.co.uk/GPD) and ONEXPLAYER devices.
...
Comparing the scores, we can see that the [ONEXPLAYER 1S](https://go.droix.co.uk/ONEXPLAYER-1S) still remains overall the best performing device at 20W.
...
I like the AYA NEO a lot, it feels very comfortable to handle and play games on, And it is not too heavy when holding it unaided, for example resting on your lap or table. The screen size is also just right, large enough to be able to see smaller text. [Aya](https://go.droix.co.uk/AYANEO) have done a great job with the Neo and we can’t wait to see how the [AYA NEO Pro](https://go.droix.co.uk/AYANEO-2021-PRO) model with faster processor performs.
...
You can learn more and [buy the AYA NEO here](https://go.droix.co.uk/AYANEO-2021), or you can browse our range of [gaming handhelds](https://go.droix.co.uk/GAMING-HANDHELD) here.

[BUY NOW](https://droix.net/product/aya-neo/)

---

## AYA NEO FAQ – Everything You Need To Know So Far

*Originally Posted by [benjamin](https://droix.net/blogs/author/benjamin/) on: 28/07/21*

Welcome to our FAQ for the [AYA NEO](https://go.droix.co.uk/AYANEO-2021). Here we’ll compile everything **you** need to know about this up-and-coming ryzen handheld, where to buy it, and more!

### What is the AYA NEO?

The AYA NEO is an up-and-coming [gaming handheld](https://go.droix.co.uk/GAMING-HANDHELD) that was [successfully crowdfunded in April 2021](https://www.indiegogo.com/projects/ayaneo-world-s-first-7nm-handheld-gaming-device#/), totalling up at an impressive 1,576,992 GBP.
...
The market for [handheld gaming PCs](https://go.droix.co.uk/HANDHELD-GAMING-PC) that can play AAA games is still a relatively untapped one, so right now the space is ripe for innovation and new developments.
...
| Ports | 3x USB 3.2 Gen 2 Type-C 3.5mm Headphone Jack |
| Speakers | 2x Stereo Speakers |
| Sensors | Built-in Gyroscope Built-in Accelerometer |
| Screen | Capacitive touchscreen 7-inch 1280x800p H-IPS 215ppi |
| Battery | 3x 4100mAh |
| Adapter | 65W PD |
| Leds | 1x Charging Indicator |
| Game Controls | Clickable (L3/R3) analogue sticks Built-in rumble D-Pad w/ independent buttons Face buttons (A/B/X/Y) Bumpers/Triggers (L1/R1, L2/R2) |
| Weight | 650g approx. |
...
The AYA NEO is powered by an [AMD Ryzen 5 4500U](https://www.amd.com/en/products/apu/amd-ryzen-5-4500u). A Ryzen series mobile processor that “officially” launched in June 2020 (but as with most “official” launches of hardware, it usually takes some time for them to worm their way into the market).
...
There are also rumours that there is a [Ryzen 7 4800U](https://www.amd.com/en/products/apu/amd-ryzen-7-4800u) version in the works, but this is currently unconfirmed.
...
The NVMe SSD – while nothing new to the world of windows [gaming handhelds](https://go.droix.co.uk/GAMING-HANDHELD) – is still a welcome addition as well, as this boosts the load times across the device in general.
...
Like many of the [Switch] inspired [gaming handhelds](https://go.droix.co.uk/GAMING-HANDHELD) currently, the AYA NEO’s design is fundamentally no different from its contemporaries.
...
The 7-inch display is what sets it apart from its most immediate counterpart, the [GPD Win 3](https://go.droix.co.uk/GPD-WIN-3). This does mean that the AYA NEO is slightly larger, but still ultimately very portable. It is also approximately 100g heavier.
...
For the full details on the AYA NEO 2021 Pro, check out our blog post covering the [AYA NEO 2021’s announcement](https://go.droix.co.uk/AYANEO-2021-PRO). See below for a small table outlining the difference between the various AYA NEO models too:
...
Currently, you can [purchase the AYA NEO for £849.95 from DroiX](https://go.droix.co.uk/AYANEO-2021). This will be shipped from the United Kingdom and features a 30-day returns window and a free 1 year warranty.
...
*Originally posted by [DaveC](https://droix.net/blogs/author/david-cole/) on: 17/08/2021*
...
The Aya Neo has the AMD Ryzen 5 4500U processor with Radeon Graphics, which we reviewed in our recent [ASUS PN50 benchmark blog post](https://go.droix.co.uk/ASUS-PN50-BENCHMARK). It is a decent processor, and after some benchmarking we saw very respectable scores across the system and gaming tests.

The amount of RAM and storage space is what you would expect to see in a [gaming handheld](https://go.droix.co.uk/GAMING-HANDHELD) PC. 16GB is plenty for Windows 10 and games to run with no issues. We would recommend the 1TB storage as this will leave you plenty of space for many large AAA games.

### Overview

Aya Neo Size

The Aya Neo AMD windows gaming handheld measures approximately 10.03 x 4.17 x 0.78 inches (25.5cm x 10.6cm x 2cm) and weighs 650g. This puts it in the middle in terms of size, with the larger [ONEXPLAYER](https://go.droix.co.uk/ONEXPLAYER-1S) and smaller [GPD Win 3](https://go.droix.co.uk/GPD-WIN-3).
...
We start off with [Shadow of the Tomb Raider](https://tombraider.square-enix-games.com/) which looks and runs great. We are using a mix of settings for the best performance versus visuals.
