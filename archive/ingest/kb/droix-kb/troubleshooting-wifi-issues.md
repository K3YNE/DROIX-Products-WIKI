...
source_url: "https://droix.net/knowledge-base/article/troubleshooting-wifi-issues/"
...
In order to test the internet download/upload speed and ping, you can use the [Speedtest](https://play.google.com/store/apps/details?id=org.zwanoo.android.speedtest) app which can be downloaded from the [Google Play Store](https://droix.net/first-run-of-googles-play-store/). You can then cross compare or use another device as a comparison.
...
Besides the speeds, you can use a [WiFi analyzer app](https://play.google.com/store/apps/details?id=com.farproc.wifi.analyzer) to check the signal strength and based on that move the device into better position to get a stronger signal.
...
This is a method that can be done through the Android menu or through recovery menu. It will wipe the device back to a clean slate, this is the first method to use in order to resolve the issue and usually this fixes the problem. You can follow our guide [here](https://droix.net/accessing-your-droidboxs-recovery-menu/) to do this.

**2. Replacing the firmware (SD card based method)**

This method (depending on the device) will replace the firmware or install a new instance of it based on the firmware release that you had on the device and that is currently available (most recent). Firmware’s can be obtained through our [forum](https://www.droidboxforums.com/), each device has its own category or if there is no guide on the forum at the moment by contacting us through the support@droix.net email provided.
...
Check on the [forum](https://www.droidboxforums.com/) to see if you device has a firmware available.

If the specific device has only one procedure offered or does not display any feel free to contact us on support@droix.net and we will be able to advise you accordingly. In order for us to easier resolve your request please make sure that inside email you provide clear description of the issue, your order ID so we can locate your order and what has been tried so far as a possible solution. By knowing this we will be able to resolve your request as soon as possible and you will be able use your device again in no time.