---
title: GPD WIN 3/4 Hardshell Case
source_url: "https://gpdstore.net/product/gpd-win-3-4-hardshell-case"
...
* **Official** GPD Protective case for GPD Win 3/4
* **Durable** external synthetic polymer shell
* Soft fabric lining for **added protection**.
* **Separate mesh compartment** for peripherals.
* Sleek design with secure zipper closure.
