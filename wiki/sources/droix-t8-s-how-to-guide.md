---
title: "DROIX T8-S How-To Guide"
type: source
subtype: kb-article
slug: droix-t8-s-how-to-guide
brand: droix
product: null
source_url: "https://droix.net/knowledge-base/article/droix-t8-s-how-to-guide/"
...
The T8-S is a new release that has all the features of our popular T8, with a few added extras.

[Getting your T8/T8-S set up at first use](#getting-started)

## How is the T8-S different?

There is space to insert a 2.5in hard drive which is popular with people who like to download live broadcasts or programs for later viewing, as well as more apps like games. You can also store media files on it that you may already have on other devices. Currently this has been tested up to a capacity of 1TB, but theoretically can go higher. We shall update this as we are able to test larger configurations. Previously, storage like this could be done with with external USB drives (all our other devices support external USB), but now there is one less device on the TV stand and several less cables!
...
#### How to install Showbox and Mobdro
