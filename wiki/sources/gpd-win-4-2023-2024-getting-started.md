---
title: "Getting Started with the GPD WIN 4 (2023/2024)"
type: source
subtype: kb-article
slug: gpd-win-4-2023-2024-getting-started
brand: gpd
product: gpd-win-4
source_url: "https://droix.net/knowledge-base/article/gpd-win-4/"
...
Congratulations on purchasing the [GPD WIN 4](https://droix.net/product/gpd-win-4-2024) handheld gaming computer. Whether you have the latest [2024 model](https://droix.net/product/gpd-win-4-2024) or a [previous one](https://droix.net/product/gpd-win-4-2023), we have prepared a getting started guide which we highly recommend looking over. It contains what to check, how to update Windows, update device-specific software, firmware & drivers and much more on your new [handheld gaming PC](https://droix.net/product-category/gaming-handhelds/)!

## Testing Your Hardware

The first thing you need to do when you take your device out of the box is to ensure that everything works as it’s supposed to. We’ve got an article [here](https://droix.net/knowledge-base/article/getting-started-with-your-gaming-handheld-test-your-hardware/) and embedded below taking you through how to test all of the different buttons, joysticks, screens and features of your new GPD WIN 4 2023.
...
Below you can find the unique Firmware and Drivers specific to your GPD WIN 4 2023. We will update these links for each new update.
...
| GPD WIN 4 2024 (8840U) |  |
| --- | --- |
| Drivers | N/A |

**These update files are intended only for the GPD WIN 4 2024 (8840U). Do not install it on any other device or model.**

---

## Stress Testing Your GPD WIN 4
...
Let’s not forget, this is [Windows 11](https://www.microsoft.com/en-gb/windows/windows-11). If you’re not a fan of the preinstalled companion apps, you can install whatever you’d like as long as it is supported. Software such as [Handheld Companion](https://github.com/Valkirie/HandheldCompanion) is one that we highly recommend! You can unlock even more additional controls and settings, including setting up hotkeys for your own functions. Or enabling on-screen stats to keep a close eye on performance. And even enabling and adjusting motion control allows you to get just that much more immersed in your games.
...
What you’re actually here for, the GPD WIN 4 2023 has got in spades. Windows is far and away the best platform for gaming. It’s the gold standard the likes of SteamOS try to emulate, we’ve got full-fat [Windows 11](https://www.microsoft.com/en-gb/windows/windows-11) on the GPD WIN 4 2023. Whatever you can do on your gaming PC you can do here. With full support for Steam, [XBOX Game Pass](https://www.xbox.com/en-gb/xbox-game-pass/pc-game-pass/), GeForce Now, Epic Games, EA, Radeon Games, GOG Galaxy and many, many, many more. You won’t have an issue running your library of games and adding to it.
...
It’s incredible, right? Your new gaming handheld can do so much already, what more is there? Believe me, there’s more. With additional accessories and add-ons available for the GPD WIN 4 2023, you can take your device to an even higher level, and keep it running for years to come.
