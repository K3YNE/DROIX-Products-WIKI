---
title: "Using iOS to stream and cast using Airplay and Youtube with DROIX TV Set Top Box Based on Android"
type: source
subtype: kb-article
slug: using-ios-to-stream-and-cast-using-airplay-and-youtube-with-droix-tv-set-top-box
brand: droix
product: null
source_url: "https://droix.net/knowledge-base/article/using-ios-to-stream-and-cast-using-airplay-and-youtube-with-droix-tv-set-top-box-based-on-android/"
...
[DROIX Share on iOS Devices – Demonstration Video](https://droix.net/wordpress/droidbox-share-demonstration-video/)

[How to Stream and Cast to your DROIX with your Android device using Yatse](https://www.youtube.com/watch?v=hDmMQHf62Os)
