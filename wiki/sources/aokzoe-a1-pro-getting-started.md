...
| BIOS update 65W – [AOK-A1-Pro-65W.zip](https://droix.sharepoint.com/:u:/s/Purchasing/EYOf3lh2MTFNpgB_KAZXqxcBBxocMT774NvdkH_AyXe-pg?e=jyGoAc) | Extract the contents and run the **AOK.bat** file. |
| Graphics Drivers – [230428a-392651C-Nantong\_Huada.2.zip](https://droix.sharepoint.com/:u:/s/Purchasing/EcwRkdBejBZJj4T9_cKWh_8BbnOtmTbk4zV_vx6UTah4lQ?e=SHNBo8) | Extract the contents and run the **Setup.exe** file |
| Player Center – [aokzoe\_0.4.5.zip](https://droix.sharepoint.com/:u:/s/Purchasing/EWf6JMuQ24BBjqpzFVIeT80BDO4JiwUnwnyL9FL9YQsOaQ?e=SaCGAP) | Extract the contents and run the **aokzoe\_0.4.5.exe** file |
