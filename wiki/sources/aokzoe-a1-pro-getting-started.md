---
title: "Getting Started with the AOKZOE A1 Pro"
type: source
subtype: kb-article
slug: aokzoe-a1-pro-getting-started
brand: aokzoe
product: aokzoe-a1-pro
source_url: "https://droix.net/knowledge-base/article/getting-started-with-the-aokzoe-a1-pro/"
published: 2023-07-10
created: 2026-04-22
updated: 2026-04-22
tags: [kb-article, aokzoe, aokzoe]
---

Congratulations on purchasing the [AOKZOE A1 Pro](https://droix.net/product/aokzoe-a1-pro/) handheld gaming computer. We have prepared a getting started guide which we highly recommend looking over. It contains what to check, how to update Windows, update device-specific software, firmware & drivers and much more!

## Testing Your Hardware

The first thing you need to do when you take your device out of the box is to ensure that everything works as it’s supposed to. We’ve got an article [here](https://droix.net/knowledge-base/article/getting-started-with-your-gaming-handheld-test-your-hardware/) and embedded below taking you through how to test all of the different buttons, joysticks, screens and features of your new AOKZOE A1 Pro.
...
**DO NOT INSTALL THESE FILES ON ANY OTHER DEVICE THAN THE AOKZOE A1 PRO, it may cause damage to your device.**

|  |  |
| --- | --- |
| **AOKZOE A1 Pro Firmware & Drivers** | **Instructions** |
| BIOS update 65W – [AOK-A1-Pro-65W.zip](https://droidbox.sharepoint.com/:u:/s/Purchasing/EYOf3lh2MTFNpgB_KAZXqxcBBxocMT774NvdkH_AyXe-pg?e=jyGoAc) | Extract the contents and run the **AOK.bat** file. |
| Graphics Drivers – [230428a-392651C-Nantong\_Huada.2.zip](https://droidbox.sharepoint.com/:u:/s/Purchasing/EcwRkdBejBZJj4T9_cKWh_8BbnOtmTbk4zV_vx6UTah4lQ?e=SHNBo8) | Extract the contents and run the **Setup.exe** file |
| Player Center – [aokzoe\_0.4.5.zip](https://droidbox.sharepoint.com/:u:/s/Purchasing/EWf6JMuQ24BBjqpzFVIeT80BDO4JiwUnwnyL9FL9YQsOaQ?e=SaCGAP) | Extract the contents and run the **aokzoe\_0.4.5.exe** file |
...
What you’re actually here for, the AOKZOE A1 Pro has got in spades. Windows is far and away the best platform for gaming. It’s the gold standard the likes of SteamOS try to emulate, we’ve got full-fat Windows 11 on the AOKZOE A1 Pro. Whatever you can do on your gaming PC you can do here. With full support for Steam, XBOX Game Pass, GeForce Now, Epic Games, EA, Radeon Games, GOG Galaxy and many, many, many more. You won’t have an issue running your library of games and adding to it.
...
It’s incredible, right? Your new gaming handheld can do so much already, what more is there? There’s more. With additional accessories and add-ons available for the AOKZOE A1 Pro you can take your device to an even higher level, and keep it running for years to come.

[GPD G1 eGPU docking station](https://droix.net/product/gpd-g1/): The docking station offers all your usual USB, DisplayPort and HDMI ports expandability but the main highlight is the built-in graphics card. The GPD G1 has a high-performance [Radeon RX 7600M XT](https://www.amd.com/en/products/graphics/amd-radeon-rx-7600m-xt) eGPU capable of running the latest games at higher graphics settings and high resolutions on an external monitor. Read our full review of it [here](https://droix.net/blogs/gpd-g1-egpu-docking-station-review).
