---
title: "Emulate a Different Controller on Your DROIX Device"
type: source
subtype: kb-article
slug: droix-emulate-controller-interface
brand: droix
product: null
source_url: "https://droix.net/knowledge-base/article/fully-emulate-a-different-controller-interface-on-your-android-powered-droix-device/"
...
Whether you want to emulate a touchscreen tap (as with a phone or tablet) instead of a mouse click, or want to use your gaming controller with a different layout, read on to learn how to install and configure [Tincore Keymapper](https://play.google.com/store/apps/details?id=com.tincore.and.keymapper).
