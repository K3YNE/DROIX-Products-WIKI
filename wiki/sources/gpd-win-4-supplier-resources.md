---
title: "GPD WIN 4 Supplier Resources"
type: source
subtype: resource-firmware
slug: gpd-win-4-supplier-resources
brand: gpd
product: gpd-win-4
source_url: https://www.gpd.hk/gpdwin4firmwaredriver
created: 2026-04-22
updated: 2026-04-22
tags: [resource-firmware, resource-bios, resource-driver, resource-tool, gpd]
---

Official firmware, driver, BIOS, and tool resources for the original GPD WIN 4 (AMD Ryzen 7 6800U). Retrieved from the GPD official resource page on 2026-04-21.

Applies to: [[gpd-win-4]]
...
|---|---|---|---|
| WIN 4 (6800U) Windows 11 24H2 Home Firmware **(current)** | 2024-12-20 | `730BD7B9D989797488C1509E590085FD9941E80C` | [Download](https://drive.google.com/file/d/1vr_seeh5rmQUe-Ez49htZ63ykrkyHT4x/view?usp=sharing) |
| WIN 4 (6800U) Windows 11 Home Firmware | 2024-03-08 | — | [Download](https://drive.google.com/file/d/1LY44bRqhijfFIsHbGPV0BARA8DGwy6i7/view?usp=drive_link) |
...
|---|---|---|---|---|
| WIN 4 (8840U / 7840U / 7640U / 6800U) Drivers **(current)** | v3.4 | 2024-05-07 | Separate driver package intended for custom OS installs or when not using the official firmware bundle. After extracting, run `AutoInstallDrivers.bat`. | [Download](https://drive.google.com/file/d/19MALLPUxRZHsXjcP-VP3synRRxTwBc19/view?usp=sharing) |
...
| Resource | Version | Date | Notes | Download |
|---|---|---|---|---|
| WIN 4 (6800U) BIOS **(current)** | V3.06 | 2023-06-07 | Fixes volume keys becoming unresponsive after sleep on Linux; fixes bottom C port not displaying in v3.04; fixes device crash under abnormal conditions; adds screen firmware update interface. Only upgrade if experiencing these issues. | [Download](https://drive.google.com/file/d/1lHTJUokYs5KxXWYDQcrotl4nL0wmIiv4/view?usp=sharing) |
...
| Touchscreen Driver | 2023-04-17 | Solves issue of touchscreen suddenly becoming ineffective. | [Download](https://drive.google.com/file/d/1-jHtIoKodhM35sO1KYzLpr0ymiblFc5S/view?usp=sharing) |
| WIN 4 Keyboard Firmware | 2023-02-25 | Prevents keyboard triggers caused by screen contacting keyboard during upward swipes. | [Download](https://drive.google.com/file/d/1YEDoGec-L6iSWhpDTke5AlB8PuDC3Ji0/view?usp=share_link) |
...
Tool for WIN 4 grip back button mapping, programming, and vibration adjustment.
...
| Resource | Date | Notes | Download |
|---|---|---|---|
| WIN 4 Q & A | 2022-09-02 | PDF with frequently asked questions. | [Download](https://drive.google.com/file/d/1cpE845YohcW7P66S1yQZi7-dKCV4wJAK/view?usp=share_link) |
| WIN 4 User Manual | 2022-09-02 | PDF with function key and port descriptions. | [Download](https://drive.google.com/file/d/1Z-gIblVeHqQtONBCD0rjmrmvR1l84wUL/view?usp=share_link) |
...
| Resource | Date | Notes | Download |
|---|---|---|---|
| WIN 4 Grip 3D Printing File | 2023-04-03 | 3D printing file for WIN 4 handle with detailed instructions inside. | [Download](https://drive.google.com/file/d/1xmDOZaLhpdVo5kin6nyQjQIAGo-gNk_c/view?usp=sharing) |
...
| GPD OS (WIN Max 2 6800U) — Manjaro/SteamOS | 2022-12-13 | Linux Kernel 6.0, Manjaro desktop + Steam OS game mode. Compatible with WIN 4. Use balenaEtcher to flash. First boot: connect Wi-Fi, launch Steam before switching to Deck GamePad UI. [Setup video](https://youtu.be/aekVivINoOQ) | [Mirror](https://mirror.fkardame.com/Linux/Images/GPD/) |
...
Video guide: Replace The SSD On GPD WIN 4 And Reinstall OS (linked from official resource page).
