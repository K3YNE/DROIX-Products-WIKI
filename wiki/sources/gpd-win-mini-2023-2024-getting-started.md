---
title: "Getting Started with the GPD WIN Mini (2023/2024)"
type: source
subtype: kb-article
slug: gpd-win-mini-2023-2024-getting-started
brand: gpd
product: gpd-win-mini
source_url: "https://droix.net/knowledge-base/article/gpd-win-mini/"
...
Congratulations on purchasing the [GPD WIN Mini](https://droix.net/product/gpd-win-min-2024/) handheld gaming computer. We have prepared a getting started guide for the [2023](https://droix.net/product/gpd-win-min/) and [2024](https://droix.net/product/gpd-win-min-2024i/) variants, which we highly recommend reviewing. It contains what to check, how to update Windows, update device-specific software, firmware & drivers and much more!

## Testing Your GPD WIN Mini

The first thing you need to do when you take your [handheld gaming PC](https://droix.net/product-category/handhelds/handheld-gaming-pcs/) out of the box is to ensure that everything works as it’s supposed to. We’ve got an article [here](https://droix.net/knowledge-base/article/getting-started-with-your-gaming-handheld-test-your-hardware/) and embedded below taking you through how to test all of the different buttons, joysticks, screens and features of your new GPD WIN Mini.
...
| GPD WIN Mini Firmware | Download Link |
| --- | --- |
| [WIn-Mini\_22H2\_WIN11\_HOME\_\_20230801.zip](https://droidbox.sharepoint.com/:u:/s/Purchasing/EfdxVLqVkdVOs1DI1PJL0GoBXLPEDkJqFIDOD422zJQk-g?e=QlEl7b) | GPD WIN Mini Windows install if you want to reinstall a fresh version of Windows with GPD WIN Mini drivers included |
| Windows 11 Home (8840U/7840U/7640U) | Download |

**Please only use the Windows install, firmware and BIOS updates on the GPD WIN Mini. These firmware files are intended only for the GPD WIN Mini and may cause issues or even render the device inoperable when installed on other devices.**

You can find the article on how to [install, update and delete AMD drivers here](https://droix.net/knowledge-base/article/how-to-uninstall-old-amd-graphics-drivers-and-install-new-ones/), and also embedded below. These are the graphics drivers for your device.
...
What you’re actually here for, the GPD WIN Mini has got in spades. Windows is far and away the best platform for gaming. It’s the gold standard the likes of the SteamOS try to emulate, we’ve got full-fat Windows 11 on the GPD WIN Mini. Whatever you can do on your gaming PC you can do here. With full support for Steam, XBOX Game Pass, GeForce Now, Epic Games, EA, Radeon Games, GOG Galaxy and many, many, many more. You won’t have an issue running your library of games and adding to it.
...
If you would like to try a SteamOS-like user interface and operating system for example, then we can suggest [HoloISO](https://github.com/HoloISO). Please read the requirements, and known bugs and set up instructions first. Please note that we do not provide support for other operating systems.

### Retro Gaming

If you fancy delving into the past you can play your retro game ROMs, that you definitely own! You can use emulator frontends such as [RetroArch](https://www.retroarch.com/) or individual emulators such as [RPCS3](https://rpcs3.net/) for PlayStation 3. By adding your ROMs you can capture the past in the present day and play all of your favourites from your GPD WIN Mini.
...
The GPD G1 eGPU docking station provides more USB ports as well as HDMI and DisplayPort to your monitor or TV. The main attraction is the built-in Radeon RX 7600M XT eGPU! It can run your games at higher FPS and visuals and with an external monitor at higher resolutions.
...
It’s incredible, right? Your new gaming handheld can do so much already, what more is there? Believe me, there’s more. With additional accessories and add-ons available for the GPD WIN Mini you can take your device to an even higher level, and keep it running for years to come.
