---
title: "How to update your K5 or M5 device manually"
type: source
subtype: kb-article
slug: how-to-update-your-k5-or-m5-device-manually
brand: droix
product: null
source_url: "https://droix.net/knowledge-base/article/how-to-update-your-k5-or-m5-device-manually/"
...
If you use the second method, please ensure you also download the AML and IMG files.

You will need an SD memory card, 2Gb or larger, and nothing on the card to start with. If you have any documents/pictures/files on the memory card, please copy and paste the files onto another storage device, such as your computer’s hard drive.
...
Click the Select button, and click on dbx.M5K5.20160617.V2.4.0.zip . Now click the Update button.
...
Once you have your blank memory card ready, visit 3 <https://droidboxcloud.com/index.php/s/8FzmfXYXWuP2afI> and download all three files from the page. Copy these three files (again not extracting anything from the ZIP file please) onto your memory card.

Switch off your K5 or M5 device as normal. Insert the SD card you previously copied the files onto.
