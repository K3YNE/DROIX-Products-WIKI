---
title: "Changing the Launcher on a Go v3"
type: source
subtype: kb-article
slug: droix-go-v3-launcher-change
brand: droix
product: null
source_url: "https://droix.net/knowledge-base/article/changing-the-launcher-on-a-go-v3/"
...
It will continue to allow access to the DROIX launcher for people who prefer the look/use the projector itself for Kodi, rather than connect to consoles/laptops etc
...
The cogs take you to Settings, whilst on the right we have your favorite apps area. You can add and remove shortcuts to the apps (from the long list you’ll see when you click the six dots in a circle icon on the left). Tick or untick the apps you want after clicking the ± sign and then press the Return button on your remote to save the selection.
