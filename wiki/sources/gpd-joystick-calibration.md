---
title: "How to Calibrate GPD Joysticks"
type: source
subtype: kb-article
slug: gpd-joystick-calibration
brand: gpd
product: null
source_url: "https://droix.net/knowledge-base/article/how-to-calibrate-gpd-joysticks/"
...
Occasionally the joysticks on devices such as controllers or [handheld PCs](https://droix.net/product-category/handhelds/handheld-gaming-pcs/) can lose their calibration resulting in incorrect and inaccurate input. This guide will walk you through step by step how to install the necessary software and how to calibrate your GPD joysticks on all [GPD devices](https://droix.net/product-attribute/brands/gpd/).

This guide will work with:

* [GPD WIN 5](https://droix.net/product/gpd-win-5/)
* [GPD WIN 4 series](https://droix.net/product/gpd-win-4/)
* [GPD WIN MAX series](https://droix.net/product/gpd-win-max-2-2023/)
* [GPD WIN 3](https://droix.net/product/gpd-win-3/)
* [Other GPD Handhelds](https://droix.net/product-attribute/brands/gpd/)

## Download the GPD Joystick Calibration Tool

Download and extract the latest version of the [GPD Joystick Calibration Tool here](https://gofile.me/7AWvf/mIN1B5UdX). Extract the .zip file and you will have the **Win3TestV1.04.exe** file, run this file.

## GPD Joystick Calibration
...
If you feel that you didnt fully push the edges or the triggers, you can press the button and repeat the calibration. You can also test the calibration has worked by pressing any of the analogue sticks or triggers and the values will appear in their respective areas.
