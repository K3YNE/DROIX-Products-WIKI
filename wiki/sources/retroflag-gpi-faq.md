...
<details>
<summary>Screen display is distorted and/or speaker is buzzing</summary>
The common cause of this is the cartridge. The pogo pins which connect the GPi to the Raspberry Zero are not making proper contact. We find that screwing the brass stand-offs quite tight to the case and Zero, and then tightening the silver case screws until they can't be turned any more with little pressure. If you then loosen the silver case screws by a half turn, this seems to fix the issue.

Other things you can check are that the contacts on the cartridge may be dirty from fingerprints.
</details>

<details>
<summary>D-Pad is not responding on the Menu or in-game</summary>
...
<details>
<summary>How to connect Retroflag GPi to WiFi?</summary>
...
<details>
<summary>How do I flash an .img file?</summary>
...
<details>
<summary>How do I copy ROMs to the Mini SD Card?</summary>
Retropie and Recalbox, for example, use the EXT4 file system as it is Linux-based. Unfortunately, Windows cannot read this format, so it is not as simple as copying files via a card reader. There are a few solutions:
