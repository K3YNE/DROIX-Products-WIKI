---
title: "How to recalibrate your GPD controls"
type: source
subtype: kb-article
slug: gpd-recalibrate-controls
brand: gpd
source_url: "https://gpdstore.net/kb/gpd-win-4-support-hub/kb-article/how-to-recalibrate-your-gpd-controls/"
...
From time to time, the thumbsticks on gadgets like gamepads or handheld computers may drift or lose their calibration, causing inputs to be imprecise or wrong. This tutorial will provide a step-by-step explanation of how to set up the required utility and calibrate the joysticks on every [GPD handheld gaming PC](https://gpdstore.net/product-category/gpd-handheld-gaming-pcs/ "GPD handheld gaming PC").

This walkthrough is compatible with:

* [GPD WIN 5](https://gpdstore.net/product/gpd-win-5/ "GPD WIN 5")
* [GPD WIN 4 series](https://gpdstore.net/product/gpd-win-4-2025/ "GPD WIN 4 series")
* [GPD WIN MAX series](https://gpdstore.net/product/gpd-win-max-2-2025/ "GPD WIN MAX series")
...
## **Download the GPD Joystick Calibration** Tool

Save and unzip the most current release of the GPD Joystick Calibration Tool [here](https://gofile.me/7AWvf/mIN1B5UdX "here"). Unpack the compressed archive to locate the `Win3TestV1.04.exe` application, then launch this program.

## **Calibrating the GPD Sticks**
...
If you suspect that you did not reach the full range of the edges or the triggers, you can hit the button to redo the calibration. You may also verify that the adjustment was successful by moving any of the analog sticks or triggers, and the resulting data will show up in the appropriate fields.
...
This section allows you to verify the functionality of your gamepad inputs.

* **Z Axis** corresponds to the Trigger inputs.
* **X Rotation** represents the horizontal motion of the Right Stick.
* **Y Rotation** represents the vertical motion of the Right Stick.
* **X-Axis / Y-Axis** tracks the Left Stick’s movement.
