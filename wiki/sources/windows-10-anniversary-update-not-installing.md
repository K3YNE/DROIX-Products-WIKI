---
title: "Windows 10 Anniversary Update Not Installing?"
type: source
subtype: kb-article
slug: windows-10-anniversary-update-not-installing
brand: droix
product: null
source_url: "https://droix.net/knowledge-base/article/windows-10-anniversary-update-not-installing/"
...
Windows 10 Anniversary Update brings some interesting features and improvements to the Windows 10 Home operating system found on our recent Windows based devices.
...
T11 – if you have a 2.5″ hard drive (be it the conventional spinning drive or an SSD) of 9.5mm or less in height, install it into your device
...
If it fails again, please make a note of exactly how much free disk space you have, and include it in your [e-mail requesting support](https://droidboxforums.com/threads/what-to-include-if-you-need-to-e-mail-us.364/), along with your DROIX order ID.

[Update]

If you haven’t yet been offered the Anniversary Update, Microsoft are rolling it out over several months. You can still use the method above to grab the update though. Please see <http://www.zdnet.com/article/windows-10-anniversary-update-rollout-may-not-be-done-until-early-november/> for more information.
