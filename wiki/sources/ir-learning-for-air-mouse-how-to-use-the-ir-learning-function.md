---
title: "IR Learning For Air Mouse – How to use the “IR Learning” Function"
type: source
subtype: kb-article
slug: ir-learning-for-air-mouse-how-to-use-the-ir-learning-function
brand: droix
product: null
source_url: "https://droix.net/knowledge-base/article/ir-learning-for-air-mouse-how-to-use-the-ir-learning-function/"
...
* [**Infrared**](https://www.britannica.com/science/infrared-radiation) – The remote sends various signals using a “code” that a device is hard-wired to constantly listen out for.

Of the three, IR is generally the cheapest to facilitate as it is the most “low-tech” option (infrared technology is many, many decades old) and only requires the inclusion of a basic transceiver in the remote and box. Compared to 2.4GHz, which requires a dongle (that can be lost/damaged), or Bluetooth, which requires more expensive (yet [more powerful](https://www.scienceabc.com/innovation/whats-the-difference-between-bluetooth-and-infrared-transmission.html)) components.

Most contemporary android boxes will come with a very cheap [IR remote](https://electronics.howstuffworks.com/remote-control2.htm) that provides the barest of functionality. For this reason, we’d suggest purchasing a dedicated one if you’re more of a power-user. We sell a variety here:https://droix.net/product-category/tv-and-home-cinema/accessories/
...
Infrared receivers are always listening however. With the caveat being their [short range and vulnerability to interference.](https://t4tutorials.com/bluetooth-vs-infrared-comparison-of-range-and-transmission-speed/)
