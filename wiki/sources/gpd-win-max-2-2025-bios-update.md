---
title: "How to update the GPD WIN MAX 2 2025 BIOS"
type: source
subtype: kb-article
slug: gpd-win-max-2-2025-bios-update
brand: gpd
product: gpd-win-max-2
source_url: "https://gpdstore.net/kb/gpd-win-max-2-support-hub/kb-article/how-to-update-the-gpd-win-max-2-2025-bios/"
...
The process for updating the [GPD WIN MAX 2 2025](https://gpdstore.net/gpd-handheld-gaming-pcs/gpd-win-max-2-2025/) HX 370 firmware is fairly straightforward, but it can be daunting if you have not performed a BIOS update before. Our step by step guide will walk you through the process.
...
The GPD WIN MAX 2 2025 **HX 370 ONLY** BIOS updates are available for [download here](https://gofile.me/7AWvf/R7PDGplq1). These are **not** for the 8840U model. It is important to note that some antivirus applications may incorrectly identify the file as a threat. We suggest deactivating any antivirus software before you start the download and not reactivating it until the BIOS update is fully installed.

## **Setting up the USB drive**

Decompress the downloaded BIOS update file, where you will find three available BIOS versions: 0.18, 0.19, and 0.21. Unpack the specific version you wish to flash, which is typically the most recent one.
...
Verify that your [GPD WIN MAX 2 2025](https://gpdstore.net/gpd-handheld-gaming-pcs/gpd-win-max-2-2025/) has a full battery charge and is connected to the power adapter.
...
After the update has finalized, your [GPD WIN MAX 2 2025](https://gpdstore.net/gpd-handheld-gaming-pcs/gpd-win-max-2-2025/) will boot into the Windows operating system, and normal operation can be resumed.
