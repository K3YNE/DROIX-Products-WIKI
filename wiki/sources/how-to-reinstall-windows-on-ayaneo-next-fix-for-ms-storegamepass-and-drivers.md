---
title: "How to reinstall windows on AYANEO Next – Fix for MS Store/Gamepass and Drivers"
type: source
subtype: kb-article
slug: how-to-reinstall-windows-on-ayaneo-next-fix-for-ms-storegamepass-and-drivers
brand: ayaneo
product: ayaneo-next
source_url: "https://droix.net/knowledge-base/article/how-to-reinstall-windows-on-ayaneo-next/"
published: 2022-05-23
created: 2026-04-22
updated: 2026-04-22
tags: [kb-article, ayaneo, ayaneo-next, windows, troubleshooting, installation, drivers]
---

There are many reasons why you would need to reinstall Windows on AYANEO Next or Next Pro. Recently we received an email from a customer saying that they can’t download apps from the Microsoft Store on the AYANEO Next. They were not even able to download the Xbox to use GamePass. This leads us to think some of you might have a corrupted Windows installation, so we’ll reinstall windows and all the drivers.
...
1. Go to [Microsoft Support](https://www.microsoft.com/en-us/software-download/windows11)
...
1. AYA Space Beta – [Download](https://cdn.ayaneo.com/ayaneo/downloads/AYASpaceGlobalSetup1.0.1.144.zip)
