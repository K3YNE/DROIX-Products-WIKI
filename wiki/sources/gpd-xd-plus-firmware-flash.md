---
title: "Flashing GPD XD+ (Plus) Firmware"
type: source
subtype: kb-article
slug: gpd-xd-plus-firmware-flash
brand: gpd
product: null
source_url: "https://droix.net/knowledge-base/article/flashing-gpd-xd-plus-firmware/"
...
**IMPORTANT:** This guide is for the **GPD XD+** **(Plus)** only, NOT the GPD XD. Do not attempt to install this on the GPD XD as it may cause irreversible damage to the device!

Download one of the firmware files and Flashing Tool file to your PC.

**Firmware**  
The latest firmware can be downloaded from <https://www.gpd.hk/gpdxdplusfirmware>

**Flashing Tool**  
<https://1drv.ms/u/s!AlRdlhGu3fjih2A2I12IynAOo5cX>

Create a new folder on your PC hard drive and call it “**GPD XD Plus**” for easy reference
...
**NOTE:**The first boot after a firmware flash or factory reset it will take longer than usual to boot as it is setting up the operating system for first use.
