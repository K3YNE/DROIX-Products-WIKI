...
Next, open up Kodi or DroidBOX Media Centre (whichever you normally use) to test the system works
...
Unless you have already changed the network name given to your DroidBOX, you need to click SAMBADROID here
