---
title: GPD Win MAX 2021 Review – Powerful AND Portable!
source_url: "https://droix.net/blogs/gpd-win-max-2021-review/"
source_site: droix.net
type: review-blog
date: 2021-09-15
---

In our GPD Win MAX 2021 review we start with an unboxing and overview of the handheld gaming PC. We continue the review with system and gaming benchmarks, followed by gameplay and emulator testing footage. There is a choice of videos on our playlist, or if you prefer you can read the text version below. You can learn more and [buy the GPD Win MAX 2021 here](https://go.droix.co.uk/GPD-WIN-MAX-2021), or you can browse our range of [gaming handhelds](https://go.droix.co.uk/GAMING-HANDHELD).

Contents

[GPD Win MAX 2021 Review Video](#gpd-win-max-2021-review-video)

[Unboxing](#unboxing)

[GPD Win MAX 2021 Overview](#gpd-win-max-2021-overview)

[GPD Win MAX 2021 Technical Specifications](#gpd-win-max-2021-technical-specifications)

[GPD Win MAX 2021 i7 Benchmarks](#gpd-win-max-2021-i7-benchmarks)
...
[GPD Win MAX 2021 Gaming Benchmarks](#gpd-win-max-2021-gaming-benchmarks)

[Forza Horizon 4](#forza-horizon-4)

[Final Fantasy XIV Endwalker](#final-fantasy-xiv-endwalker)

[Street Fighter V](#street-fighter-v)

[Gameplay Tests Footage](#gameplay-tests-footage)

[BloodRayne Betrayal Fresh Bites](#bloodrayne-betrayal-fresh-bites)

[WRC10](#wrc10)

[Quake Enhanced](#quake-enhanced)

[Mass Effect Legendary](#mass-effect-legendary)

[RICO: London](#rico-london)

[Emulator Test Footage](#emulator-test-footage)

[PlayStation Portable Emulation](#playstation-portable-emulation)

[Xbox Emulation](#xbox-emulation)

[PlayStation 2 Emulation](#playstation-2-emulation)

[PlayStation 3 Emulation](#playstation-3-emulation)

[Summary](#summary)

[GPD Win 3 vs ONEXPLAYER vs GPD Win MAX 2021 Comparison](#gpd-win-3-vs-onexplayer-vs-gpd-win-max-2021-comparison)

[Where to buy the GPD Win MAX 2021](#where-to-buy-the-gpd-win-max-2021)

[GPD WIN MAX 2021 FAQ – Everything you need to know about the 2021 edition GPD WIN MAX](#gpd-win-max-2021-faq-everything-you-need-to-know-about-the-2021-edition-gpd-win-max)

[What IS the WIN MAX 2021?](#what-is-the-win-max-2021)

[GPD WIN MAX 2021Technical Specifications](#gpd-win-max-2021technical-specifications)

[Processor Choices](#processor-choices)

[GPD WIN MAX 2021 – Benchmarks](#gpd-win-max-2021-benchmarks)

[The Physical Details](#the-physical-details)

[[FAQ] Can I upgrade my GPD WIN MAX to the GPD WIN MAX 2021?](#faq-can-i-upgrade-my-gpd-win-max-to-the-gpd-win-max-2021)

[When is the GPD WIN MAX 2021’s Release Date? Where to buy?](#when-is-the-gpd-win-max-2021s-release-date-where-to-buy)
...
The 8 inch IPS touch enabled screen has a default resolution of 1280×800, with 189 pixels per inch ([PPI](https://www.investopedia.com/terms/p/ppi-pixels-inch.asp)). It is very clear and bright, we currently have it at 50% brightness.
...
On the back from left to right you can find the right shoulder and trigger buttons. A full size HDMI port to connect to your TV or monitor. There are two USB 3 and two [USB Type-C ports](https://en.wikipedia.org/wiki/USB-C) to connect peripherals to. And finally the Left shoulder and trigger buttons.
...
Inside you can find a 3×5000mAh / 57Wh high-capacity polymer lithium battery which is good for between 3 to 8 hours depending on usage. [GPD](https://go.droix.co.uk/GPD) had originally decided to go a small steps backwards in terms of wireless connectivity, with WiFi 5 and Bluetooth 4.2. This has now been updated to WiFi 6 and Bluetooth 5 based on customer feedback.

## GPD Win MAX 2021 Technical Specifications

There are two models of the GPD Win MAX 2021 based on [Intel](https://go.droix.co.uk/INTEL) and [AMD](https://go.droix.co.uk/AMD) processors.
...
| **EXECUTION UNITS (Intel) /**  **CORES (AMD)** | 96 | 8 |
...
| **BLUETOOTH** | 4.2 |
| **PORTS** | 2x USB Type-C (Thunderbolt 4) (Intel model only)  2x USB-Type-C (USB 3.2 Gen 2) (AMD model only)  2x USB Type-A 1x 3.5mm headphone jack. 1x HDMI |
| **OTHER** | Backlit chiclet keyboard Controller/Mouse Mode Toggle Switch eGPU Compatible (Intel model only) |
...
We have set the resolution to 720P and the graphics to the default Ultra settings. This gives us a good idea of gaming performance compared to other [gaming handhelds](https://go.droix.co.uk/GAMING-HANDHELD) and [gaming Mini PC’s](https://go.droix.co.uk/GAMING-MINI-PC).
...
Mass Effect Legendary runs great on the Win MAX 2021. We saw with the 1165G7 processor on our [ONEXPLAYER gameplay tests](https://droix.net/blogs/onexplayer-review-gameplay-tests-with-nine-aaa-games/) that it was not quite fast enough for a stable 60FPS, but with the 1195G7 it definitely remains more in that area. The game plays very well and I did not experience any major frame drops while playing.
...
We conclude our GPD Win MAX 2021 review with a summary. The GPD Win MAX 2021 is a bit of a dark horse in the current hype of gaming handhelds. The GPD Win 3 and ONEXPLAYER have been very popular and then the Win MAX 2021 from [GPD](https://droix.net/blogs/brand/gpd/) turns up and blows them away with the faster 1195G7 processor. Both the Win 3 and ONEXPLAYER will also be receiving an upgrade to the newer processor, so it will be a nice full comparison to make in a future video.
...
| **PASSMARK** | 3810 | **4120** | 3703 |
| **PCMARK** | 5027 | 4884 | **5503** |
| **3DMARK** | 1796 | 1801 | 1409 (disputed) |
...
Overall I am very impressed with the [GPD Win MAX 2021 i7](https://go.droix.co.uk/GPD-WIN-MAX-2021) version. That extra boost in performance does make a noticeable difference in a lot of games, especially where they may not have been quite fast enough to get a stable 60FPS. Mass Effect is a very good example of this!

## Where to buy the GPD Win MAX 2021

You can learn more and [buy the GPD Win MAX 2021 here](https://go.droix.co.uk/GPD-WIN-MAX-2021) which is available in both the Intel and AMD processor editions. Or you can browse our range of [gaming handhelds here](https://go.droix.co.uk/GAMING-HANDHELD).

[BUY NOW](https://go.droix.co.uk/GPD-WIN-MAX-2021)

---

## GPD WIN MAX 2021 FAQ – Everything you need to know about the 2021 edition GPD WIN MAX

*Originally posted by [benjamin](https://droix.net/blogs/author/benjamin/) on: 03/08/2021*

Hello! Welcome to our FAQ for the [GPD WIN MAX 2021](https://go.droix.co.uk/GPD-WIN-MAX-2021)! Recently, GPD have announced their intent to release a new revision of their popular GPD Win Max [gaming laptop](https://go.droix.co.uk/GAMING-LAPTOPS). At this point in time, both fans and GPD alike have taken to calling this new revision the GPD Win Max 2021.

### What IS the WIN MAX 2021?

The [WIN MAX 2021](https://go.droix.co.uk/GPD-WIN-MAX-2021) is a successor to GPD’s popular 2020 handheld gaming PC, the [GPD WIN MAX](https://go.droix.co.uk/GPD-WIN-MAX).
...
While classified as a gaming handheld in many spaces spaces, the GPD Win MAX is better described as a device that occupies a space between gaming handhelds and [gaming laptops](https://droix.net/blogs/product-category/laptops/gaming-laptops/). Combining the performance and feature-set of the latter with the portability of the former.
...
|  |  |
| --- | --- |
| Processor | AMD Ryzen 7 4800U (Quad-core, 1.80-4.20GHz) Intel Core i7-1195G7 (Octa-core, 2.9-5.0GHz) |
| Graphics | Intel Iris Xe Graphics [INTEL ONLY] Radeon 8 Graphics [AMD ONLY] |
| RAM | 16GB LPDDR4x (@4266MHz) |
| Storage Options | 1TB M.2 NVMe |
| Storage Expansion | microSD M.2 NVMe |
| Screen | Touch-enabled 8 Inches 1280x800p (16:10) 189 PPI IPS |
| Wi-Fi | IEEE 802.11a/b/g/n/ac (WiFi 5) MU-MIMO Support |
| Bluetooth | 4.2 |
| Controls | A B X Y buttons D-pad L & R analog triggers L & R bumpers View & Menu buttons 2x analog sticks; clickable (L3/R3) Start & Select buttons 1x Trackpad |
| Ports | 2x USB Type-C (Thunderbolt 4) [INTEL ONLY] 2x USB-Type-C (USB 3.2 Gen 2) [AMD ONLY] 2x USB Type-A  1x 3.5mm headphone jack. 1x HDMI |
| Other Features | Backlit chiclet keyboard Controller/Mouse Mode Toggle Switch eGPU Compatible [INTEL ONLY] |
| Battery | ~57Whr; approx. 3-8 hours of gameplay. |
| Size | 207m x 145m x 26mm |
| Weight | ~790g |
| Price | TBA |
...
That’s not to mention that the device itself will likely be an [emulation monster](https://www.youtube.com/watch?v=zFDMaGyEQfk).
...
The Intel processor is a little harder to judge. The [i7-1195G7 is a *cutting-edge* CPU](https://www.intel.com/content/www/us/en/products/sku/217187/intel-core-i71195g7-processor-12m-cache-up-to-5-00-ghz/specifications.html) as far as consumer models go, only being officially “launched” in Q2 of 2021, and at the time of writing, not available in any other device on the market.
...
Many more games approach 60FPS with the i7 You probably wont notice it unlesss youre sensitive to frame drops
...
Given the benefit of the doubt, one would assume both the [AMD](https://droix.net/blogs/brand/amd/) and [Intel](https://droix.net/blogs/brand/intel/) CPUs were tested under the same conditions. If so, then the i7-1195G7 represents a big leap in performance in many games, around 20-25 FPS.
...
Put the GPU into the enclosure Connect the enclosure to the WIN MAX and youre good to go
...
Thankfully [GPD](https://go.droix.co.uk/GPD) are more concise here with their testing methodology, letting us know that these benchmarks were performed at 1280×800. It doesn’t say what the individual games settings’ are, but we’ll take what we can get!
...
The GPD WIN MAX 2021 adopts a standard “clamshell” style laptop appearance. With two halves that close together to both save on space and protect the device’s screen/keyboard. The WIN MAX 2021 is definitely larger than most conventional “handhelds”, sizing up at 207m x 145m x 26mm when closed. Larger than it’s most immediate relative, the [GPD WIN 3](https://go.droix.co.uk/GPD-WIN-3).
...
Essentially, this means it can more comfortably run at [higher TDPs](https://go.droix.co.uk/MAKE-WIN-3-FASTER) and perform more demanding tasks without delving into the “danger zone” for operating temperatures.
...
UPDATE: It is now launched and you can [buy the GPD Win MAX 2021 here](https://go.droix.co.uk/GPD-WIN-MAX-2021).

The [official Kickstarter](https://www.indiegogo.com/projects/win-max-2021-handheld-game-laptop-for-aaa-games#/) claims that shipping for devices will begin in September 2021, meaning backers can expect to begin receiving their models in Q4 2021 at the earliest. Prices start at £480 for the motherboard-only option, and and go as high as £717 for a full unit.

That’s all for now on the WIN MAX 2021! For the latest updates on the WIN MAX 2021 and other gadgets, please make sure to follow us on [Twitter](https://twitter.com/DroiX_Store), [Instagram](https://www.instagram.com/droix.store/), [Facebook](https://www.facebook.com/DroiX.Store/) and [Youtube](https://www.youtube.com/channel/UCKprdWGHr3oo3WNY2PKgmjg?sub_confirmation=1)! Leave a comment below as well if you have any thoughts, we’d love to hear them!
