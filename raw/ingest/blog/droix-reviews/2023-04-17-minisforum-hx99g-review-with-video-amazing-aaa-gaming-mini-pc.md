---
title: MinisForum HX99G Review with video – Amazing AAA gaming mini PC
source_url: "https://droix.net/blogs/minisforum-hx99g-review-with-video/"
source_site: droix.net
type: review-blog
date: 2023-04-17
---

The [MinisForum HX99G](https://droix.net/product/minisforum-neptune-hx99g/) is a gaming mini PC that actually does exactly what it says on the tin… erm case. In our MinisForum HX99G review we will run some benchmarks and compare the performance with others and see how well it can run AAA games!

Contents

[MinisForum HX99G Review Video](#minisforum-hx99g-review-video)

[Unboxing the MinisForum HX99G](#unboxing-the-minisforum-hx99g)

[Overview of the HX99G](#overview-of-the-hx99g)
...
[Resident Evil 4 Remake Demo](#resident-evil-4-remake-demo)
...
Up next we have the [HX99G gaming mini PC](https://droix.net/product/minisforum-neptune-hx99g/). We will take a closer look at it shortly.

Minisforum HX99G Unboxed

Underneath the packaging there is a power brick and plug lead. We will include the correct adaptor for your country. There is a pack containing heatsinks and thermal pads for when installing your RAM. As a note, if you buy from us pre configured then we will use these when installing the RAM. Next we have a [HDMI](https://www.hdmi.org/spec/index) cable for connecting the HX99G mini PC with Windows 11 to your display.

Minisforum HX99G Unboxing

And there is a stand with a bracket and screws which you can use to stand the HX99G vertically.

## Overview of the HX99G

We continue the Minisforum HX99G review with an overview of the min PC. The [MinisForum HX99G](https://droix.net/product/minisforum-neptune-hx99g/) measures around 8.07 x 7.99 x 2.72 inches  (20.5 x 20.3 x 6.93 cm) and weighs 1.4kg. It can be used either horizontally on a flat surface, or vertically with the mount.

HX99G Front View

On the front there is a USB 3.2 Gen 1 Type-A port, followed by dedicated 3.5mm headphone and microphone jacks. Beside that is a [USB 3.2](https://www.usb.org/usb-32-0) Gen 1 Type-C Port, and the power button.
...
|  |  |
| --- | --- |
| **CPU** | [AMD Ryzen 9 6900HX](https://droix.net/product-attribute/processor-cpu-model/ryzen-9-6900hx/) processor with 8 cores and 16 threads up to 4.9GHz at 45W TDP. |
| **GPU** | Integrated: [AMD Radeon 680M](https://droix.net/product-attribute/graphics-gpu-model/radeon-680m/) Discreet: [AMD Radeon RX 6600M](https://www.amd.com/en/products/graphics/amd-radeon-rx-6600m) with 8GB GDDR6 RAM, up to 2117MHz @ 100W TDP |
| **RAM** | Up to 64GB [DDR5](https://droix.net/product-attribute/memory-ram-technology/ddr5-so-dimm/) 4800MHz |
| **SSD** | Up to 2TB [m.2](https://en.wikipedia.org/wiki/M.2) 2280 PCIe 4 SSD |
| **COMMUNICATIONS** | 2.5 Gbps Ethernet [WiFi 6](https://droix.net/product-attribute/wi-fi/6/) Bluetooth 5.2 |
| **HIGHEST POWER DRAW** | 199W |
| **HIGHEST FAN NOISE** | 55dB |
| **HIGHEST TEMPERATURE** | 56°C |

MinisForum HX99G review technical specifications
...
First we have the PassMark benchmark results. The [MinisForum HX99G](https://droix.net/product/minisforum-neptune-hx99g/) takes a very respectable second place, beating the [MinisForum NUCXi5](https://droix.net/product/minisforum-nucxi5/) in third and behind the NUCXi7 in first.
...
For Fire Strike we can see the HX99G in second place behind the [MinisForum NUCXi7](https://droix.net/product/minisforum-nucxi7/), and again on the Night Raid benchmark. It drops down to 3rd place behind the NUCXi5 for the Time Spy test only by a small margin though.
...
Starting with Forza Horizon 5 we can see that at 4K the [MinisForum HX99G](https://droix.net/product/minisforum-neptune-hx99g/) does well in second place. It gets 94 frames per second, compared with 101 on the NUCXi7, both on the Very Low graphics settings.

Forza Horizon 5 Benchmark Results

At 1080P is where there is a power shift with the [MinisForum HX99G](https://droix.net/product/minisforum-neptune-hx99g/), it has a massive 198 FPS average, compared to just 153 on the NUCXi7 in 2nd place. Ryzen mini PC’s run amazingly well compared to Intel and Nvidia devices on this game as we saw in our gaming handheld benchmarks.
...
At 4K we can see the HX99G mini PC for gaming in third place with the [NUCXi5](https://droix.net/product/minisforum-nucxi5/) and i7 taking the lead.
...
Our final benchmark is Call of Duty Modern Warfare 2. The [MinisForum HX99G mini PC for gaming](https://droix.net/product/minisforum-neptune-hx99g/) is essentially tied with the NUCXi5 for 2nd place at 4K.

Again the pattern continues once we go to 1080P, which is a jump in performance for the HX99G taking a solid 2nd place.

And at 720P we can see that while the HX99G Ryzen mini PC remains in second place, there is only a few frames per second difference between it and the [NUCXi7](https://droix.net/product/minisforum-nucxi7/).
...
We are trying the [HX99G](https://droix.net/product/minisforum-neptune-hx99g/) with a new 4K portable touchscreen monitor and [GuliKit KingKong 2 Pro gamepad](https://droix.net/product/gulikit-kingkong-2-pro/) we will be selling. Check the links in the description if you want to learn more and keep an eye out for their reviews shortly.
...
Ryujinx on the Minisforum HX99G
...
For 1440P and 4K gaming the HX99G does a respectable job, however if you plan to game at these resolutions then the [MinisForum NUCXi7](https://droix.net/product/minisforum-nucxi7/) is definitely what you should be considering. Based on price, the HX99G it is a fair bit cheaper, and at 1080P and below it often beats or comes fairly close to beating the NUCXi7.  Don’t forget that 1080P is still the most popular screen resolution for gaming on a mini PC, if you plan to game at 1080P or even 720P then the HX99G is the perfect choice.

You can learn more about and [buy the MinisForum HX99G here](https://droix.net/product/minisforum-neptune-hx99g/). Use the code **HX99G5OFF** on the Checkout for 5% off! Note that the code is not valid during sales or promotions and will expire after one month.

We hope you have found our MinisForum HX99G review useful. Let us know what you think of it in the comments.

[BUY MINISFORUM HX99G HERE](https://droix.net/product/minisforum-neptune-hx99g/)

[azp\_custom\_product id=”48″]