---
title: ONEXPLAYER ONEXFLY F1 Pro Review – 8840U, HX 365 & HX 370 powered handheld gaming PCs
source_url: "https://droix.net/blogs/onexplayer-onexfly-f1-pro-review/"
source_site: droix.net
type: review-blog
date: 2025-02-11
---

You wait ages for a ONEXPLAYER ONEXFLY to come, and then three turn up at once. The new ONEXFLY F1 Pro with a choice of 8840U, HX 365 and HX 370 CPU are [ONEXPLAYER’S](https://droix.net/product-attribute/brands/onexplayer/) new models for 2025. Let’s find out in our [ONEXPLAYER ONEXFLY F1 Pro](https://droix.net/product/onexplayer-onexfly-f1-pro/) review how they compare with other handhelds and if they are worth your consideration as your next handheld gaming PC.

Contents

[ONEXPLAYER ONEXFLY F1 Pro Review Video](#onexplayer-onexfly-f1-pro-review-video)

[ONEXPLAYER ONEXFLY F1 Pro Overview](#onexplayer-onexfly-f1-pro-overview)

[ONEXPLAYER ONEXFLY F1 PRO Technical Specifications](#onexplayer-onexfly-f1-pro-technical-specifications)

[ONEXPLAYER ONEXFLY F1 Pro CPU & GPU Options](#onexplayer-onexfly-f1-pro-cpu-amp-gpu-options)

[ONEXPLAYER ONEXFLY F1 Pro shared specifications](#onexplayer-onexfly-f1-pro-shared-specifications)
...
[Indiana Jones & The Great Circle](#indiana-jones-amp-the-great-circle)
...
|  |  |  |  |
| --- | --- | --- | --- |
|  | **ONEXPLAYER ONEXFLY F1 PRO 8840U** | **ONEXPLAYER ONEXFLY F1 PRO 365** | ****ONEXPLAYER ONEXFLY F1 PRO 370**** |
| **CPU** | AMD [Ryzen 7 8840U](https://droix.net/product-attribute/processor-cpu-model/amd-ryzen-7-8840u/), 8 cores, 16 threads up to 5.1GHz | AMD [Ryzen AI 9 HX 36](https://droix.net/product-attribute/processor-cpu-model/ryzen-ai-9-hx-365/)5, 10 cores, 20 threads up to 5GHz | AMD [Ryzen AI 9 HX 370](https://droix.net/product-attribute/processor-cpu-model/ryzen-ai-9-hx-370/), 12 cores, 14 threads up to 5.1GHz |
| **GPU** | AMD [Radeon 780M](https://droix.net/product-attribute/graphics-gpu-model/ryzen-7-8840u-radeon-780m/) up to 2,700Mhz | AMD [Radeon 880M](https://droix.net/product-attribute/graphics-gpu-model/radeon-880m/) up to 2,900 Mhz | AMD [Radeon 890M](https://droix.net/product-attribute/graphics-gpu-model/ryzen-ai-9-hx-370-radeon-890m/) up to 2,900MHz |
| **BUY** | [HERE](https://droix.net/product/onexplayer-onexfly-f1-pro/) | [HERE](https://droix.net/product/onexplayer-onexfly-f1-pro/) | [HERE](https://droix.net/product/onexplayer-onexfly-f1-pro/) |

### ONEXPLAYER ONEXFLY F1 Pro shared specifications

|  |  |
| --- | --- |
| **DISPLAY** | 7″ [OLED](https://droix.net/product-attribute/display-type/oled/), [144Hz](https://droix.net/product-attribute/refresh-rate/144hz/), 16:9, 800 nits, 315 PPI |
| **RESOLUTION** | 1920×1080 |
| **RAM** | 32GB or 64GB [LPDDR5x](https://droix.net/product-attribute/memory-ram-technology/lpddr5x/) 7500MHz |
| **STORAGE** | 1TB, 2TB, 4TB [NVMe PCI-E Gen 4.0](https://droix.net/product-attribute/storage-technology/nvme-pci-e-gen-4-0/) |
| **WI-FI** | [6](https://droix.net/product-attribute/wi-fi/6/) |
| **BLUETOOTH** | [5.2](https://droix.net/product-attribute/bluetooth/5-2/) |
| **I/O** | 1x USB 3.2 Type-A [2x USB 4.0 Type-C](https://droix.net/product-attribute/i-o-usb/2x-usb-4-0-type-c/) 1x 3.5mm Headphone Jack 1x Micro SD card reader |
| **BATTERY** | 48.5Wh Li-po rechargeable battery |

In our battery tests running Cinebench on a loop, with full screen brightness at 28W TDP we got similar battery lifes of 1 hour 10 minutes on the 8840U model, 1 hour 11 minutes on the HX 365 and 1 hour 13 minutes on the HX 370 model. Around 10 minutes more battery life than the [GPD Win 4 2025](https://droix.net/product/gpd-win-4-2025/) and Mini. Your average usage will of course be higher, in the 3 to 6 hours range depending on demand.
...
We see slightly lower results with the [ONEXPLAYER ONEXFLY F1 Pro](https://droix.net/product/onexplayer-onexfly-f1-pro/) when compared to the GPD gaming handhelds. These are combined scores so it could be slightly slower SSD speeds for example affecting them.
...
We naturally see lower scores for the older 8840U processor. With the HX based models we see similar scores for single-core performance. The HX 370 takes the lead on multicore performance, and we can see a considerable drop on the HX 365, though it is the same as the [GPD WIN Mini 2025](https://droix.net/product/gpd-win-mini-2025/) HX 370 performance.
...
For single core performance we see fairly similar scores which is expected. On multi-core the [ONEXPLAYER ONEXFLY F1 Pro](https://droix.net/product/onexplayer-onexfly-f1-pro/) HX 370 again takes the lead, the HX 365 does well beating the [GPD WIN MAX 2 2025](https://droix.net/product/gpd-win-max-2-2025/) and Win 4 devices.
...
For Forza Horizon 5, we see that at 1080P, the F1 Pros have noticeable lower performance than the GPD devices. And at 720P the GPD devices keep the advantage until we get to around 10W TDP where the [ONEXPLAYER ONEXFLY F1 Pro](https://droix.net/product/onexplayer-onexfly-f1-pro/) has similar or higher frame rates.

### Shadow of the Tomb Raider

ONEXPLAYER ONEXFLY F1 Pro SHADOW OF THE TOMB RAIDER BENCHMARK COMPARISON

For Shadow of the Tomb Raider, we again see some differences. At 1080P the F1 PROs are behind the GPD devices. And at 720P we see improved results at 28W TDP, and as we lower the TDP, the frame rates start to overtake the [GPD](https://droix.net/product-attribute/brands/gpd/) devices.
...
The [ONEXPLAYER ONEXFLY F1 Pro’s](https://droix.net/product/onexplayer-onexfly-f1-pro/) compared with the GPD mobile gaming PCs clearly have some differences in performance. Throughout the tests we see overall lower performance while at 28W TDP on the F1 Pro. And when we lower the TDP, we see similar or higher scores than the GPD. This is most likely how the CPU and GPU power management is configured and can be tweaked with 3rd party software such as [Handheld Companion](https://droix.net/knowledge-base/en-gb/article/handheld-companion/).
...
Lonely Mountain on the ONEXPLAYER ONEXFLY F1 Pro



Carrion on the ONEXPLAYER ONEXFLY F1 Pro
...
TMNT Shredders Revenge on the ONEXPLAYER ONEXFLY F1 Pro



Overthrown on the ONEXPLAYER ONEXFLY F1 Pro
...
And it is much the same with [PCSX2](https://pcsx2.net/), compatible games will run great and you will again have no issues cranking up the rendering resolutions and graphics setting.

PCSX2 on the ONEXPLAYER ONEXFLY F1 Pro



RPCS3 on the ONEXPLAYER ONEXFLY F1 Pro
...
While the [ONEXPLAYER ONEXFLY F1 Pro](https://droix.net/product/onexplayer-onexfly-f1-pro/) series does not have an OCuLink port, you can still use the high speed USB 4 port to connect to an eGPU. You now have a choice of the [ONEXGPU](https://droix.net/product/onexplayer-onexgpu/) with AMD [Radeon RX 7600M](https://droix.net/product-attribute/graphics-gpu-model/radeon-rx-7600m-xt/) or the new and higher performing [ONEXGPU 2](https://droix.net/product/onexplayer-onexgpu-2/) with AMD [Radeon RX 7800M](https://droix.net/product-attribute/graphics-gpu-model/radeon-rx-7800m-2/).
...
If the GPD WIN 4 and Mini 2025 handheld gaming computers are not your thing, then the [ONEXPLAYER ONEXFLY F1 Pro](https://droix.net/product/onexplayer-onexfly-f1-pro/) series are a great alternative!

[BUY THE ONEXPLAYER ONEXFLY F1 PRO HERE](https://droix.net/product/onexplayer-onexfly-f1-pro/)

You can learn more and order all three models of the [ONEXPLAYER ONEXFLY F1 Pro here.](https://droix.net/product/onexplayer-onexfly-f1-pro/)
