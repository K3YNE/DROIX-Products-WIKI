---
title: AYANEO Pocket S Review with video – The new Android handheld king?
source_url: "https://droix.net/blogs/ayaneo-pocket-s-review-with-video/"
...
[AYANEO Pocket S Review Video](#ayaneo-pocket-s-review-video)

[Unboxing the AYANEO Pocket S](#unboxing-the-ayaneo-pocket-s)

[AYANEO Pocket S Overview](#ayaneo-pocket-s-overview)

[AYANEO Pocket S Technical Specifications](#ayaneo-pocket-s-technical-specifications)

[AYANEO Pocket S OS Overview](#ayaneo-pocket-s-os-overview)
...
AYANEO Pocket S Unboxing

## AYANEO Pocket S Overview

The [AYANEO Pocket S](https://droix.net/product/ayaneo-pocket-s/) measures around 8.42 x 3.3 x 0.55 in (21.39 x 8.5 x 1.4 cm) and weighs 350g. It is available in two colours, Obsidian Black and Ice Soul White along with a choice of display resolution.

AYANEO Pocket S Dimensions
...
AYANEO Pocket S Left View

On the left side is a covered micro sd card reader. And on the right is a switch which changes the performance modes.

AYANEO Pocket S Right View

Along the top of the [AYANEO Pocket S](https://droix.net/product/ayaneo-pocket-s/) we have shoulders and triggers and small macro buttons beside them which are configurable in the AYA Space software. There are volume buttons and a power button which has an integrated fingerprint scanner.

AYANEO Pocket S Top View

And on the bottom is a USB 3.2 Gen 2 Type-C port for charging and data.

AYANEO Pocket S Bottom View
...
AYANEO Pocket S AYA Space Overlay

## System Benchmarks

As we have the [AYANEO Pocket S](https://droix.net/product/ayaneo-pocket-s/) 1440P display model we have also used some software to change the resolution to 1080P so we can roughly compare the performance with the [AYN Odin 2](https://droix.net/product/ayn-odin-2/) which has a 1080P resolution. Please keep in mind the actual 1080P resolution model may have different scores, we will update our review with actual scores when we can test that model.

### Geekbench 5 and 6

Our first benchmark is with Geekbench 5 & 6; they test the single and multi-core performance of the processor.

AYANEO Pocket S Geekbench 5 Benchmark Comparison

On Geekbench 5 we got scores of 1427 & 4172 at 1440P, and a bit higher at 1080P with 1,535 & 4,739 respectively. Interestingly, the AYN Odin 2 still has a higher multi core score against both resolutions of the [AYANEO Pocket S](https://droix.net/product/ayaneo-pocket-s/).

AYANEO Pocket S Geekbench 6 Benchmark Comparison
...
AYANEO Pocket S Antutu Benchmark Comparison
...
AYANEO Pocket S 3DMARK Benchmark Comparison

In the Slingshot benchmark, the [AYANEO Pocket S](https://droix.net/product/ayaneo-pocket-s/) maxed out the score as expected. In the more demanding Wildlife Extreme benchmark, we get scores of 3937 at 1440P, and 4314 at 1080P, a nice jump in performance.

## Benchmark Summary

For 1440P resolution, keeping in mind the Odin 2 is 1080P, we see fairly small differences in performance for the [AYANEO Pocket S](https://droix.net/product/ayaneo-pocket-s/). 3% for Antutu, lower differences in Geekbench, and just 6% in Wildlife Extreme.

At 1080P, and do remember these are from adjusting the resolution, so may not be 100% accurate. In Geekbench 5 , we see a 3% difference in favour of the Pocket S for single core, and for multi-core we see a 6% difference in favour of the [AYN Odin 2](https://droix.net/product/ayn-odin-2/).
...
Overall the [AYANEO Pocket S](https://droix.net/product/ayaneo-pocket-s/) does come out on top in the 1080P comparisons. There are small margins in general usage, but on GPU heavy usage there is a larger gap in performance.
...
We know from the [AYN Odin 2](https://droix.net/product/ayn-odin-2/) that these newer Snapdragon processors are great for emulation. We saw that the now sadly departed Yuzu was even able to run some games at great speeds. Before we check that emulator out, let’s have a quick look at some older consoles and work our way up to the newer ones.
...
Dolphin emulator on the Pocket S
...
The main factors really come down to the design and price for me personally. The [AYANEO Pocket S](https://droix.net/product/ayaneo-pocket-s/) looks amazing, but it’s not as comfortable to play on as the [AYN Odin 2](https://droix.net/product/ayn-odin-2/). The performance is not so much a factor as there’s not a large gap and nothing will really benefit from it on the Pocket S.  Which one would you choose and why? Let us know in the comments.

You can learn more and [buy the AYANEO Pocket S here](https://droix.net/product/ayaneo-pocket-s/). Use the discount code POCKETS5OFF on the Checkout for 5% off. The code is valid for one month of this review being posted and can not be used during store sales or promotions.

[BUY THE AYANEO POCKET S HERE](https://droix.net/product/ayaneo-pocket-s/)
