---
title: ONEXPLAYER 1S Review – Handheld Gaming PC Overview
source_url: "https://droix.net/blogs/onexplayer-1s-review/"
source_site: droix.net
type: review-blog
date: 2021-08-05
---

Welcome to the official DroiX ONEXPLAYER 1S review! Popular mini laptop manufacturer One-Netbook have finally taken a shot at their version of a handheld gaming PC!

Contents

[ONEXPLAYER 1S Unboxing](#onexplayer-1s-unboxing)

[ONEXPLAYER 1S Review](#onexplayer-1s-review)

[Size](#size)

[Features](#features)

[Back of the ONEXPLAYER 1S](#back-of-the-onexplayer-1s)

[Top of the ONEXPLAYER 1S](#top-of-the-onexplayer-1s)

[ONEXPLAYER 1S Review Part Two Out Now!](#onexplayer-1s-review-part-two-out-now)

[Where to buy the ONEXPLAYER 1S](#where-to-buy-the-onexplayer-1s)

[ONEXPLAYER FAQ – All You Need To Know](#onexplayer-faq-all-you-need-to-know)

[What is the ONEXPLAYER?](#what-is-the-onexplayer)

[[FAQ] ONEXPLAYER Preliminary Specifications](#faq-onexplayer-preliminary-specifications)

[[FAQ] ONEXPLAYER Performance](#faq-onexplayer-performance)

[[FAQ] ONEXPLAYER Design](#faq-onexplayer-design)

[Another gaming handheld?](#another-gaming-handheld)

[[FAQ] ONEXPLAYER Release Date](#faq-onexplayer-release-date)
...
High quality braided USB Type C Cable
...
There are clickable dual analogue joysticks which are manufactured by [ALPS](https://www.alpsalpine.com/e/), widely known for their high quality sticks.
...
A nice and useful feature is the built in stand which lifts up. You can then sit the ONEXPLAYER on a flat surface which is great when using it as a desktop PC or watching [DroiX videos on YouTube](https://www.youtube.com/user/DroidboxInUK)!
...
The second part of our ONEXPLAYER 1S review video and blog post is now online [here](https://droix.net/blogs/onexplayer-review-gameplay-tests-with-nine-aaa-games/). We are playing nine AAA Windows games showing around a minute or so of each game to see their performance.

## Where to buy the ONEXPLAYER 1S

We have a dedicated full detail product page where you can also [buy the ONEXPLAYER 1S here](https://droix.net/product/onexplayer-1s/), the release date is expected around September 3rd.
...
***Originally posted by [benjamin](https://droix.net/blogs/author/benjamin/)* *on:**  30/07/2021*

Welcome to our FAQ for the [ONEXPLAYER](https://droix.net/product/onexplayer-1s/) – where we’ll go over all you need to know about this up-and-coming [handheld gaming console](https://go.droix.co.uk/HANDHELD-GAMING-CONSOLES)!

### What is the ONEXPLAYER?

The ONEXPLAYER is an up-and-coming Intel gaming handheld PC developed by ONE NETBOOK. A manufacturer of various small-form-factor laptops. Such as the popular [One Mix 3](https://go.droix.co.uk/ONE-NETBOOK-ONE-MIX-3-PRO-PLATINUM) series of business [mini laptops](https://go.droix.co.uk/MINI-LAPTOPS), the [GX1](https://go.droix.co.uk/ONE-GX1) mini [gaming laptop](https://go.droix.co.uk/GAMING-LAPTOPS), and the niche engineering-centric [A1](https://go.droix.co.uk/DroiX-One-Netbook-A1).
...
The ONEXPLAYER has officially been listed by ONE NETBOOK in three configurations. One with an [Intel Core i5-1135G7](https://www.intel.com/content/www/us/en/products/sku/208658/intel-core-i51135g7-processor-8m-cache-up-to-4-20-ghz/specifications.html) processor and a 512GB SSD, one with an [Intel Core i7-1165G7](https://www.intel.com/content/www/us/en/products/sku/208662/intel-core-i71165g7-processor-12m-cache-up-to-4-70-ghz/specifications.html) and a 1TB SSD; and finally, one with an [Intel Core i7-1185G7](https://www.intel.com/content/www/us/en/products/sku/208664/intel-core-i71185g7-processor-12m-cache-up-to-4-80-ghz-with-ipu/specifications.html) and a 2TB SSD.

Blink and youll miss it The most powerful ONEXPLAYER sold out within hours of the kickstarter going live
...
One Netbook tested various titles released in the 2010s
...
Given that it uses the same kind of processor(s) as the [GPD Win 3](https://go.droix.co.uk/GPD-WIN-3), and the same kind of RAM, you can expect similar performance from both, which can be seen in the [GPD Win 3’s benchmarks](https://youtu.be/LsFyCxmE_-o).
...
An eGPU is essentially a dedicated graphics card (of your choice) that is contained within a separate enclosure (also your choice!), and provides power and protection to the card. The [ONEXPLAYER can then connect to this eGPU](https://youtu.be/h9c1T-ZukQA?t=572) enclosure, and the two devices can work in tandem as if they were a normal PC.

Running an eGPU setup WILL be prohibitively expensive for most, even more so given the [poor availability of graphics cards](https://www.techspot.com/article/2294-gpu-pricing-2021-update/) currently. But it is an option for those interested.
...
The ONEXPLAYER has three configurations currently “available” (at least, they technically exist) across a variety of processor/storage combinations. The prices listed here are representative of the prices provided by the [official crowdfunding page.](https://www.indiegogo.com/projects/onexplayer-best-performing-handheld-game-console#/) Early purchasers were able to snatch discounts of up to 15%.
...
The [ONEXPLAYER can also be purchased from DroiX](https://droix.net/product/onexplayer-1s/), starting from £1049 GBP. This features a 30 day refund window and a 1 year warranty that is handled by a UK-based team.
...
* Massive 8.3 inch full-fit FHD IPS touch screen @ 2560x1600 resolution
...
Play AAA Windows games and high end emulators wherever you are!
