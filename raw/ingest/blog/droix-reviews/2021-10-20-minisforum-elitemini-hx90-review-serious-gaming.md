---
title: MinisForum EliteMini HX90 Review – SERIOUS Gaming!
source_url: "https://droix.net/blogs/minisforum-elitemini-hx90-review/"
source_site: droix.net
type: review-blog
date: 2021-10-20
---

Hello and welcome to DroiX. Today we are checking out the [MinisForum EliteMini HX90](https://go.droix.co.uk/MINISFORUM-HX90) with an unboxing and overview of the [Mini PC’s](https://go.droix.co.uk/MINI-PC) specs and features. After in our review, we will be performing some system and gaming benchmarks, then testing a few games and emulators.

Contents

[MinisForum EliteMini HX90 Review Video](#minisforum-elitemini-hx90-review-video)

[MinisForum EliteMini HX90 Unboxing](#minisforum-elitemini-hx90-unboxing)

[HX90 Overview](#hx90-overview)

[MinisForum EliteMini HX90 Technical Specifications](#minisforum-elitemini-hx90-technical-specifications)

[MinisForum HX90 System Benchmarks](#minisforum-hx90-system-benchmarks)
...
[MinisForum HX90 Game Benchmarks](#minisforum-hx90-game-benchmarks)
...
[Gameplay and Emulator Footage](#gameplay-and-emulator-footage)

[Where to buy the MinisForum HX90](#where-to-buy-the-minisforum-hx90)
...
Next is a VESA mount and screws to attach to the back of your TV or monitor. There is a HDMI cable and some foam feet for the stand, as well as some screws and [SATA](https://en.wikipedia.org/wiki/Serial_ATA) cables for installing two internal drives. And last but not least, there is a stand for the HX90 to position it vertically.
...
| **CORES** | 8 |
| **THREADS** | 16 |
| **BASE / MAX FREQUENCY** | 3.3 GHz / 4.60 GHz |
|  |  |
...
|  |  |
| **RAM** | 16GB or 32GB |
| **STORAGE** | 256GB/512GB/1TB M.2 PCI-e NVMe SSD Space inside for two 2.5″ HDD/SSD |
| **CONNECTIVITY** | 2.5G Ethernet Adapter (RJ45) 802.11a/ac/b/g/n/ax Module – Dual-Band WiFi 6 Bluetooth 5.2 |
...
As mentioned, the [MinisForum HX90](https://go.droix.co.uk/MINISFORUM-HX90) is a very capable Mini PC for gaming thanks to its AMD Ryzen 9 CPU and GPU. For the HX90 review, the benchmarks are done at maximum settings to fully test, in usual circumstances you would need to run the games at lower settings to have better performance.
...
| **PCMARK** | 6,682 |
| **3DMARK** | 1,699 |
| **FORZA HORIZON 4** | 56 FPS |
| **STREET FIGHTER V** | 38 FPS (average across the first match) |
| **SHADOW OF THE TOMB RAIDER** | Lowest Default Settings: 71 FPS Medium Default Settings: 42 FPS Highest Default Settings: 36 FPS |
| **FINAL FANTASY XIV** | 4,012 (Standard rating level) |
...
Overall I am very impressed with the [MinisForum EliteMini HX90](https://go.droix.co.uk/MINISFORUM-HX90). As a home or office work mini PC it excels. As a gaming machine it does a very good job! If you are a casual gamer then this is a highly considerable option. It would also be ideal in the living room as a second PC for casual gaming or streaming from your main gaming PC.

Mass Effect Legendary 1280×720 on Maximum Settings

You also have the bonus of it supporting two internal 2.5” drives and fast ethernet, so it is great as a NAS for media and storage as an example. I like the HX90 a lot, if you are looking for a high performance gaming mini pc, then look no further, [MinisForum](https://go.droix.co.uk/MINISFORUM) have done an amazing job!

## Gameplay and Emulator Footage

In our [MinisForum HX90 Review video](https://www.youtube.com/watch?v=-pDN2F6Ua7k) we spend a bit of time playing some Windows games and emulators including PSP, Xbox Original and PlayStation 2.
...
For emulation, the PSP emulator [PPSSPP](https://www.ppsspp.org/) works great and you can increase the rendering resolution to 1080P with no frame drops. Xbox games that are compatible with the CXBX Reloaded emulator work great! In many cases you can increase the rendering resolution to higher than the Xbox native resolution. The PlayStation 2 emulator PSCX2 also works very well, again you can increase the resolution and still enjoy full 60 FPS frame rates.

MinisForum EliteMini HX90 PS2 Emulation

## Where to buy the MinisForum HX90

That wraps up this review, you can learn more and buy the [MinisForum EliteMini HX90 Mini PC here](https://go.droix.co.uk/MINISFORUM-HX90). Or alternatively you can [browse our range of Mini PC’s here](https://go.droix.co.uk/MINI-PC).

[BUY NOW](https://go.droix.co.uk/MINISFORUM-HX90)