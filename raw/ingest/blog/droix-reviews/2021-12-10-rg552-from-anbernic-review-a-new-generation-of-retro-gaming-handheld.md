---
title: RG552 from Anbernic Review – A new generation of retro gaming handheld!
source_url: "https://droix.net/blogs/anbernic-rg552-review/"
source_site: droix.net
type: review-blog
date: 2021-12-10
---

We have the eagerly anticipated [RG552 from Anbernic](https://go.droix.co.uk/RG552) review sample today. We will be unboxing it and taking a closer look at its features including the Android and Linux operating systems. Then we will run a bunch of emulators and compare the performance of them between the two OS’s.

Contents

[RG552 Review Video](#rg552-review-video)

[RG552 from Anbernic Unboxing](#rg552-from-anbernic-unboxing)

[RG552 Overview](#rg552-overview)

[Comparison](#comparison)

[RG552 Technical Specifications](#rg552-technical-specifications)

[Dual Boot Operating Systems](#dual-boot-operating-systems)
...
[GBA and Drastic](#gba-and-drastic)
...
[Where to buy the RG552 from Anbernic?](#where-to-buy-the-rg552-from-anbernic)

[ANBERNIC RG552 FAQ – Everything We Know So Far](#anbernic-rg552-faq-everything-we-know-so-far)

[21/01/2022 Update:](#21012022-update)

[15/12/2021 Update:](#15122021-update)

[10/12/2021 Update: RG552 Review Video](#10122021-update-rg552-review-video)

[6/12/2021 Update: RG552 Pre-Orders Closed Temporarily](#6122021-update-rg552-preorders-closed-temporarily)

[2/12/2021 Update: RG552 Pre-Orders Closed Temporarily](#2122021-update-rg552-preorders-closed-temporarily)

[1/12/2021 Update: RG552 Pre-Orders Are Now Open (On DroiX)](#1122021-update-rg552-preorders-are-now-open-on-droix)

[30/11/2021 Update: Official Promo Video Premiere](#30112021-update-official-promo-video-premiere)

[18/11/2021 Update: RG552 Release Date Announced!](#18112021-update-rg552-release-date-announced)

[16/11/2021 Update: More Screenshots and Video Footage](#16112021-update-more-screenshots-and-video-footage)

[What is the ANBERNIC RG552?](#what-is-the-anbernic-rg552)

[RG552 Specifications](#rg552-specifications)

[RG552 Preview](#rg552-preview)

[RG552 Performance](#rg552-performance)

[RG552 Price?](#rg552-price)

[ANBERNIC RG552 Release Date?](#anbernic-rg552-release-date)
...
The [Anbernic RG552](https://droix.net/product/rg552/) measures 7.8 x 3.3 x 0.7 inches (20 x 8.5 x 2 cm) and weighs 353 grams. The IPS touchscreen measures 5.36 inches with a resolution of 1920×1152.
...
Compared to the amazing [RG351MP from Anbernic](https://go.droix.co.uk/RG351MP) you can see that the RG552 screen is a fair bit larger.

RG552 compared to RG351MP

But when compared with the [GPD XP](https://go.droix.co.uk/GPD-XP), the ultra widescreen is larger than the RG552. Personally I prefer the RG552 widescreen as it offers the best compatibility with Android games and emulators.

RG552 vs GPD XP

A very brief comparison between the RG552 and GPD XP with [Geekbench 5.](https://www.geekbench.com/) The RG552 scores 266 on single core and 714 on multi-core, and the GPD XP scoring 501 and 1601 on the respective cores. If you would like to see more benchmarks let us know in the comments.
...
| **RAM** | 4GB LPDDR4 |
| **STORAGE** | 64GB internal eMMC (Android OS) 16GB Micro SD Card (for Linux OS) 64GB Micro SD Card (for storage) |
...
That wraps our review of the Anbernic RG552. We hope you have found it useful. You can learn more and [buy your RG552 from Anbernic here](https://go.droix.co.uk/RG552). Or browse our wide range of [Retro Gaming Handhelds here](https://go.droix.co.uk/RETRO-GAMING-HANDHELD).

[BUY NOW](https://droix.net/product/rg552/)

---

## ANBERNIC RG552 FAQ – Everything We Know So Far

**Originally posted by [benjamin](https://droix.net/blogs/author/benjamin/)* *on:*  01/10/2021*
...
**Disclaimer:** ~~As of 01/10/2021 – Everything on this page is “hearsay” taken from a mixture of community posts from the (awesome) [RetroGameHandhelds](https://www.rghandhelds.com/) Discord and Baidu Tieba, a popular Chinese forum. So take every granule of information posted here with a grain of salt, **as nothing is finalized until ANBERNIC publicly announce it themselves.**~~

**Last Updated: 10/12/2021:**  RG552 Firmware Update Guide added!

### 21/01/2022 Update:

We’ve made a MEGA GUIDE on [how to get started with the RG552](https://go.droix.co.uk/RG552-GUIDE). If anything, it’s more of an FAQ than this article!
...
[You can pre-order an RG552 from DroiX here](https://go.droix.co.uk/RG552), for a limited time price of £184.95. Once this promotion is over, the RG552 will cost £209.95.
...
However, given the precarious time of year when it comes to international shipping (delays can always happen), We would advise opting for an alternative [Retro Gaming Handheld](https://go.droix.co.uk/RETRO-GAMING-HANDHELD) if you urgently need a gift for the holiday season.
...
[Want to pre-order the RG552? Check out our listing on droix.co.uk!](https://go.droix.co.uk/RG552)
...
We’ll also have other articles live in the weeks following its launch (we’re particularly excited to try the **good** up-and-coming [Android PS2 emulator](https://pcsx2.net/301-aethersx2-pcsx2-mobile.html) on it, for what it’s worth).
...
We ourselves will be expecting a sample to arrive in the coming weeks, so follow us on social media ([Youtube](https://www.youtube.com/user/DroidboxInUK), [Facebook](https://www.facebook.com/DroiX.Store), [Instagram](https://www.instagram.com/droix.store/), [Twitter](https://twitter.com/DroiX_Store)) to get a glimpse of it when it arrives!
...
The rumoured “11/11” release date turned out to be just that – a rumour. As humorous as it would be to launch a geeky gadget on [Singles’ Day](https://en.wikipedia.org/wiki/Singles%27_Day), ANBERNIC stayed quiet.

(It is unusual that they missed an opportunity to announce the device however).

#### Reviewer Units Arriving

Dont worry thats just a business card on the box

Retro gaming handheld hobbyist [DIYGameModz](https://www.youtube.com/c/DIYGameModz) uploaded a video on the 16th showcasing the Retroarch XMB-styled menus.
...
The ANBERNIC RG552 is the next generation in [ANBERNIC](https://go.droix.co.uk/ANBERNIC)‘s collection of [retro gaming handhelds](https://go.droix.co.uk/RETRO-GAMING-HANDHELD).
...
With many “next generation” devices on the immediate horizon, such as the Miyoo P60, the [AYN ODIN](https://go.droix.co.uk/AYN-ODIN-FAQ), and more. It remains to be seen if there will be a common SoC used across multiple devices (like the Rockchip RK3266).

### RG552 Specifications

|  |  |
| --- | --- |
| **CPU/Processor** | Rockchip RK3399 (6 Cores @ 1.8GHz) |
| **RAM** | 4GB LPDDR4 |
| **Display Size** | 5.5 Inches |
| **Display Resolution** | 1920×1152 |
| **Aspect Ratio** | 5:3 |
| **Control Layout** | Dual Analog; Symmetrical (Lower) |
| **Storage** | 64GB eMMC |
| **SD Card Layout** | 2x External |
| **Battery** | 2x 3200mAh |
| **Charging** | Input – 9V~12V ≥2.5A Supports Fast Charging (PD, QC, AFC, etc.) |
| **Operating System** | Linux (Batocera, etc.) via microSD Android 7.1 via eMMC |
| **Speakers** | Dual Stereo Speakers |
| **Device Weight** | Unknown |
| **Dimensions** | Unknown |
| **Colours Available:** | Black, Bronze Gray |
| **Other Features** | “10-point” Touch Screen HDMI Output (tentatively full-sized) 3.5mm Headphone Jack Active Cooling (heatsink + fan) Built-in Rumble (“dual motors”) |
...
Notable custom firmware teams to keep an eye on are those mentioned in our [best RG351 custom firmware guide](https://go.droix.co.uk/RG351-CFW). At least one of these developers will likely create something for the device at some point… or perhaps a new developer will rise up out of the blue?

#### Return of the HDMI

Reports indicate that the RG552 will feature a HDMI port – a feature which has been entirely absent from the “[third generation](https://go.droix.co.uk/ANBERNIC-GUIDE)” of ANBERNIC handhelds. With the more powerful processor and higher resolution display than previous models, it should provide a better overall experience.
...
In terms of layout/appearance, the RG552 does not reinvent the wheel. Instead, it is almost identical in layout to ANBERNIC’s other horizontal handhelds, such as the [RG351P](https://go.droix.co.uk/RG351P).

[](https://droix.net/blogs/wp-content/uploads/2021/10/RG552_fan_demo.webm)
...
[](https://droix.net/blogs/wp-content/uploads/2021/10/RG552_tekken_PSP_2x_res.webm)

RG552 Playing Tekken 6 [PSP]

[](https://droix.net/blogs/wp-content/uploads/2021/10/RG552_playing_GOW_PSP.webm)
...
In addition, the RG552 may potentially be able to handle some *lightweight* Gamecube emulation, [as can be witnessed on devices with the same processor.](https://www.youtube.com/watch?v=3k1JhDqMbA0)
...
**1/12/2021 Update:** The release price for the RG552 is £209.95 GBP, [if ordered directly from us at DroiX](https://go.droix.co.uk/RG552).
