There’s clickable dual [hall sensor](https://en.wikipedia.org/wiki/Hall_effect_sensor) analogue sticks which are magnetic sensors that reduce wear and tear and also prevent drifting. You have a nicely styled D-Pad and your usual gaming buttons. There are two additional buttons that activate AYA SPACE and show the desktop.
...
AYA SPACE has continued to improve on its features since [we first took a look](https://droix.net/blogs/aya-space-official-frontend-for-the-aya-neo-and-aya-neo-pro/) at the software when it was first released. It is primarily a frontend for your installed games and you can browse your collection and launch them from AYA SPACE.
...
On the Assistant tab you have access to various stats and it is also where you can do some customising. In the controller mode you configure the joysticks, buttons and gyro. And new for the [AYANEO Air](https://droix.net/product/ayaneo-air/) is the RGB lighting where you can choose from a variety of patterns. It’s a nice feature.
...
Continuing our [AYANEO Air](https://droix.net/product/ayaneo-air/) review we also perform some gaming benchmarks starting with Forza Horizon 5 running at 720P on the lowest graphics settings.

AYANEO Air Forza Horizon 5 Benchmark
...
AYANEO Air Final Fantasy XIV Benchmark
...
AYANEO Air Street Fighter V Benchmark
...
AYANEO Air Shadow of the Tomb Raider Benchmark
...
AYANEO Air Cyberpunk 2077 Benchmark

We were not expecting a high frame rate as this is a very demanding game, we got a score of 12.77 frames per second.

## Benchmark Comparison & Summary

Let’s have a brief recap of the benchmark results for this AYANEO Air review and compare them with a lower cost [Win 600](https://droix.net/product/anbernic-win600-retro-gaming-handheld/) and higher priced [AYANEO NEXT Pro](https://droix.net/product/ayaneo-next-pro/) PC gaming handhelds.
...
In our [Win 600 review](https://droix.net/blogs/win-600-review/) we mentioned that it was ideal for playing your older game collection and emulation up to the Dreamcast and PlayStation era. As we will see shortly the [AYANEO Air](https://droix.net/product/ayaneo-air/) does play newer games, but with many you do have to compromise. It’s fine for older games but you’re not quite sure where the limit is when you try newer ones. And if you want the latest higher end games, then you may not have a great deal of luck. You should probably wait for [the next generation Windows gaming handhelds](https://droix.net/blogs/top-5-upcoming-pc-gaming-handhelds/) with Ryzen 6000 series processors.
...
Continuing our AYANEO Air review, so we know that while the [AYANEO Air](https://droix.net/product/ayaneo-air/) Windows handheld does struggle with higher demanding games, let’s take a look at some other games at the default 8W TDP with playable graphics settings to see how they perform.
...
TMNT Shredders Revenge on the Air
...
And we round off our emulation tests with RyuJinx and Cruisn’ Blast. We are getting around 23 frames per second on the new Vulkan graphics engine and around 20 on OpenGL. You will have better performance for lower demanding games but overall the [AYANEO Air](https://droix.net/product/ayaneo-air/) is not quite fast enough to play many games on this emulator. An alternative small handheld is the [GPD Win 4](https://droix.net/product/gpd-win-4/) which will be available in November. It will feature the high performance AMD Ryzen 7 6800U processor.

## Where to buy the AYANEO Air?

You can learn more and [buy the AYANEO Air here](https://droix.net/product/ayaneo-air/) or the larger battery model [AYANEO Air Pro here](https://droix.net/product/ayaneo-air/). Or browse our wide range of [handheld game consoles here](https://droix.net/blogs/product-category/handhelds/handheld-game-consoles/).

[BUY AYANEO AIR & PRO](https://droix.net/product/ayaneo-air/)
