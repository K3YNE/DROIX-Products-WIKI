---
title: AYANEO Pocket AIR review with video – Premium Android 12 gaming handheld
source_url: "https://droix.net/blogs/aya-neo-pocket-air-review-with-video/"
source_site: droix.net
type: review-blog
date: 2023-12-06
---

The [AYANEO Pocket AIR](https://droix.net/product/aya-neo-pocket-air/) is AYA’s first Android handheld in what is already a very competitive market. Will their different approach with a premium design and custom software be enough to warrant a buy? Find out in our full AYANEO Pocket AIR review!

Contents

[AYANEO Pocket Air review video](#ayaneo-pocket-air-review-video)

[Unboxing the AYA NEO Pocket Air](#unboxing-the-aya-neo-pocket-air)

[Overview of the AYANEO Pocket Air](#overview-of-the-ayaneo-pocket-air)

[AYANEO Pocket Air Technical Specifications](#ayaneo-pocket-air-technical-specifications)

[Android OS and software overview](#android-os-and-software-overview)
...
AYA NEO Pocket AIR Unboxing

## Overview of the AYANEO Pocket Air

We continue our AYANEO Pocket AIR review with an overview of the handheld itself. The [AYANEO Pocket Air](https://droix.net/product/aya-neo-pocket-air/) measures 8.8 x 3.5 x 0.6 inches (22.4 x 8.9 x 1.7 cm) and weighs 380g. The retro edition is available in just the one colour which is a Famicom inspired red and white, with some yellowed thumbstick caps which gives an aged look, a nice touch from [AYANEO](http://product-attribute/brands/ayaneo/)!

AYA NEO Pocket AIR Front View

The 5.5” [AMOLED](https://en.wikipedia.org/wiki/AMOLED) touchscreen display has a resolution of 1920x1080It does look great, really nice bright colours that stand out.
...
AYA NEO Pocket AIR Bottom View

The bottom has a covered slot for where you put your Nano-SIM and Micro SD card. Beside is a 3.5mm headphone port, followed by a USB Type-C 3.2 port. With one of our USB hubs, you can use it for HDMI output to a TV or monitor. Grab a [DroiX NT8 Clear USB Hub](https://droix.net/product/droix-nt8-clear-usb-hub/) or [NH8 hub with NVMe storage](https://droix.net/product/droix-nt8-clear-usb-hub/).
...
|  |  |
| --- | --- |
| **CPU** | [MediaTek Dimensity 1200](https://droix.net/product-attribute/processor-cpu-model/dimensity-1200/), 8 cores, up to 3.0GHz |
| **GPU** | [Mali G77](https://droix.net/product-attribute/graphics-gpu-model/g77-mp9/) |
| **RAM** | 8GB [LPDDR5](https://droix.net/product-attribute/memory-ram-technology/lpddr5/) |
...
The [AYANEO Pocket Air](https://droix.net/product/aya-neo-pocket-air/) runs on Android 12, it’s not the latest what with Android 14 rolling out, but it’s fairly up to date. Let’s take a closer look at AYA’s custom software for this AYA NEO Pocket AIR review.
...
AYA NEO Pocket AIR AYA Home

You get a fairly barebones Android setup with just the usual apps such as [Google Play Store](https://play.google.com/store/games), Google Suite of apps, File Manager etc. You will need to install any apps such as games and emulators yourself. You can get them from the Google Play and APKPure stores, or download manually.
...
As always we include benchmarks when we can in this AYANEO Pocket AIR review. As this is an Android OS we will run some benchmarks and compare the performance of the [AYANEO Pocket AIR](https://droix.net/product/aya-neo-pocket-air/) with other Android based devices. These include the [AYN Odin 2](https://droix.net/product/ayn-odin-2/), [Retroid Pocket Flip](https://droix.net/product/retroid-pocket-flip/) and Anbernic RG552.

### 3DMark

3DMark Slingshot Benchmark Comparison

Starting with 3DMark and the Slingshot benchmark. It maxed out which is a good sign.

3DMark Wildlife Extreme Benchmark Comparison
...
Geekbench Benchmark Comparison
...
Asphalt 8 on the AYA NEO Pocket AIR
...
Horizon Chase using gyroscope controls
...
DuckStation upscaling comparison up to 1080P with graphics tweaks

Instead we will take a closer look at the consoles around and after the PS1 era.

### Dolphin

Dolphin emulator on AYA NEO Pocket AIR
...
PPSSPP on AYA NEO Pocket AIR

The PlayStation emulator PPSSPP runs amazingly well. We are upscaling up to 1080P and have various graphics improvements enabled along with 16x Anisotropic filtering. We got a rock solid 60 FPS on God of War with the [AYANEO Pocket AIR](https://droix.net/product/aya-neo-pocket-air/) so that’s good enough for us.
...
AetherSX2 on AYANEO Pocket Air
...
Dreamcast emulator on AYA NEO Pocket AIR

The performance of the [AYANEO Pocket Air](https://droix.net/product/aya-neo-pocket-air/) is an important factor to consider. We did see great scores when compared to the GPD XP+ which used the same processor but slower RAM. Do consider the XP+ came out two years ago.

Compared to the AYN Odin 2, we see that this has around double the performance. Both devices launched at around the same time and at similar price ranges. The [Pocket Air](https://droix.net/product/aya-neo-pocket-air/) is not great for price vs performance when compared.

AYA NEO Pocket AIR running RetroArch PC Engine
...
You can [order the AYANEO Pocket AIR here](https://droix.net/product/aya-neo-pocket-air/). And browse our range of [retro gaming handhelds here](https://droix.net/product-category/handhelds/retro-gaming-handheld/).

[BUY AYANEO POCKET AIR HERE](https://droix.net/product/aya-neo-pocket-air/)
