---
title: One Netbook 5 Review with video – Interchangeable Mini Laptop & Tablet with Intel i7 CPU
source_url: "https://droix.net/blogs/onenetbook-5-review-with-video/"
...
[One Netbook 5 Review Video](#one-netbook-5-review-video)

[One Netbook 5 Unboxing](#one-netbook-5-unboxing)

[One Netbook 5 Overview](#one-netbook-5-overview)

[One Netbook 5 Technical Specifications](#one-netbook-5-technical-specifications)
...
|  |  |
| --- | --- |
| **CPU** | 12th Generation Intel [Core i7-1250U](https://droix.net/product-attribute/processor-cpu-model/core-i7-1250u/), 10 Total Cores (2 Performance Cores + 8 Efficient Cores), 12 threads, 4.70GHz |
| **GPU** | Intel [Iris Xe Graphics](https://droix.net/product-attribute/graphics-gpu-model/iris-xe-graphics/), 96 execution units. |
| **RAM** | 16GB/32GB [LPDDR5](https://droix.net/product-attribute/memory-ram-technology/lpddr5/)-5200MHz Dual-Channel |
| **STORAGE** | 1TB/2TB M.2 2280 PCIe 4.0\*4 SSD |
| **DISPLAY** | 10.1-inch FHD [LTPS](https://droix.net/product-attribute/display-type/ltps/) Screen Resolution: 2560×1600 Pixel Density: 300 PPI sRGB: 108.8% High Color Gamut Volume 10-Point Multi-Touch Support 4096 Pressure Levels Stylus Pen Support Aspect Ratio: 16:10 |
| **COMMUNICATIONS** | 2.4G/5G Dual-Band [WiFi 6.0](https://droix.net/product-attribute/wi-fi/6/) Bluetooth 5.2 |
| **I/O** | USB-C 4.0\*1 (Supports Hub/4K Monitor, eGPU docking station) USB-C 3.2\*1 3.5mm Audio Port\*1 Micro SD (TF)\*1 (micro 4.0 protocol, max read speed around 300MB/s, supports up to 2TB capacity expansion) |
| **BATTERY** | 11,000mAh (3.85V, 42.35Wh) Standard 65W GaN Charger PD Fast Charging Support |
| **DIMENSIONS** | 9.1 x 6.5 x 0.59 inches (23.2 x 16.7 x1.5 cm) |
| **WEIGHT** | 970g / 2.13 lbs |
...
We get a score of 36,163 which is strangely lower than the A1 Pro and [GPD Pocket 3](https://droix.net/product/gpd-pocket-3/). For some reason the GPU tests did not get great scores despite having a faster GPU than the other two devices.
...
With an eGPU such as the [GPD G1 eGPU docking station](https://droix.net/product/gpd-g1/) it opens up the number of games and you get decent performance. But remember it’s not just for gaming, it’s also useful for video and image rendering for example.
