---
title: "AYANEO Pocket DS Review: Does it Beat the AYN Thor? (A Deep Dive)"
source_url: "https://droix.net/blogs/ayaneo-pocket-ds-review/"
source_site: droix.net
type: review-blog
date: 2025-11-21
---

The dual screen [Android gaming handheld](https://droix.net/product-category/gaming-handheld/android-gaming-handheld/ "Android gaming handheld") scene has been very popular lately with AYANEO and AYN’s offerings, as well as Anbernics recently announced handheld. Following this trend, in our [AYANEO Pocket DS](https://droix.net/product/ayaneo-pocket-ds/ "AYANEO Pocket DS") review, we will be taking a closer look at what makes it stand apart from AYN’s.

Contents

[AYANEO Pocket DS Review Video](#ayaneo-pocket-ds-review-video)

[AYANEO Pocket DS Overview](#ayaneo-pocket-ds-overview)

[AYANEO Pocket DS Look & Feel](#ayaneo-pocket-ds-look-amp-feel)

[AYANEO Pocket DS Review Technical Specifications](#ayaneo-pocket-ds-review-technical-specifications)

[AYANEO Pocket DS Review System Benchmarks](#ayaneo-pocket-ds-review-system-benchmarks)
...
[AYANEO Pocket DS Software](#ayaneo-pocket-ds-software)
...
[AYANEO Pocket DS Review Final Thoughts](#ayaneo-pocket-ds-review-final-thoughts)
...
AYANEO Pocket DS Bottom Side View



AYANEO Pocket DS Top Side View
...
As part of our [AYANEO Pocket DS](https://droix.net/product/ayaneo-pocket-ds/ "AYANEO Pocket DS") review we cover the technical specifications as well as our own battery life, fan noise and temperature tests.

|  |  |
| --- | --- |
| **MAIN DISPLAY** | 7″ 1080P [OLED](https://droix.net/product-attribute/display-type/1920x1080-oled/ "OLED") vibrant high refresh-rate display Full-angle adjustable hinge Max opening angle: 180° Resolution: 1920 x 1080 Supports HDR 150% sRGB color gamut volume 800 nits peak brightness 90% DCI-P3 color gamut Five refresh rate options: [165Hz](https://droix.net/product-attribute/refresh-rate/165hz/ "165Hz") / [144Hz](https://droix.net/product-attribute/refresh-rate/144hz/ "144Hz") / [120Hz](https://droix.net/product-attribute/refresh-rate/120hz/ "120Hz") / [90Hz](https://droix.net/product-attribute/refresh-rate/90hz/ "90Hz") / [60Hz](https://droix.net/product-attribute/refresh-rate/60hz/ "60Hz") |
| **SECONDARY DISPLAY** | 5″ LCD screen with 1024 x 768 resolution [4:3](https://droix.net/product-attribute/aspect-ratio/1024x768-43/ "4:3") aspect ratio 256PPI 100% sRGB color gamut volume 550 nits peak brightness |
...
| **BATTERY** | 8,000mAh, 40W PD charging |
| **COLOURS** | ShadowDance Black / Starry Yellow / Retro Gray |
| **SIZE** | 7.05 x 3.98 x 0.98 inches (17.9 x 10.1 x 2.5 cm) |
| **WEIGHT** | 540g (1.19lbs) |
...
For our benchmarks in this [AYANEO Pocket DS](https://droix.net/product/ayaneo-pocket-ds/ "AYANEO Pocket DS") review, we will be testing with the bottom display switched on and off to see differences in performance. We will also be comparing it to the AYN Thor, which has a different processor, and the [AYANEO Pocket ACE](https://droix.net/product/ayaneo-pocket-ace/ "AYANEO Pocket ACE") and DMG, which have the same.
...
Antutu tests the overall performance of Android gaming handhelds. Here, we see excellent results in both Dual and Single screen scores, taking first place over the same CPU Pocket ACE & [AYANEO Pocket DMG](https://droix.net/product/ayaneo-pocket-dmg/ "AYANEO Pocket DMG"). Truly impressive!
...
In addition, their game launcher, AYA Space, hasn’t really changed much over time. You can add your game and ROM collection here and it will list them. However, we would love to see a built-in game scraping feature to really complete this [AYANEO](https://droix.net/product-attribute/brands/ayaneo/ "AYANEO") software.
...
AYANEO Pocket DS AYA Settings



AYANEO Pocket DS Dual Display Settings
...
Browsing the web while playing Prince of Persia



Built in game screen mapping

## Emulation

The Snapdragon series are great for emulation, and consequently, it will run just about everything up to the PlayStation 2 era without breaking a sweat. In most cases, you can increase the rendering resolution for improved visuals, add graphics tweaks, etc. Moreover, the [Turnip](https://github.com/K11MCH1/AdrenoToolsDrivers "Turnip") graphics drivers have improved a great deal in the past year, and we are seeing improvements in higher-end emulators especially. Let’s take a look at a few:
...
The Cemu emulator is in fairly early stages of development, so it’s not massively compatible. You will need to use a [forked Cemu version](https://github.com/SapphireRhodonite/Cemu/releases/tag/0.0.2 "forked Cemu version") of this emulator for dual screen support. However, there are not many games that use the two displays, so for now, you are not missing much.
...
Lets sum up our AYANEO Pocket DS review with our final thoughts. Overall, the [AYANEO Pocket DS](https://droix.net/product/ayaneo-pocket-ds/ "AYANEO Pocket DS") is a fantastic Android gaming handheld. In our benchmark tests, for instance, we saw some top results against the same CPU devices. I reckon the physically larger device and its cooling has helped there.
...
So, as to which you should decide on between the two, both have their advantages and disadvantages in terms of performance, design, size, portability, etc. We recently had a popular discussion on [Reddit](https://www.reddit.com/r/DroiX/comments/1o7cplg/ayn_thor_compared_with_ayaneo_pocket_ds_which_do/ "Reddit"), and there is no clear winner decided there in the comments. Ultimately, it is a bit of a personal preference for this type of gaming Android handheld.

[BUY THE AYANEO POCKET DS HERE](https://droix.net/product/ayaneo-pocket-ds/)
