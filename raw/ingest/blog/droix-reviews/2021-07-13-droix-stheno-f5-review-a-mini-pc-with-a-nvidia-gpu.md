---
title: DroiX Stheno F5 Review – A mini PC with a NVIDIA GPU!?
source_url: "https://droix.net/blogs/droix-stheno-f5-review-a-high-performance-gaming-mini-pc/"
...
[DroiX Stheno F5 Review Video](#droix-stheno-f5-review-video)

[DroiX Stheno F5 Unboxing](#droix-stheno-f5-unboxing)

[DroiX Stheno F5 Overview](#droix-stheno-f5-overview)

[Stheno F5 Internals](#stheno-f5-internals)

[Stheno F5 Technical Specs](#stheno-f5-technical-specs)

[Windows Overview](#windows-overview)

[DroiX Stheno F5 Review: Benchmarks](#droix-stheno-f5-review-benchmarks)
...
[Emulators Overview](#emulators-overview)
...
[DroiX Stheno F5 Review: Summary](#droix-stheno-f5-review-summary)

[Where to buy the DroiX Stheno F5](#where-to-buy-the-droix-stheno-f5)

The [DroiX Stheno F5 Gaming Mini PC](https://go.droix.co.uk/DROIX-STHENO-F5)is to put quite simply, an impressive and high performing gaming setup. With an Intel i5-9300H Quad Core processor and Nvidia GeForce GTX 1650 dedicated graphics card, you can enjoy the best AAA games with amazing visual settings!

The Mini PC with Windows is available in three DDR4 RAM & [M.2 PCI-e NVMe](https://www.kingston.com/unitedkingdom/en/community/articledetail/articleid/48543) SSD Storage configurations; 16GB/256GB, 16GB/512GB and a massive 32GB/1TB. There’s space inside to add an internal 2.5” HDD/SSD to increase the storage capacity.

## DroiX Stheno F5 Review Video
...
First, we have a user guide, which is in full English and will get you up and running in no time at all. There is the Stheno F5 Mini Computer which we will review in more detail shortly. Included is a power brick and cable. We will include the correct adaptor for your country. And last but not least is a HDMI cable to connect to your TV or monitor.

## DroiX Stheno F5 Overview

Stheno F5 Front View

The F5 keeps a sleek clean look with just a power button on the front. It measures 8.6 x 7.6 x 1.5 inches (22 x 19.5 x 4 cm)

On the back is where you can find all the ports.

Stheno F5 Back View

There is the Power Supply port and a USB Type-C port is next. It’s ideal for connecting high speed peripherals to. There are both DisplayPort 1.4 and HDMI 2.0, for connecting to your TV or monitor.

Beside those are two USB 2 ports and four USB 3 ports. There is a high speed Gigabit ethernet for fast and reliable data transfer. And finally there is a 3.5 mm headphone port
...
| **CORES** | 4 |
| **THREADS** | 8 |
| **MAX FREQUENCY** | 4.10 GHz |
|  |  |
| **GPU** | NVIDIA GeForce GTX 1650 |
| **RAM** | 4GB GDDR5 |
| **MAX FREQUENCY** | 1665 Mhz |
|  |  |
| **RAM** | 16GB/32GB |
| **STORAGE** | 256GB/512GB/1TB M.2 PCI-e NVMe SSD, 2.5″ HDD/SSD Bay |
| **LAN** | 10/100/1000M Ethernet Adapter (RJ45) |
| **WIFI** | 802.11a/ac/b/g/n Module – Dual-Band |
| **I/O** | 4x USB Type-A 3.0 Port ; 2x USB Type-A 2.0 Port ; 1x USB Type-C |
| **VIDEO** | 1x HDMI 2.0 Port (4K@60Hz) ; 1x DisplayPort 1.4 Port (4K@60Hz) |
| **AUDIO** | 1x HDMI 2.0 Port (4K@60Hz) ; 1x DisplayPort 1.4 Port (4K@60Hz) |
...
There is a choice of three RAM and Storage options: 16GB and 256GB & 16GB and 512GB. And finally a massive 32GB DDR4, Dual-Channel, 2,666Mhz RAM, and 1TB of M.2 PCI-e NVMe SSD
...
## DroiX Stheno F5 Review: Benchmarks

We will start with showing off some benchmarks in our DroiX Stheno F5 review, to see the performance of this Mini computer.

### PassMark

First we will take a look at PassMark which gives an overall indication of performance, testing the processor, 2D and 3D graphics, ram and disk speed.
...
Now onto the retro gaming portion of our DroiX Stheno F5 review. As this mini PC is high spec, you can enjoy everything from 8 to 32 bit systems with no issues at all. So we won’t spend too long on those and instead test some higher end consoles.

### PlayStation Portable

Sony PSP Emulation on the Stheno F5
...
## Where to buy the DroiX Stheno F5

We hope that you have found this Stheno F5 review useful. You can learn more and [buy the Stheno F5 here](https://go.droix.co.uk/DROIX-STHENO-F5) or click on the Shop Now link below.

[BUY NOW](https://go.droix.co.uk/DROIX-STHENO-F5)