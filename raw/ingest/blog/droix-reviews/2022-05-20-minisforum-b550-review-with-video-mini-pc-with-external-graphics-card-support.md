---
title: Minisforum B550 Review with video – Mini PC with external graphics card support
source_url: "https://droix.net/blogs/minisforum-b550-review/"
source_site: droix.net
type: review-blog
date: 2022-05-20
---

In our [Minisforum B550](https://droix.net/product/minisforum-b550/) review we will be unboxing it, checking out its features and assembling the graphics card dock. We will then run some system and gaming benchmarks to see its performance. And to finish the review, check out some games with the budget Radeon RX 6400 and high-end GeForce 3070 TI external graphics cards.

Contents

[Minisforum B550 Review video](#minisforum-b550-review-video)

[Unboxing the Minisforum B550](#unboxing-the-minisforum-b550)

[Minisforum B550 Overview](#minisforum-b550-overview)

[Minisforum B550 Dock Overview](#minisforum-b550-dock-overview)

[Minisforum B550 Technical Specifications](#minisforum-b550-technical-specifications)
...
[Game Benchmark Summary](#game-benchmark-summary)
...
[Is the Minisforum B550 worth buying?](#is-the-minisforum-b550-worth-buying)

[Where to buy the Minisforum B550?](#where-to-buy-the-minisforum-b550)
...
Minisforum B550 Review B550 Unboxed

Also inside the hard case is the power brick and power cable. We will include the correct adaptor for your country. Underneath the packaging is a [VESA](https://vesa.org/) mount for attaching the B550 to the back of your display. There is a HDMI cable for connecting the B550 mini computer to your monitor or TV.

Minisforum B550 Unboxing
...
The [B550](https://droix.net/product/minisforum-b550/) measures 7.4 x 6.5 x 2.6 inches (15.8 x 16.65 x 6.7 cm) and weighs 1129 grams. Unlike most other mini PC’s the B550 design is very clean, with none of the usual ports on the front and side.

Minisforum B550 Dimensions

The back of the mini PC is where everything is located. Starting from the left we have the Power button and power input. There are two HDMI and one DisplayPort, supporting up to triple monitor display. There are a total of four USB 3.2 Gen 2 ports, along with a USB Type-C Gen 2. We have 3.5mm headphone and microphone jacks. And there is a 2.5 Gigabit ethernet port for fast wired data transfer.

Minisforum B550 Back View

On the right side you will notice a slot covering the Graphics card interface to the dock unit. This can be removed with two screws and reattached to the bottom of the case for safe keeping.

Minisforum B550 Side View
...
Minisforum B550 Bottom View

## Minisforum B550 Dock Overview

The dock allows you to connect a compatible external graphics card to the [Minisforum B550](https://droix.net/product/minisforum-b550/) and turn it into a gaming mini PC. But first, it requires some assembly. You will also need a separate PC power supply which will power the mini PC, the dock and if required the graphics card.

Minisforum B550 Dock Building
...
Minisforum B550 Dock with Radeon RX 6400 eGPU

## Minisforum B550 Technical Specifications

|  |  |
| --- | --- |
| **CPU** | AMD Ryzen 7 4700G, 8 Cores/16 Threads. Base Clock 3.6GHz , Up to 4.4GHz AMD Ryzen 7 5700G, 8 Cores/16 Threads. Base Clock 3.8GHz , Up to 4.6GHz |
| **GPU** | Radeon Graphics (Graphics Frequency 2100 MHz) Radeon Graphics (Graphics Frequency 2000 MHz) |
| **RAM** | DDR4 Dual channel (SODIMM Slots×2) Up to 64GB (32GB x 2) |
| **STORAGE** | M.2 2280 SSD Slot × 2 (Supports NGFF SATA or NVMe PCIe3.0) Space inside for 2.5″ HDD/SSD |
| **CONNECTIVITY** | Wi-Fi 6, Bluetooth 5.2, 2.5 Gigabit Ethernet |
| **FAN NOISE** | 50dB under full load. |
| **TEMPERATURE** | 38°C / 100°F under full load |
...
Minisforum B550 PassMark Score
...
Minisforum B550 PCMark Score

The [Minisforum B550 office mini PC](https://droix.net/product/minisforum-b550/) scores 6,468. Compared to the Proteus 11S which scored 1,300 less, it’s a very good score.
...
[Cinebench](https://www.maxon.net/en/cinebench) tests only the CPU in either single or multi core processing. In this test we are running the multi-core benchmark for 10 minutes.
...
| **3DMARK** | 1502 |
| **CINEBENCH** | 12015 |
| **CRYSTALDISKMARK (READ /WRITE)** | 3257 / 2876 MB/s |
| **WIFI (DOWN / UP)** | 433 / 478 Mbps |
...
Even with the integrated graphics on the [B550 gaming mini PC](https://droix.net/product/minisforum-b550/) we are getting great scores! You can increase the graphics quality to higher levels and keep within the 60 frames per second target.
...
Cyberpunk 2077 Benchmark Scores
...
|  |  |  |  |
| --- | --- | --- | --- |
|  | **INTEGRATED GPU** | **RADEON RX 6400** | **GEFORCE 3070 TI** |
| **FORZA HORIZON 5** | 92 FPS | 134 FPS | 209 FPS |
| **CYBERPUNK 2077** | 41 FPS | 65 FPS | 150 FPS |
| **FINAL FANTASY XIV** | 6561 | 15884 | 23963 |
| **SHADOW OF THE TOMB RAIDER** | 69 FPS | 161 FPS | 169 FPS |
| **3DMARK** | 1502 | 3813 | 13772 |
...
Minisforum B550 with Geforce 3070 Ti

### Cyberpunk

We are starting with Cyberpunk on the [Minisforum B550](https://droix.net/product/minisforum-b550/) iGPU 720P with the lowest graphics. We are getting in the area of low to high 30 frames per second. Locking it to 30 FPS would make it more stable, but still expect drops below 30.
...
Cyberpunk 2077 on Geforce 3070 Ti
...
Minisforum B550 with Radeon RX 6400
...
For gaming with the integrated GPU, the B550 is impressive! In comparison, we are looking at slightly higher performance than the [AYA NEO NEXT PRO gaming handheld](https://droix.net/product/ayaneo-next-pro/). You can enjoy AAA games at playable frame rates.

Minisforum B550 Dock and PSU
...
We hope you have found our Minisforum B550 review useful. You can learn more and [buy your Minisforum B550 here](https://droix.net/product/minisforum-b550/). Or browse our range of [mini PC’s here](https://droix.net/blogs/product-category/mini-pcs/),

[BUY NOW](https://droix.net/product/minisforum-b550/)