---
title: EasySMX ESM-9101 Review – Gaming controller for PC, PS3, Pi & Android
source_url: "https://droix.net/blogs/easysmx-esm-9101-review/"
source_site: droix.net
type: review-blog
date: 2022-02-11
---

Today we are checking out the [EasySMX ESM-9101 gaming controller](https://droix.net/product/easysmx-esm-9101/). We will be unboxing it, taking an overview of the features and playing a brief game or two to show it in action.

Contents

[EasySMX ESM-9101 Review Video](#easysmx-esm9101-review-video)

[Unboxing the EasySMX ESM-9101](#unboxing-the-easysmx-esm9101)

[Overview of the EasySMX ESM-9101](#overview-of-the-easysmx-esm9101)
...
The [EasySMX ESM-9101 gaming controller](https://droix.net/product/easysmx-esm-9101/) can be used on Windows PC, [PlayStation 3](https://en.wikipedia.org/wiki/PlayStation_3), Android devices as well as Raspberry Pi. You can switch between controller modes for these devices by holding the Home button for five seconds and the LED status will change. You can refer to the manual for each mode and which is best for your device.
...
You can learn more and buy your [EasySMX ESM-9101 gaming controller here](https://droix.net/product/easysmx-esm-9101/). You can browse the range of [EasySMX controllers here](https://droix.net/brand/easysmx/).

[azp\_custom\_product id=”32″]