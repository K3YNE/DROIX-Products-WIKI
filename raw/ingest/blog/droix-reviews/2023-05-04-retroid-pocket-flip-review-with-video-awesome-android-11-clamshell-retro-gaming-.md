---
title: Retroid Pocket Flip Review with video – Awesome Android 11 clamshell retro gaming handheld!
source_url: "https://droix.net/blogs/retroid-pocket-flip-review-with-video/"
source_site: droix.net
type: review-blog
date: 2023-05-04
---

In our [Retroid Pocket Flip](https://droix.net/product/retroid-pocket-flip) review we compare it with the previous model which shares the same processor and find out if the clamshell design, hall sensor sliders and analogue triggers are worth the upgrade?

Contents

[Retroid Pocket Flip Review Video](#retroid-pocket-flip-review-video)

[Unboxing the Retroid Pocket Flip](#unboxing-the-retroid-pocket-flip)

[Retroid Pocket Flip Overview](#retroid-pocket-flip-overview)

[Retroid Pocket Flip Technical Specifications](#retroid-pocket-flip-technical-specifications)

[OS & Menus overview](#os-amp-menus-overview)
...
[Call of Duty with on screen mapping](#call-of-duty-with-on-screen-mapping)

[Forza Horizon 5 Xbox Cloud Gaming](#forza-horizon-5-xbox-cloud-gaming)
...
Next we have the [Retroid Pocket Flip](https://droix.net/product/retroid-pocket-flip) retro gaming handheld itself which we will show in more detail shortly. As a note, you do not get a micro SD card with the Pocket Flip so you will need to supply one yourself.

Underneath is a USB Type-C charge cable. And that’s it, I said it was a brief unboxing!

## Retroid Pocket Flip Overview

We continue the Retroid Pocket Flip review with an overlook of the classic gaming handheld. The [Retroid Pocket Flip](https://droix.net/product/retroid-pocket-flip) measures around 5.4 x 3.2 x 0.9 inches (13.9 x 8.2 x 2.5 cm) when closed, and weighs about 270g. It’s very portable and easily fits in your pockets.
...
|  |  |
| --- | --- |
| **CPU** | [Unisoc Tiger T618](https://droix.net/product-attribute/processor-cpu-model/tiger-t618/) octa-core processor 2x A75 @2.0GHz & 6x [[email protected]](/cdn-cgi/l/email-protection) |
| **GPU** | Mali G52 MC2 @850MHz |
| **RAM** | 4GB [LPDDR4X](https://droix.net/product-attribute/memory-ram-technology/lpddr4x/) @1866Mhz |
| **STORAGE** | 128GB [eMMC](https://en.wikipedia.org/wiki/MultiMediaCard#eMMC) |
| **COOLING** | Active |
| **SCREEN** | 4.7″ 750×1334 touch screen @ 450nits |
| **WIFI** | 2.4G/5G 802.11 b/g/n/ac |
| **BLUETOOTH** | 5.0 |
| **OS** | [Android 11](https://droix.net/product-attribute/operating-system/android-11/) |
| **BATTERY** | 5000mAh |
| **BATTERY LIFE** | Up to 8 hours depending on usage. In our tests we got just over 5 hours running 3DMark benchmark on a loop. |

## OS & Menus overview

The [Retroid Pocket Flip](https://droix.net/product/retroid-pocket-flip) portable game console runs on Android 11 operating system and when first booted up you are presented with a welcome guide that goes through the initial setting up. Here you can choose which emulators and software you wish to install.
...
As part of our Retroid Pocket Flip review we ran a couple of system benchmarks. We can use the results to see the [Pocket Flip](https://droix.net/product/retroid-pocket-flip) performance as well as compare it to other Android based retro emulator devices

### Geekbench

Geekbench Benchmark Results

Geekbench runs a series of CPU based tests on the device. We can see that the Pocket Flip scores 382 and 1396 on the single and multi-core benchmarks. It’s pretty much identical to the Pocket 3+ and [Anbernic RG505](https://droix.net/product/anbernic-rg505/) which we expected to see as they have the same processors..

### 3DMark

3DMark tests the CPU and GPU working together for their best performance. We get a score of 2215 which again is similar to the [Pocket 3+](https://droix.net/product/retroid-pocket-3-plus/) and Anbernic RG505.
...
Next we are briefly trying the Xbox Cloud Gaming. Providing you have a decent WiFi signal and internet speed you will have no issues at all with streaming games on the [Retroid Pocket Flip](https://droix.net/product/retroid-pocket-flip). We did not see any stuttering or reduction in quality, including busy scenes. It works great!
...
The Dolphin emulators have great compatibility but the [Retroid Pocket Flip](https://droix.net/product/retroid-pocket-flip) and similar handhelds do struggle with performance. Our go to game Burnout 2 works great and runs at mostly 60 frames per second. However you will find many games that are running at slower speeds, with many being unplayable.
...
We will now summarise our Retroid Pocket Flip review with our thoughts on the portable retro gaming console. The [Retroid Pocket Flip](https://droix.net/product/retroid-pocket-flip) is a very good gaming handheld in general. Its main use is for [emulation](https://retrogamingbanter.com/a-guide-to-emulators-and-emulation/) and this is about as good as you are going to get in this price range right now. It can emulate up to the PlayStation 1 and Dreamcast era with no issues at all. And as we go into more recent generations we find  good support for the handheld consoles. The Vita3K and Skyline emulators are relatively early in development and some games are playable which is impressive but don’t expect performance to be much better on these going forward.

The [Retroid Pocket Flip](https://droix.net/product/retroid-pocket-flip) does offer more than emulation. You can also play a wide variety of native Android games and use all the apps from the Google Play Store. It’s great for watching videos either locally or streaming from YouTube, web browsing and of course gaming with a controller!
...
That was really my only complaint with the Retroid Pocket Flip retro emulator device. So the real decision comes down to if you want a traditional handheld such as the [Retroid Pocket 3+](https://droix.net/product/retroid-pocket-3-plus/),  or a clamshell design with the [Retroid Pocket Flip](https://droix.net/product/retroid-pocket-flip)? Let us know in the comments which one you would pick and why! That wraps up our Retroid Pocket Flip review!

You can learn more about and buy the [Retroid Pocket Flip here](https://droix.net/product/retroid-pocket-flip). Find our range of [retro gaming handhelds here](https://droix.net/product-category/handhelds/retro-gaming-handheld/).

[BUY RETROID POCKET FLIP HERE](https://droix.net/product/retroid-pocket-flip)
