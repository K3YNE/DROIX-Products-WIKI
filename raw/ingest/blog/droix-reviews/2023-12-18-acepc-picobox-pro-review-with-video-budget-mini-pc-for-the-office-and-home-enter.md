---
title: ACEPC Picobox Pro Review with video – Budget mini PC for the office and home entertainment
source_url: "https://droix.net/blogs/acepc-picobox-pro-review-with-video/"
source_site: droix.net
type: review-blog
date: 2023-12-18
---

Following up from our recent review of the ACEPC Picobox Mini, it’s now the turn of its bigger brother, the [ACEPC Picbox Pro](https://droix.net/product/acepc-picobox-pro/).

Contents

[ACEPC Picobox Pro review video](#acepc-picobox-pro-review-video)

[Unboxing the ACEPC Picobox Pro](#unboxing-the-acepc-picobox-pro)

[ACEPC Picobox Pro Overview](#acepc-picobox-pro-overview)

[ACEPC Picobox Pro Technical Specifications](#acepc-picobox-pro-technical-specifications)

[ACEPC Picobox Pro Benchmarks](#acepc-picobox-pro-benchmarks)
...
ACEPC Picobox Pro Unboxing

## ACEPC Picobox Pro Overview

The [ACEPC Picobox Pro](https://droix.net/product/acepc-picobox-pro/) measures around 5.04 x 5.04 x 2.03 inches and weighs around 386g. The right side has the power button, two USB 3 and one USB 2 port for connecting peripherals to.

ACEPC Picobox Pro Right Side View
...
ACEPC Picobox Pro Back View

The base contains a space for a 2.5” SATA hard drive or SSD. It is very easy to fit, simply unscrew and lift the lid. You can then insert your drive, replace the lid and screws and you are good to go. There are two sliding locks which when unlocked, you can separate the base from the main [mini PC](https://droix.net/product-category/mini-pcs/) which is handy if travelling for example.

ACEPC Picobox Pro drive space inside

When powered on the LED lighting  shows around the top area of the [Picobox Pro](https://droix.net/product/acepc-picobox-pro/) mini PC. The lighting can be configured in the software and allows for different patterns and brightness, as well as  switching off if it is distracting for you.

ACEPC Picobox Pro LED Lighting
...
| **RAM** | 8GB/16GB [LDPPR5](https://en.wikipedia.org/wiki/LPDDR#LPDDR5) | 16GB RAM [DDR4](https://droix.net/product-attribute/memory-ram-technology/ddr4-so-dimm/) SO-DIMM |
...
ACEPC Picobox Pro PCMARK Benchmark Comparison
...
ACEPC Picobox Pro Cinebench Benchmark Comparison

Cinebench measures the performance of the single and multi-cores on the processor. We again see the Picobox Mini slightly outperform the [ACEPC Picobox Pro](https://droix.net/product/acepc-picobox-pro/) with 911 versus 904. We do see a larger performance difference on multi-core with 2164 versus 2848. The RAM type definitely helps with a performance increase here.

### 3DMark

ACEPC Picobox Pro 3DMARK Benchmark Comparison

3DMark tests the CPU and GPU performance. We see that the Picobox Mini is slightly ahead in the scores with 360 versus 349 on the [ACEPC Picobox Pro](https://droix.net/product/acepc-picobox-pro/). Again you would not notice much difference when compared side by side.

## 4K Youtube Playback

ACEPC Picobox Pro Youtube 4K
...
ACEPC Picobox Pro Sonic The Hedgehog
...
We will sum up the review with our final thoughts. As with the Mini, the [ACEPC Picobox Pro](https://droix.net/product/acepc-picobox-pro/) is not great for gaming. While you can play some light games, you will struggle with anything higher. A good alternative is game streaming services such as Xbox and Luna services which work great.
...
You can learn more and [buy the ACEPC Picobox Pro here](https://droix.net/product/acepc-picobox-pro/).

[BUY ACEPC PICOBOX PRO HERE](https://droix.net/product/acepc-picobox-pro/)
