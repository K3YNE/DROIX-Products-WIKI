---
title: GPD XP Plus Review -The Best Android Retro Gaming Handheld?
source_url: "https://droix.net/blogs/gpd-xp-plus-review/"
source_site: droix.net
type: review-blog
date: 2022-06-23
---

Today we are checking out the new revised model of the GPD XP that launched last year, it’s the [GPD XP Plus](https://droix.net/product/gpd-xp-plus/). In our GPD XP Plus review we will be unboxing it, running some system benchmarks, and then running a whole bunch of emulators, ranging from Mega Drive to PlayStation 2 and more! And if that is not enough, we will be checking out some native Android apps games to see how well they run on this retro gaming handheld. Grab a cuppa tea, it’s a long one!

Contents

[GPD XP Plus Review Video](#gpd-xp-plus-review-video)

[Unboxing the GPD XP Plus](#unboxing-the-gpd-xp-plus)

[Overview of the GPD XP Plus](#overview-of-the-gpd-xp-plus)

[Controller overview](#controller-overview)

[GPD XP Plus Technical Specifications](#gpd-xp-plus-technical-specifications)

[XP Plus TV/Monitor Output](#xp-plus-tvmonitor-output)
...
[VBA-M Emulator](#vbam-emulator)

[Yabasanshiro Emulator – Saturn](#yabasanshiro-emulator-saturn)

[Mupen64Plus Emulator](#mupen64plus-emulator)

[DeSmuME- Castlevania Portrait of Ruin](#desmume-castlevania-portrait-of-ruin)

[Flycast Emulator – Dreamcast](#flycast-emulator-dreamcast)

[DuckStation Emulator – PlayStation](#duckstation-emulator-playstation)

[PPSSPP Emulator – PlayStation Portable](#ppsspp-emulator-playstation-portable)

[AetherSX2 Emulator – PlayStation 2](#aethersx2-emulator-playstation-2)

[Citra Emulator](#citra-emulator)

[Dolphin Emulator](#dolphin-emulator)

[Android Games Performance](#android-games-performance)

[Game Streaming Performance](#game-streaming-performance)

[Screen Mapping Software](#screen-mapping-software)
...
Underneath the second part of the packaging is an envelope containing a screen protector and the user guide which is in English and Chinese. There is a [USB Type-C](https://en.wikipedia.org/wiki/USB-C) charge cable and it will also come with a power supply for your country.

GPD XP Plus Modular Controllers
...
Visually the [GPD XP Plus](https://droix.net/product/gpd-xp-plus/) is the same as the original. It measures 9.17 x 3.2 x 1.6 inches (23.3 cm 8.3 cm 4.1 cm) at its largest thickness including the grip. And it weighs 370 grams with the Xbox style modular controller.

GPD XP Plus Dimensions
...
GPD XP Plus Top View

On the top of the [GPD XP+](https://droix.net/product/gpd-xp-plus/) you can find left and right shoulder and trigger buttons. There is also a volume rocker and power button.

GPD XP Plus Bottom View
...
|  |  |
| --- | --- |
| **CPU** | [MediaTek Dimensity 1200](https://www.mediatek.com/products/smartphones-2/mediatek-dimensity-1200), 8 Core |
| **GPU** | [ARM Mali-G77 MP9](https://www.notebookcheck.net/ARM-Mali-G77-MP9-GPU-Benchmarks-and-Specs.497867.0.html) @900MHz |
| **RAM** | 6GB [LPDDR4x](https://www.techcenturion.com/ddr4-vs-lpddr4x) @4266Mbps |
| **ROM** | 128GB [UFS](https://en.wikipedia.org/wiki/Universal_Flash_Storage) 3.1 |
...
| **BATTERY** | 7000mAh Idle: 9+ hours tested in office closing time, 13+ hours reported Full Load: 4.5 hours running benchmark on a loop |
...
GPD XP Plus Output to TV

## System Benchmarks

### GeekBench

As part of our GPD XP Plus review we perform a few system benchmarks to see the performance and when possible compare with other similar devices. We start the system benchmarks with [GeekBench](https://www.geekbench.com/) which runs a series of tests across single and multi-core operations.

GPD XP Plus GeekBench Benchmark

We get scores of 952 for single core and 2,765 for multicore. In comparison to the original GPD XP we got scores of 501 and 1,601 respectively. And for the [Anbernic RG552](https://droix.net/product/rg552/) we got 266 and 714. So there is a very good increase in performance for both single and multi-core processing on the GPD XP Plus retro console.
...
Contra Advance on VBA M

The VBA-M emulator on [RetroArch](https://www.retroarch.com/) runs with no issues or slowdown. We are checking out Contra Advance here and it scales up nice to the display resolution, although not to the ultra wide resolution. You could stretch it if you wanted to but it wouldn’t look nice.

### Yabasanshiro Emulator – Saturn

GPD XP Plus Saturn Emulation
...
Vertical orientation is also playable
...
Next we have the PlayStation Portable and [PPSSPP](https://www.ppsspp.org/). As a standard we are trying God Of War. We are getting a solid 60 frames per second and you can increase the resolution and other improvements to make it look great on screen.

PSP emulator on GPD XP+
...
Overall the level of emulation is very good on the [GPD XP +](https://droix.net/product/gpd-xp-plus/). There are plenty of PlayStation 2 games to enjoy, and I think with Citra that may be an issue with that version of the emulator rather than performance of the GPD XP Plus. Don’t forget there are alternative emulators out there, some of which may work better than others for certain games.
...
Xbox Cloud App running Forza Horizon 5

We tried the Xbox Cloud Gaming beta for Android and it works great with high end games such as Forza Horizon 5. You do need a subscription to [Xbox Game Pass](https://www.xbox.com/en-GB/xbox-game-pass) to use this. It essentially lets you stream games from the Microsoft servers to your GPD XP Plus gaming handheld. We had no problems with the streaming quality or drops in WiFi speed, especially with the router being around 15 metres across the office. It all works great!
...
Screen mapping Call of Duty Mobile
...
Genshin Impact Mobile with controller support
...
Overall the [GPD XP Plus](https://droix.net/product/gpd-xp-plus/) is a great improvement over the original model in terms of performance. We saw from the benchmarks that there is around a 50-60% difference in single and multi-core performance. This gives us a much faster overall experience both in emulators and Android games.
...
Mega Drive emulator playing Comix Zone
...
You can learn more about and [buy the GPD XP Plus here](https://droix.net/product/gpd-xp-plus/). You can browse our range of [handheld gaming consoles here](https://droix.net/blogs/product-category/handhelds/handheld-game-consoles/).

[BUY NOW](https://droix.net/product/gpd-xp-plus/)
