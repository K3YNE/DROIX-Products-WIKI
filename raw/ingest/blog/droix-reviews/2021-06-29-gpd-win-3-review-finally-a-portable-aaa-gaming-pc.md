---
title: GPD Win 3 Review – Finally, a portable AAA Gaming PC!
source_url: "https://droix.net/blogs/gpd-win-3-review/"
...
[GPD Win 3 Review [Video]](#gpd-win-3-review-video)

[GPD Win 3 Full Review](#gpd-win-3-full-review)

[Unboxing The GPD Win 3](#unboxing-the-gpd-win-3)

[GPD Win 3 Overview](#gpd-win-3-overview)

[GPD Win 3 Accessories](#gpd-win-3-accessories)

[GPD Win 3 Technical Specifications](#gpd-win-3-technical-specifications)

[GPD Win 3 Benchmarks](#gpd-win-3-benchmarks)

[PC Mark Benchmark:](#pc-mark-benchmark)

[3D Mark Benchmark:](#3d-mark-benchmark)

[Gaming On The GPD Win 3](#gaming-on-the-gpd-win-3)

[Emulation Demos:](#emulation-demos)

[To Summarize](#to-summarize)

[Where to buy the GPD Win 3](#where-to-buy-the-gpd-win-3)
...
Inside is the GPD Win 3, which we will show in more detail shortly. Underneath is a screen protector and wipe, which you can apply to the screen to protect it.

GPD Win 3 quick start guide

There is a quick start guide which is in full English. Also, check out our website [Knowledge Base](https://go.droix.co.uk/KNOWLEDGE-BASE) and [Forums](https://go.droix.co.uk/FORUMS) if you have any questions or check out some helpful guides.

GPD Win 3 Power Supply
...
As an introductory bonus, DroiX customers will also receive a free GPD Win 3 Docking Station and Carry case. Please check the website for availability as there is limited stock. We will take a closer look at the Docking Station features a little later.

## GPD Win 3 Overview

GPD Win 3 Overview

The [GPD Win 3](https://go.droix.co.uk/FORUMS) is available in two colours, Silver and Space Grey. Other than the colour, there is no difference in specifications or features.

GPD Win 3 Display

The GPD Win 3 features an H-IPS 5.5” 1280×720 4-point touchscreen display. It also has Corning [Gorilla Glass 5](https://www.theverge.com/2016/7/20/12236642/corning-announces-new-gorilla-glass-5-smartphone-drops-cracked-screen#:~:text=Called%20Gorilla%20Glass%205%2C%20the,waist%20height%20to%20shoulder%20height.&text=The%20new%20glass%20is%20the,in%20the%20fall%20of%202014.) for excellent protection from scuffs.

There are two clickable analogue sticks made by ALPS, which are comfortable and offer pixel-precise movement. In addition, there is a D-Pad which is excellent for retro gaming. Below the D-Pad, you can find SELECT and START buttons and the Charge and Power LED.

On the right, four gaming buttons handily have both Xbox and PlayStation symbols, which, like me, helps if you often forget the layout of the two. Towards the bottom is a fingerprint sensor for easy logging into Windows. And finally, there is an Xbox style Guide button that can be used for bringing up the Xbox game bar found in Windows 10.
...
There are Power, Volume Up and Down buttons and a 3.5mm headphone port. Finally, there is a USB 3.0 port to which you can connect peripherals.

Bottom View GPD Win 3
...
GPD has moved from the traditional clamshell design to bring a new slidable screen to reveal the keyboard. It is touch-sensitive and has a backlight so that you will see the keys in the dark. The touch screen still works when the screen is up and can be easily pushed back down when the keyboard is not required.

## GPD Win 3 Accessories

The docking station is a handy accessory for the GPD Win 3. On the back, you can find a USB Type-C port, HDMI port, three USB 3.0 ports and an Ethernet port.

GPD Win 3 Connected to PC
...
The GPD Win 3 again continues with the improvements to specifications and features, so let us take a closer look at them.

## GPD Win 3 Technical Specifications

|  |  |
| --- | --- |
| **PROCESSOR** | Intel Core™ i5-1135G7 / Core™ i7-1165G7 |
| **CORES** | 4 |
| **THREADS** | 8 |
| **MAX FREQUENCY** | 4.2 Ghz / 4.7 Ghz |
|  |  |
| **GPU** | Intel Iris® Xe Graphics |
| **MAX FREQUENCY** | 1.30 Ghz |
|  |  |
| **RAM** | 16GB LPDDR4x @ 4266Mhz – Dual Channel |
| **STORAGE** | 1TB NVMe PCIe Gen 4.0 NVMe 1.4 |
...
You can then use the analogue stick and Left and Right shoulder buttons as their respective mouse buttons.

## GPD Win 3 Benchmarks

### PC Mark Benchmark:

Let’s now test the performance of the GPD Win 3 with some benchmarks.

We start with PC Mark, which tests the overall performance of the Win 3 in a variety of scenarios ranging from desktop performance, video conferencing, office apps, and of course, 2D and 3D performance.

The GPD Win 3 scores an excellent 5037
...
3D performance with 3D Mark 2

The final score of 1791 is excellent, beating the higher-end mobile AMD Ryzen processors. It is no surprise that the 12th Gen Intel Iris is immensely powerful and great for 2D and 3D graphics.

Diskmark Benchmark

## Gaming On The GPD Win 3

Next, we will check out some high-end games, starting with the recently released Crash Bandicoot 4.
...
GPD Win 3 Playing Forza Horizon 4
...
Play PlayStation 2 on a handheld
...
Like most current systems, the emulator requires shader caches, so first playthroughs will be slower as the caches are generated. Once they are generated, you will have excellent performance, and the games are pretty playable.

## To Summarize

That wraps up this overview of the GPD Win 3. I have to say that the improvements in both design and performance over the Win 2 are excellent. High-end games and emulators perform far better, and the difference between the Win 2 and 3 are big enough to make me retire my Win 2 and enjoy games how they are meant to be played on Win 3.

GPD Win 3 Conclusion
...
Thanks for sticking with this article so far! We hope you have found the GPD Win 3 Review to cover all the necessary bases. If you haven’t, however, please feel free to reach out to us at [[email protected]](/cdn-cgi/l/email-protection), or leave a comment below, and we’ll be happy to answer any questions you might have.

## Where to buy the GPD Win 3

If you’re interested in a GPD Win 3 of your own, check out our listing for the [GPD Win 3 in the UK](https://go.droix.co.uk/GPD-WIN-3) for more information.

Until next time!

[BUY NOW](https://go.droix.co.uk/GPD-WIN-3)