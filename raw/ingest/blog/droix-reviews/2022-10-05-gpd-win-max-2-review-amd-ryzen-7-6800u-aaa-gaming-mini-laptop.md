---
title: GPD WIN MAX 2 Review – AMD Ryzen 7 6800U AAA gaming mini laptop
source_url: "https://droix.net/blogs/gpd-win-max-2-amd-review/"
source_site: droix.net
type: review-blog
date: 2022-10-05
---

You wait ages for the [GPD WIN MAX 2](https://droix.net/product/gpd-win-max-2/) gaming mini laptop to arrive, and you get three come along at once! In our GPD WIN MAX 2 review we will be taking a look at three models of the [handheld gaming PC](https://droix.net/blogs/product-category/handhelds/handheld-gaming-pcs/), putting it through its paces with some system and games benchmarks. Then we finish with playing some games and emulators to see how well they perform.

Contents

[GPD WIN MAX 2 Review Video](#gpd-win-max-2-review-video)

[Unboxing the GPD WIN MAX 2 AMD](#unboxing-the-gpd-win-max-2-amd)

[GPD WIN MAX 2 AMD Overview](#gpd-win-max-2-amd-overview)

[GPD WIN MAX 2 AMD Technical Specifications](#gpd-win-max-2-amd-technical-specifications)
...
[Benchmark Summary and Comparison](#benchmark-summary-and-comparison)

[30W TDP Comparison](#30w-tdp-comparison)

[15W, 20W & 30W TDP Performance](#15w-20w-amp-30w-tdp-performance)

[GPD WIN MAX 2 AMD vs Intel models](#gpd-win-max-2-amd-vs-intel-models)
...
[Xbox OG – Xemu](#xbox-og-xemu)

[Citra](#citra)

[PlayStation Vita – Vita3K](#playstation-vita-vita3k)

[PlayStation 3 – RPCS3](#playstation-3-rpcs3)

[Xbox 360 – Xenia](#xbox-360-xenia)

[Ryujinx & Yuzu](#ryujinx-amp-yuzu)

[Final Thoughts](#final-thoughts)

[Where to buy the GPD WIN MAX 2?](#where-to-buy-the-gpd-win-max-2)
...
GPD WIN MAX 2 Display

Below is a QWERTY keyboard that has two levels of backlight control. There are two detachable covers which hide the gaming controls, so you can use your [GPD Win MAX 2](https://droix.net/product/gpd-win-max-2/) as an mini laptop for work as an example. It’s a nice idea by GPD!

GPD WIN MAX 2 Controls

You have the usual gaming controls, dual clickable analogue [hall sensor](https://en.wikipedia.org/wiki/Hall_effect_sensor) sticks, D-Pad and gaming buttons.  Let’s try them out while we go over the tech specs!

## GPD WIN MAX 2 AMD Technical Specifications

|  |  |
| --- | --- |
| **CPU** | [AMD Ryzen 7 6800U](https://droix.net/product-attribute/processor-cpu-model/ryzen-7-6800u/) processor, it has 8 cores and 16 threads running up to 4.7Ghz at a default 28W TDP |
| **GPU** | [AMD Radeon 680M](https://droix.net/product-attribute/graphics-gpu-model/radeon-680m/) with 12 cores running up to 2200Mhz |
| **RAM** | 16GB or 32GB [LPDDR5](https://droix.net/product-attribute/memory-ram-technology/lpddr5/) 6400 RAM |
| **STORAGE** | 1TB or 2TB of m.2 [PCIe 4](https://www.kingston.com/unitedkingdom/en/blog/pc-performance/pcie-gen-4-explained) SSD |
| **COMMUNICATIONS** | [WiFi 6](https://droix.net/product-attribute/wi-fi/6/) Bluetooth 5.2 [4G LTE](https://www.verizon.com/about/news/what-4g-lte-and-why-it-matters) module (sold separately) |
...
We left the MAX 2 running idle on the desktop with only BatteryMon , it run for 10 hours 50 minutes.The first 7 hours 30 minutes was before the battery saver kicked in, and the rest while on battery saver. When running Cinebench on full load at 28W [TDP](https://retrogamingbanter.com/tdp-explained/) we got an impressive 2 hours and 5 minutes.

## System Benchmarks

We continue our [GPD WIN MAX 2](https://droix.net/product/gpd-win-max-2/) review with putting the three handheld gaming PC’s through its paces with some system benchmarks. We are testing at 30W TDP, it can go higher but the included software only allows up to 30. We may cover changing the TDP and graphics speeds in a separate article if there is enough interest, let us know in the comments.
...
GPD WIN MAX 2 32GB1TB PCMARK Breakdown
...
3DMark Benchmark Results for GPD WIN MAX 2 AMD Ryzen 7 6800U
...
The two 1TB models have the same SSD and we see near identical scores for them both. The 2TB model does have a different brand and we get over 5000 MB/s a second. As we mentioned this was the brand we were supplied with by [GPD](https://droix.net/blogs/brand/gpd/), but this may change for the retail versions.

## Gaming Benchmarks

As part of our [GPD WIN MAX 2](https://droix.net/product/gpd-win-max-2/) review we will now run some gaming benchmarks to see how well they perform. From the system benchmarks, the 32GB/1TB performed the best overall so we will use this for the benchmarks. We are running the benchmarks at 800P resolution at 15W, 20W and 30W, with one additional test at 2560×1600 (1600p) at 30W. This is the highest resolution the display supports.
...
It’s our highest FPS by far on a handheld, the next closest was the [ONEXPLAYER Mini 5800U](https://droix.net/product/onexplayer-mini/) at 88 FPS.
...
GPD WIN MAX 2 30W TDP Benchmark Results
...
32GB/1TB 15w, 20W & 30W TDP Benchmark Results

### GPD WIN MAX 2 AMD vs Intel models

The below table shows the 30W benchmark results compared to the GPD WIN MAX 2 Intel processor model we [reviewed](https://droix.net/blogs/gpd-win-max-2-review/) a few months back. Despite the Intel running at a higher 35W TDP, the AMD has the higher results in all tests. This includes those that Intel processors would generally have higher scores on such as Final Fantasy XIV. It’s no wonder why the Intel model is now discontinued! You can compare the results with other previous generation handhelds on our [handheld gaming PC benchmarks article.](https://droix.net/blogs/handheld-gaming-pc-benchmarks/)
...
The AMD model is to put it quite simply a beast! It has far higher performance than any of the previous handhelds from GPD, [AYANEO](https://droix.net/blogs/brand/ayaneo/) and [ONEXPLAYER](https://droix.net/blogs/brand/onexplayer/).  If this is the first of next-generation handheld gaming PC’s to set the bar, then we can’t wait to see what the others can do.

You can [order your GPD WIN MAX 2 here](https://droix.net/product/gpd-win-max-2/) and use the discount code **WINMAX25OFF** on the checkout!
...
And now on to some emulator performance tests for our GPD WIN MAX 2 review. We won’t cover anything before Dreamcast era as it all runs perfect. Instead we will work our way through some of the newer systems to see how the [GPD WIN MAX 2](https://droix.net/product/gpd-win-max-2/) handheld gaming PC gets on.
...
Dolphin emulator on GPD WIN MAX 2
...
Vita3k emulator on GPD WIN MAX 2
...
GPD WIN MAX 2 running PlayStation 3 emulator
...
Overall the [GPD WIN MAX 2](https://droix.net/product/gpd-win-max-2/) gaming mini laptop is very impressive! In the past year we have seen gradual increases in handheld performance, but the Ryzen 6800U blows the others away. There was amazing performance across the games and emulators we tried! And that’s before we have tweaked the power settings, plugged in an eGPU, or tried some VR gaming! We will save that for maybe another GPD WIN MAX 2 review article 🙂

GPD WIN MAX 2 and Ryujinx emulator

## Where to buy the GPD WIN MAX 2?

You can [buy your GPD WIN MAX 2 here](https://droix.net/product/gpd-win-max-2/) and use don’t forget to use the discount code **WINMAX25OFF** on the checkout (not applicable if there is a sale event running)! Or if this did not take your interest, you can browse our range of [handheld gaming PC’s here](https://droix.net/blogs/product-category/handhelds/handheld-gaming-pcs/).

[BUY GPD WIN MAX 2 HERE](https://droix.net/product/gpd-win-max-2/)
