---
title: AYN Thor Review – Dual-Screen Android Handheld Tested for Emulation, Battery Life and Performance
source_url: "https://droix.net/blogs/ayn-thor-handheld-review/"
source_site: droix.net
type: review-blog
date: 2026-01-23
---

The [AYN Thor](https://droix.net/product/ayn-thor/ "AYN Thor") is one of the best dual-screen [Android gaming handhelds](https://droix.net/product-category/gaming-handheld/android-gaming-handheld/ "Android gaming handhelds") we have tested so far, especially for retro emulation, OLED display quality, and portability. Its Snapdragon 8 Gen 2 performance is strong enough for demanding Android games and advanced emulators, while the second screen gives DS and 3DS-style play a real advantage.

Contents

[AYN Thor Review Video](#ayn-thor-review-video)

[AYN Thor Overview](#ayn-thor-overview)

[AYN Thor Review: Controls and Comfort](#ayn-thor-review-controls-and-comfort)

[AYN Thor Technical Specifications](#ayn-thor-technical-specifications)

[How long will the battery last?](#how-long-will-the-battery-last)

[How loud and hot does the AYN Thor get?](#how-loud-and-hot-does-the-ayn-thor-get)

[System Benchmarks: An AYN Thor Review of Performance](#system-benchmarks-an-ayn-thor-review-of-performance)
...
[Exploring the AYN Thor’s Android Software](#exploring-the-ayn-thors-android-software)

[How Does Android Gaming Perform?](#how-does-android-gaming-perform)

[Emulation Performance: An AYN Thor Review](#emulation-performance-an-ayn-thor-review)
...
[Other Emulators in this AYN Thor Review](#other-emulators-in-this-ayn-thor-review)

[Vita3K](#vita3k)

[Eden](#eden)

[Final Thoughts on this AYN Thor Review](#final-thoughts-on-this-ayn-thor-review)

[AYN Thor FAQ](#ayn-thor-faq)
...
The AYN Thors top AMOLED screen



The AYN Thors bottom AMOLED screen
...
The top has left and right shoulder and trigger buttons



The bottom features volume power button USB headphone jack and micro SD card slot
...
Overall, the [AYN Thor](https://droix.net/product/ayn-thor/ "AYN Thor") fits really well into your hands and has a nice balance. In fact, it is very comfortable to hold.
...
| --- | --- | --- |
| **DISPLAY** | Primary Screen: 6-inch AMOLED 1080×1920 [120Hz](https://droix.net/product-attribute/refresh-rate/120hz/ "120Hz") Secondary Screen: 3.92-inch AMOLED 1080×1240 60Hz | Primary Screen: 6-inch AMOLED 1080×1920 120Hz  Secondary Screen: 3.92-inch AMOLED 1080×1240 [60Hz](https://droix.net/product-attribute/refresh-rate/60hz/ "60Hz") |
| **CPU** | [Qualcomm](https://droix.net/product-attribute/processor-cpu-brand/qualcomm/ "Qualcomm") [Snapdragon 8 Gen 2](https://droix.net/product-attribute/processor-cpu-model/snapdragon-8-gen-2/ "Snapdragon 8 Gen 2") Gaming Platform 1 Gold [[email protected]](/cdn-cgi/l/email-protection) 4 [[email protected]](/cdn-cgi/l/email-protection) 3 [[email protected]](/cdn-cgi/l/email-protection) | Qualcomm [Snapdragon 865](https://droix.net/product-attribute/processor-cpu-model/snapdragon-sd845/ "Snapdragon SD865") 1x [[email protected]](/cdn-cgi/l/email-protection) 3x [[email protected]](/cdn-cgi/l/email-protection) 4x [[email protected]](/cdn-cgi/l/email-protection) |
| **GPU** | [Adreno 740](https://droix.net/product-attribute/graphics-gpu-model/adreno-740/ "Adreno 740") @680MHz | [Adreno 650](https://droix.net/product-attribute/graphics-gpu-model/adreno-650/ "Adreno 650") @587MHz |
| **RAM** | 8GB, 12GB, 16GB [LPDDR5x](https://droix.net/product-attribute/memory-ram-technology/lpddr5x/ "LPDDR5x") @4200MHz | 8GB [LPDDR4x](https://droix.net/product-attribute/memory-ram-technology/lpddr4x/ "LPDDR4x") @2133MHz |
| **STORAGE** | [UFS4.0](https://droix.net/product-attribute/storage-technology/ufs-4-0/ "UFS4.0") 128GB, 256GB, 1TB | [UFS3.1](https://droix.net/product-attribute/storage-technology/ufs-3-1/ "UFS3.1") 128GB |
| **CONNNECTIVITY** | Wi-Fi 6E + [BT 5.3](https://droix.net/product-attribute/bluetooth/5-3/ "BT 5.3") | [Wi-Fi 6](https://droix.net/product-attribute/wi-fi/6/ "Wi-Fi 6") + [BT 5.1](https://droix.net/product-attribute/bluetooth/5-1/ "BT 5.1") |
| **BATTERY** | 6000mAh | 6000mAh |
| **I/O** | [USB-C](https://droix.net/product-attribute/i-o-usb/1x-usb-3-1-type-c/ "USB-C") DisplayPort 4Kp60 Alt Mod | USB-C DisplayPort 4Kp60 Alt Mod |
...
Powering the [AYN Thor](https://droix.net/product/ayn-thor/ "AYN Thor") all is a 6,000 mAh battery. We conducted our usual max-settings battery life test by running Antutu on a loop. This test used full brightness on both displays, the High-Performance setting, and fans at full speed.
...
However, the [AYN Thor](https://droix.net/product/ayn-thor/ "AYN Thor") does warm up the area just below the Y and B buttons in particular. Thankfully, it’s not quite at the point where it becomes uncomfortable, unlike other handhelds I have experienced. Still, it is worth noting if you are very sensitive to heat.
...
For our benchmarks, we will be comparing the performance with the bottom screen off and on. We also compare it to the [AYN Odin 2 Portal](https://droix.net/product/ayn-odin2-portal "AYN Odin 2 Portal"), which uses the same processor, and some others for context. Testing was done with and without the bottom display on, as there are some differences in performance.
...
Antutu performs an overall test of this Android gaming console using a variety of benchmarks. Interestingly, there is a small increase in performance with just one display switched on the [AYN Thor](https://droix.net/product/ayn-thor/ "AYN Thor"). Yet, both scores are a little lower than the AYN Portal.
...
The [AYN Thor](https://droix.net/product/ayn-thor/ "AYN Thor") runs on [Android 13](https://droix.net/product-attribute/operating-system/android-13/ "Android 13"). It provides options for either the stock home screen or AYN’s custom launcher. Pressing the [AYN](https://droix.net/product-attribute/brands/ayn/ "AYN") button in the centre promptly brings up the dual screen controls. Helpfully, there are three tabs: Mode, Task, & Settings.
...
AYN Thor performance overlay and second screen control menu
...
Game while watching a video



AYN Thors Screen Mapping is perfect

The built-in screenmapping software allows you to easily map the [AYN Thor](https://droix.net/product/ayn-thor/ "AYN Thor") on-screen touch areas to the gaming controls. If a game does not natively support joysticks, it allows for many games to be mapped and played this way. As usual, no issues at all with setting up or using it.
...
Lets check out a few dual screen systems on this [Android gaming handheld](https://droix.net/product-category/gaming-handheld/android-gaming-handheld/ "Android gaming handheld").
...
The Vita emulator runs great on the [AYN Thor](https://droix.net/product/ayn-thor/ "AYN Thor"). For compatible games, you won’t have any issues at the standard resolution. Furthermore, for many titles, you can increase the rendering resolution for improved visuals.

Vita3K emulator on AYN Thor



Eden emulator on AYN Thor

### Eden

Regarding the [Eden](https://eden-emu.dev/ "Eden") emulator, it runs very well overall. Providing the game is compatible with the emulator itself, there are many games that will work great. The more demanding games, however, show mixed performance. Despite this, we saw decent, playable results with games we are not allowed to talk about or show. (Damn ninjas!)

## Final Thoughts on this AYN Thor Review

We know the [AYN Thor](https://droix.net/product/ayn-thor/ "AYN Thor") is a very popular handheld, and I would say that if this has been on your wish list, then you will not be disappointed.

PS2 emulator on the AYN Thor

Performance-wise, we see scores a little lower than the [AYN Odin2 Portal](https://droix.net/product/ayn-odin2-portal "AYN Odin2 Portal"), even with the bottom display switched off. However, with real-world usage, you would likely be hard-pressed to see any difference side-by-side. It remains a very capable processor. This capability is greatly improved with the Turnip drivers for higher-demanding emulators.
...
If dual-screen play is your priority, the [AYN Thor](https://droix.net/product/ayn-thor/ "AYN Thor") is easy to recommend. If you only care about raw performance per pound, there are stronger single-screen alternatives. For the right buyer, though, this is one of the most interesting and enjoyable Android handhelds currently available.

You can learn more and buy your [AYN Thor here](https://droix.net/product/ayn-thor/ "AYN Thor") from us at DROIX.

[BUY THE AYN THOR HERE](https://droix.net/product/ayn-thor/)
