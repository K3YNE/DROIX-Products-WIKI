---
title: DroiX X4 Review with video – We have a new Android TV box!
source_url: "https://droix.net/blogs/droix-x4-review/"
source_site: droix.net
type: review-blog
date: 2022-10-31
---

For long time fans of DroiX you will know we started off many many years ago with [Android TV boxes](https://droix.net/blogs/product-category/android-gadgets/android-tv-boxes/). It’s been a while since we last released our own model, but the time has come to change that with our [DroiX X4](https://droix.net/product/droix-x4/) review.

Contents

[DroiX X4 Review Video](#droix-x4-review-video)

[Unboxing the DroiX X4 Android TV box](#unboxing-the-droix-x4-android-tv-box)

[Overview of the DroiX X4](#overview-of-the-droix-x4)

[Overview of the DroiX G10S Air Mouse](#overview-of-the-droix-g10s-air-mouse)

[DroiX X4 Technical Specifications](#droix-x4-technical-specifications)
...
[Where to buy the DroiX X4?](#where-to-buy-the-droix-x4)
...
DroiX X4 Android TV box Unboxed

Underneath is a power supply, we will include the correct adapter for your country. Next we have the [DroiX G10S air mouse](https://droix.net/product/droix-g10s-backlit-air-mouse/) which we will also show in more detail shortly. There is a HDMI cable for connecting to your TV or monitor. And last but not least is a getting started leaflet which is in full English.

DroiX X4 Unboxing

## Overview of the DroiX X4

The [DroiX X4](https://droix.net/product/droix-x4/) streaming box measures around 4.1 x 4.1 x 0.98 inches  (10.5 x 10.5 x 2.5 cm) and weighs 139 grams.
...
The [G10S](https://droix.net/product/droix-g10s-backlit-air-mouse/) air mouse requires two AA batteries and you can find the USB dongle in the battery compartment. You wouldn’t believe how many people we get asking where it is 🙂
...
DroiX X4 G10S Air Mouse

With the [G10S air mouse](https://droix.net/product/droix-g10s-backlit-air-mouse/) you can wave your hand and pretend to be Harry Potter and control the on screen mouse cursor. Amaze your guests even more with the built in microphone and voice search on supported apps.
...
|  |  |
| --- | --- |
| **CPU** | [S905X4](https://droix.net/product-attribute/processor-cpu-model/s905x4/) Quad-Core ARM |
| **GPU** | ARM [Mali-G31 MP2](https://droix.net/product-attribute/graphics-gpu-model/mali-g31-mp2/) |
| **RAM** | 4GB [DDR3](https://droix.net/product-attribute/memory-ram-technology/ddr3/) |
| **STORAGE** | 64GB |
...
[Geekbench](https://www.geekbench.com/) runs a series of tests on devices to measure the performance. We are running the CPU benchmark which tests the single and multi-core performance.
...
A brief demonstration next showing the video playback. We start with a 4K and 8K video file in KDPlayer. Both work great with no dropped frames. The [DroiX X4](https://droix.net/product/droix-x4/) IPTV box can decode 8K videos just fine but it will output them to 4K.

DroiX X4 8K Video Test
...
eShare is a very useful app. With it you can control your DroiX X4 with your Android, iPhone or iPad. Simply download the [eShare app](https://eshare.app/#once) on your device and follow the instructions to connect.
...
As part of our DroiX X4 review we are checking the gaming performance. You can turn the [DroiX X4](https://droix.net/product/droix-x4/) into an Android gaming box, and an ever better retro gaming system when paired up with one of our [EasySMX](https://droix.net/blogs/brand/easysmx/) gamepads. We like the [ESM-9110](https://droix.net/product/easysmx-esm-9110/) the best but all three work great with the DroiX X4.

EasySMX ESM 9110 controller
...
While the DroIX X4 Android box is decent for gaming, we get very good performance for emulators. If you want to get up and running for retro gaming fast then we recommend installing RetroArch. We have an easy to follow [RetroArch install guide here](https://droix.net/knowledge-base/article/retroarch/).

SNES Emulator Pocky Rocky
...
PSP Emulator GTA Vice City Stories
...
You can learn more and buy your [DroiX X4 here](https://droix.net/product/droix-x4/). It’s the best Android TV box available! Or browse our range of [Android TV boxes here](https://droix.net/blogs/product-category/android-gadgets/android-tv-boxes/).

[BUY DROIX X4 HERE](https://droix.net/product/droix-x4/)
