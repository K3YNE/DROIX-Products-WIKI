---
title: Retroid Pocket 2+ Review – Powerful AND cheap?
source_url: "https://droix.net/blogs/retroid-pocket-2-plus-review/"
source_site: droix.net
type: review-blog
date: 2022-01-17
---

Today we are checking out the [Retroid Pocket 2+ Android handheld](https://go.droix.co.uk/RETROID-POCKET-2-PLUS). In this Retroid Pocket 2+ review, we will be unboxing it, taking a closer look at the device and then checking out the OS. Followed by an overview of the emulators and Android games for their performance. Grab a cuppa tea, it’s a long article!
...
[Retroid Pocket 2+ Technical Specifications](#retroid-pocket-2-technical-specifications)

[Operating System](#operating-system)

[Retroid Pocket 2+ Review: HDMI Output](#retroid-pocket-2-review-hdmi-output)

[Retroid Pocket 2+ Review: Emulation tests](#retroid-pocket-2-review-emulation-tests)

[3DS Emulator Citra](#3ds-emulator-citra)

[PSP Emulator PPSSPP](#psp-emulator-ppsspp)

[N64 Emulator M64Plus FZ](#n64-emulator-m64plus-fz)

[GameCube and Wii Emulator Dolphin](#gamecube-and-wii-emulator-dolphin)

[Dreamcast Emulator Redream](#dreamcast-emulator-redream)

[SEGA Saturn Emulator Yaba Sanshiro 2](#sega-saturn-emulator-yaba-sanshiro-2)

[DS Emulators melonDS and DraStic](#ds-emulators-melonds-and-drasticnbsp)

[PlayStation 2 Emulator AetherSX2](#playstation-2-emulator-aethersx2nbsp)

[PlayStation Emulator DuckStation](#playstation-emulator-duckstation)

[GBA Emulator VBA-Next](#gbanbspemulator-vbanext)

[Android Games Test](#android-games-test)

[Retroid Pocket 2+ Review: Summary](#retroid-pocket-2-review-summary)
...
The [Retroid Pocket 2+ retro gaming handheld](https://go.droix.co.uk/RETROID-POCKET-2-PLUS) measures 5.9 x 3.1 x 0.98 inches (15 x 8 x 2.5 cm) and weighs 194 grams. The display is a 3.5 inch 480p touch screen with a 4:3 aspect ratio. It’s great for retro gaming!
...
We will compare the technical specifications to the original [Retroid Pocket 2](https://go.droix.co.uk/RETROID-POCKET-2) shortly. Physically the actual devices are very similar.
...
|  |  |  |
| --- | --- | --- |
|  | **Retroid Pocket 2** | **Retroid Pocket 2+** |
| **CPU** | Quad Core Cortex A7 | Quad-core Tiger T310 ( 1x A75, 3x A55) |
| **GPU** | Mali 450 MP2 | PowerVR GE8300 |
| **RAM** | 1GB LPDDR3 | 2GB LPDDR4x |
| **STORAGE** | 8GB eMMC | 32GB eMMC |
| **WIFI** | 2.4G | 2.4G + 5G |
| **OS** | Android 6.0 / 8.1 | Android 9.0 |
...
First we will start off with what most people want to see, the emulators! The [Retroid Pocket 2 Plus](https://go.droix.co.uk/RETROID-POCKET-2-PLUS) can handle all the 8 and 16 bit systems just fine. Thanks to [RetroArch](https://www.retroarch.com/) you can install many cores for everything from the Fairchild right up to the PSP. You can be assured that for the majority of cores pre PlayStation era, they should work great.
...
The [Pocket 2+](https://go.droix.co.uk/RETROID-POCKET-2-PLUS) comes with the free with ads version of Yaba Sanshiro 2 Saturn emulator. It is definitely worth buying if you play a lot of Saturn games.
...
The recently released [AetherSX2](https://aethersx2.com/) works on the Pocket 2+ so we can try out a few PlayStation 2 games. Please be aware that the emulator is in the early stages of development so many games are broken, underperforming or not supported.
...
PlayStation emulation is overall pretty much spot on now for the [Retroid Pocket 2+](https://go.droix.co.uk/RETROID-POCKET-2-PLUS). I tried many games and did not have any issues at all either with compatibility or performance. You can tweak the graphics settings to get nicer visuals and it will not affect the performance too much.
...
For the newer systems there are some bottlenecks in performance which are simply out of the scope of this handheld for them to be improved on. But I think with AetherSX2 we will see some nice improvements over time and more playable PS2 games to enjoy. Considering the price of the Retroid Pocket 2, especially compared to more expensive devices such as the [RG552](https://go.droix.co.uk/RG552) and [GPD XP](https://go.droix.co.uk/GPD-XP), it is amazing performance versus price.

Retroid Pocket 2 Plus Dan the Man Android Game

The Retroid Pocket 2+ can be a bit troublesome to set up if you are a newcomer to Android and/or emulation in general. We will have some guides on our site to help get you started. If you want something plug and play then we would recommend an [Anbernic handheld](https://go.droix.co.uk/ANBERNIC) such as the RG552. If you don’t mind a little playing around with setting up, then you will get some amazing results, even beating the performance of the RG552.

## Where to buy the Retroid Pocket 2+

You can learn more and [buy your Retroid Pocket 2+ here](https://go.droix.co.uk/RETROID-POCKET-2-PLUS). Or browse our wide range of [Retro Gaming Handhelds here](https://go.droix.co.uk/RETRO-GAMING-HANDHELD).

[BUY NOW](https://go.droix.co.uk/RETROID-POCKET-2-PLUS)