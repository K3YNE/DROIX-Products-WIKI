---
title: AYA NEO NEXT PRO Windows gaming handheld review with video
source_url: "https://droix.net/blogs/aya-neo-next-pro-review/"
source_site: droix.net
type: review-blog
date: 2022-05-03
---

In our AYA NEO NEXT PRO review, we will be unboxing the Windows gaming handheld and taking a closer look at the device. Then we will run some system and gaming benchmarks to compare the [AYA NEO NEXT PRO](https://droix.net/product/ayaneo-next-pro/) performance with other handhelds. We will finish off with some gameplay tests of popular Windows games and a few high end console emulators.

Contents

[AYA NEO NEXT PRO Review Video](#aya-neo-next-pro-review-video)

[AYA NEO NEXT PRO Unboxing](#aya-neo-next-pro-unboxing)

[Overview of the AYA NEO NEXT PRO](#overview-of-the-aya-neo-next-pro)

[AYA NEO NEXT PRO Technical Specifications](#aya-neo-next-pro-technical-specifications)
...
[Windows Games Test](#windows-games-test)
...
[Is it worth upgrading to the AYA NEO NEXT Pro?](#is-it-worth-upgrading-to-the-aya-neo-next-pro)

[Where to buy the AYA NEO NEXT PRO?](#where-to-buy-the-aya-neo-next-pro)
...
Metallic nameplate you can engrave it if you wish to

There is a plastic overlay which shows some of the features such as the hall sensor controls.

Up next is the [AYA NEO NEXT PRO handheld games console](https://droix.net/product/ayaneo-next-pro/). This is the bright white model, there is also a jet black theme available. We will show the device in more detail shortly.

The AYA NEO NEXT Pro Windows gaming handheld
...
Power supply and worldwide plug adapters
...
The [AYA NEO NEXT](https://droix.net/product/ayaneo-next/) and PRO measures around 10.5 x 4.4 x 1.18 inches (26.7 x 11.2 x 3 cm) at its largest points, and it weighs 715 grams.
...
Below is a custom button which you can define in Aya Space, and the Aya Key which brings up Aya Space software. See our separate [article on the Aya Space frontend](https://droix.net/blogs/aya-space-official-frontend-for-the-aya-neo-and-aya-neo-pro/) if you want to learn more about it.

AYA NEO NEXT PRO Top View

On the top of the device you have the left and right shoulder and trigger buttons. There is the power button which doubles as a fingerprint sensor for fast logging in to Windows. Next to that are volume up and down buttons. To the right is a 3.5mm headphone jack. And there’s a [USB Type-C port](https://en.wikipedia.org/wiki/USB-C) which can be used for charging or data.
...
Continuing our AYA NEO NEXT PRO review we move on to our system benchmarks. We will be comparing the results with the [AYA NEO range](https://droix.net/brand/ayaneo/), [ONENETBOOK](https://droix.net/blogs/brand/one-netbook/) and [GPD](https://droix.net/blogs/brand/gpd/) devices. Note that those scores are based on older drivers from around three months previous, so there may be minor differences, but nothing that would vastly affect the scores. Check out our full [Handheld Gaming PC Benchmarks article and video](https://droix.net/blogs/handheld-gaming-pc-benchmarks/) if you want to compare the results with all of the handhelds.
...
PCMark Benchmark Comparison with AYA NEO GPD and ONEXPLAYER devices

Comparing them with other handheld devices we can in fact see that the [AYA NEO NEXT PRO handheld gaming PC](https://droix.net/product/ayaneo-next-pro/) comes out on top, just beating the NEXT ADVANCE. There is a larger gap for third place with the AYA NEO 2021 Pro, very closely followed by the ONEXPLAYER Mini.
...
3DMark Benchmark Comparison with AYA NEO GPD and ONEXPLAYER devices

The AYA NEO NEXT PRO scores 1,059, 1,455 and 1,485. Again, it just takes the lead over the AYA NEO NEXT ADVANCE,. But as you can see, the Intel based [ONEXPLAYER Mini](https://droix.net/product/onexplayer-mini/) still remains top with a massive 1,982 score.
...
Benchmark Comparison with AYA NEO GPD and ONEXPLAYER devices
...
The [AYA NEO NEXT PRO handheld game console](https://droix.net/product/ayaneo-next-pro/) scores 46, 56 and 58 frames per second across the three TDP’s. We can see that compared to the ADVANCE, it performs faster at 11 and 20W, with essentially the same results at 35W.
...
Here is a round up of all of the benchmark results with some other devices scores to compare them. Don’t forget, you can find the full comparison scores on our [Handheld Gaming PC Benchmarks](https://droix.net/blogs/handheld-gaming-pc-benchmarks/) article.
...
Forza Horizon 5 is amazing performance

For Street Fighter V, Final Fantasy 14 and Shadow of the Tomb Raider, the mighty [ONEXPLAYER Mini](https://droix.net/product/onexplayer-mini/) takes the lead in all three games. The PRO does not quite make it to 60 FPS on Street Fighter V, it’s less than 100 points behind in Final Fantasy XIV, and 4 frames per second behind on Tomb Raider. The Intel based devices have always taken the lead on these games when compared to AMD, but the gap in performance is closing between the two now which is exciting to see.
...
Lego Star Wars on the AYA NEO NEXT PRO

We start off with [LEGO Star Wars](https://store.steampowered.com/app/920210/LEGO_Star_Wars_The_Skywalker_Saga/) which was released not too long ago. We are running at 20W TDP, 1280×800 with all the graphics set to around medium levels. Although there are some dips below 60 frames per second it is barely noticeable, at least with my old eyes!
...
Elden Ring on the AYA NEO NEXT PRO
...
PlayStation 2 emulator PCSX2 running OutRun
...
Ryujinx emulator PCSX2 running Cruisn Blast
...
If you are buying a Windows gaming handheld for the first time, then the [AYA NEO NEXT PRO](https://droix.net/product/ayaneo-next-pro/) is an excellent handheld for both newcomers and experienced gamers. It is a very high performance handheld that is very capable of playing the latest AAA Windows games. For emulation it excels, easily emulating consoles and computers up to the more recent era, where it can also emulate some of those very well!

## Where to buy the AYA NEO NEXT PRO?

We hope you have enjoyed our AYA NEO NEXT PRO review. You can learn more and [buy the AYA NEO NEXT PRO here](https://droix.net/product/ayaneo-next-pro/), and [Next here](https://droix.net/product/ayaneo-next/). You can also browse our complete range of ONEXPLAYER & GPD [handheld gaming consoles here](https://droix.net/blogs/product-category/handhelds/handheld-game-consoles/).