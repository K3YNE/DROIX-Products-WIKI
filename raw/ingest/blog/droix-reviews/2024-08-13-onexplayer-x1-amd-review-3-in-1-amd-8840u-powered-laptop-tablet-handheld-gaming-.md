---
title: ONEXPLAYER X1 AMD Review – 3-in-1 AMD 8840U powered laptop, tablet & handheld gaming PC
source_url: "https://droix.net/blogs/onexplayer-x1-amd-review/"
source_site: droix.net
type: review-blog
date: 2024-08-13
---

In our [ONEXPLAYER X1 AMD](https://droix.net/product/onexplayer-x1-amd/) review we will be comparing it with the [ONEXPLAYER X1 Mini](https://droix.net/product/onexplayer-x1-mini/) (review coming soon) to see how they perform against each other. We will also be comparing with other [handheld gaming PCs](https://droix.net/product-category/gaming-handheld/handheld-gaming-pcs/) with the same processor. The results are quite interesting! Lets get on with the ONEXPLAYER X1 AMD review.

Contents

[ONEXPLAYER X1 AMD Review Video](#onexplayer-x1-amd-review-video)

[ONEXPLAYER X1 AMD Overview](#onexplayer-x1-amd-overview)

[ONEXPLAYER Controllers Overview](#onexplayer-controllers-overview)

[ONEXPLAYER Keyboard](#onexplayer-keyboard)

[ONEXPLAYER Case](#onexplayer-case)
...
[ONEXPLAYER X1 AMD Technical Specifications](#onexplayer-x1-amd-technical-specifications)
...
[Hello Neighbour 2](#hello-neighbour-2)
...
[ONEXPLAYER X1 AMD Review Final Thoughts](#onexplayer-x1-amd-review-final-thoughts)
...
ONEXPLAYER X1 AMD Top View

Along the top we have the power button which has a built-in fingerprint scanner. And a covered area for the 3.5mm audio jack and [OCuLink](https://droix.net/blogs/oculink-transforming-graphics-card-connectivity/) port for connecting to an eGPU docking station. And on the far right is a button to bring up the Control Center overlay.
...
ONEXPLAYER X1 AMD Detachable Controllers
...
ONEXPLAYER X1 AMD Controller Connector
...
Next we have the attachable keyboard. It very easily connects via pogo pins and magnets to the portable gaming computer to keep it in place. The connection is strong enough to not disconnect when the [ONEXPLAYER X1 AMD](https://droix.net/product/onexplayer-x1-amd/) is lifted, but do not try lifting it with the keyboard 🙂

ONEXPLAYER X1 AMD Detachable Keyboard
...
ONEXPLAYER X1 AMD Carry Case

And last but not least is the case for the [ONEXPLAYER X1 AMD](https://droix.net/product/onexplayer-x1-amd/). It has a strong finish on the outside and a softer material on the inside. It is large enough to fit the X1, stand and keyboard attachment. Definitely worth using to help protect against knocks and scrapes while not in use.
...
| STORAGE | Up to 4TB M.2 2280 [NVME PCIe Gen 4.0](https://droix.net/product-attribute/storage-technology/nvme-pci-e-gen-4-0/) SSD |
...
We see just below average scores for the [ONEXPLAYER X1 AMD](https://droix.net/product/onexplayer-x1-amd/) in PCMark. This can be down to slow RAM or Storage speed for example. We know for example the GPD WIN 4 2024 has very good SSD speeds which make a difference in this benchmark.
...
For 3DMark we are running the Time Spy, Night Raid and Fire Strike benchmarks. The [ONEXPLAYER X1 AMD](https://droix.net/product/onexplayer-x1-amd/) does very well here taking joint second place with the X1 Mini. The X1 Ultra 7 model does take first place but as we saw, actual gaming performance is not great on these devices.
...
ONEXPLAYER X1 AMD and ONEXPLAYER ONEXGPU
...
Forza Horizon 5 runs excellent
...
Steamworld Dig 2 only requires 5W TDP
...
The [ONEXPLAYER X1 AMD](https://droix.net/product/onexplayer-x1-amd/) is an ideal choice for someone that desires a compact gaming PC that can be used in the office environment without drawing any attention. Then while out of hours you can easily game on it with attaching the controls or using the connector. You get the best of both worlds with the ONEXPLAYER X1 AMD.

You can learn more about and buy the [ONEXPLAYER X1 AMD](https://droix.net/product/onexplayer-x1-amd/) and [ONEXPLAYER X1 Mini](https://droix.net/product/onexplayer-x1-mini/) at their respective links.
