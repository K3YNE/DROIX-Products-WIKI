---
title: RG351M Review – Finally, a metal ANBERNIC  RG351 model!
source_url: "https://droix.net/blogs/anbernic-rg351m-review/"
...
[What is the RG351M?](#what-is-the-rg351m)

[[Video] RG351M Review](#video-rg351m-review)

[RG351M Overview](#rg351m-overview)

[RG351M Technical Specifications](#rg351m-technical-specifications)

[Operating System](#operating-system)

[Wireless Multiplayer Demo](#wireless-multiplayer-demo)

[RG351M Emulation Tests](#rg351m-emulation-tests)

[Summary](#summary)

[Where to buy RG351M](#where-to-buy-rg351m)

## What is the RG351M?

The [RG351M](https://go.droix.co.uk/RG351M) is one of the newer retro gaming consoles by ANBERNIC – creators of the similarly positioned predecessor handheld, the [RG350M](https://go.droix.co.uk/RG350M). The RG351M can be considered a successor to the [RG351P](https://go.droix.co.uk/RG351P). Much like how the RG350M was to the [RG350](https://go.droix.co.uk/RG350).
...
If you prefer playing using the D-Pad, it feels very responsive and offers pixel perfect precision. There are SELECT and START buttons and four gaming buttons. On the bottom of the device are Stereo speakers. There is a Micro SD Card slot which contains the [EMUELEC operating system](https://github.com/EmuELEC) and the games. Beside that is a hard reset button.
...
 The RG series of [handhelds by Anbernic](https://droix.net/blogs/brand/anbernic/) have run all the popular 8 and 16 bit systems near on perfectly for some time. So we won’t cover systems such as the Mega Drive, SNES, Neo Geo etc in great detail. They all run great and you should not have any issues enjoying these systems. Instead we will concentrate on the more recent systems.
...
The [RG351M by Anbernic](https://go.droix.co.uk/RG351M) improves on the original P model with a great premium feeling aluminium alloy case and Wi-Fi connectivity built in. Other than these two factors, both models perform pretty much identically the same.
...
 Whichever model you decide on, you can be assured that the RG351 series are great handhelds sitting at the top of a mass of many other retro handhelds. It also has very good support in terms of custom firmware such as [ARKOS](https://github.com/christianhaitian/arkos/wiki) if that is something you are interested in.

## Where to buy RG351M

Thanks for giving our RG351M review a quick look. If you would like to purchase an RG351M of your own, you can [buy an RG351M here](https://go.droix.co.uk/RG351M), or click the link at the bottom of the page. And do check out our range of [retro gaming handhelds](https://go.droix.co.uk/RETRO-GAMING-HANDHELD), there is something for everyone.

[BUY NOW](https://go.droix.co.uk/RG351M)