---
title: AYANEO Flip Review with video – Awesome Keyboard or Dual Screen handheld gaming PC
source_url: "https://droix.net/blogs/ayaneo-flip-review-with-video/"
source_site: droix.net
type: review-blog
date: 2024-04-12
---

AYA NEO caused a bit of a stir when they announced a clamshell with a choice of keyboard or dual screen handheld gaming PCs. Let’s find out in our [AYANEO Flip](https://droix.net/product/ayaneo-flip/) review if two is better than one, as we take a look at both models, compare their features and performance, play a bunch of games and emulators, and decide which one is best.

Contents

[AYANEO Flip review video](#ayaneo-flip-review-video)

[AYANEO Flip Unboxing](#ayaneo-flip-unboxing)

[AYANEO Flip Overview](#ayaneo-flip-overview)

[AYA NEO Flip technical specifications](#aya-neo-flip-technical-specifications)

[System benchmarks and comparisons](#system-benchmarks-and-comparisons)
...
[OcuLink Benchmarks](#oculink-benchmarksnbsp)
...
We continue our AYANEO Flip review with an overview of the two models. The AYANEO Flip is available in two models, [AYANEO Flip KB](https://droix.net/product/ayaneo-flip/) with a keyboard and AYANEO Flip DS for Dual Screen. Both measure around 7.08 x 4.01 x 1.17 in (18.0 x 10.2 x 2.98 cm) and weigh 650g (1.433 lbs).
...
Both [AYANEO Flip](https://droix.net/product/ayaneo-flip/) portable gaming computers have a 7” IPS touchscreen with a 1080P resolution and 120Hz refresh rate. The display’s hinge fully opens to just under 180 degrees and has two angled locks in between for the most popular viewpoints at 120 and 150 degrees.
...
Next in our [AYANEO Flip](https://droix.net/product/ayaneo-flip/) review we take a look at the technical specifications, check out the battery life, fan noise and temperatures.

|  |  |  |
| --- | --- | --- |
|  | **AYANEO FLIP KB** | **AYANEO FLIP DS** |
| **DISPLAY (MAIN)** | 7″ 1080P [IPS](https://droix.net/product-attribute/display-type/ips/) Dynamic Screen, 120Hz, 368 PPI, 400 nits, 100% sRGB | 7″ 1080P IPS Dynamic Screen, 120Hz, 368 PPI, 400 nits, 100% sRGB |
| **DISPLAY (SECONDARY)** | N/A | 3.5″ IPS screen, 960×640 resolution, 3:2 ratio |
| **CPU** | AMD [Ryzen 7 7840U](https://droix.net/product-attribute/processor-cpu-model/ryzen-7-7840u/), 8 cores 16 threads up to 5.1GHz at 28W TDP | AMD Ryzen 7 7840U, 8 cores 16 threads up to 5.1GHz at 28W TDP |
| **GPU** | AMD Radeon 780M | AMD [Radeon 780M](https://droix.net/product-attribute/graphics-gpu-model/radeon-780m/) |
| **RAM** | Up to 64GB LPDDR5X | Up to 64GB [LPDDR5X](https://droix.net/product-attribute/memory-ram-technology/lpddr5x/) |
| **STORAGE** | Up to 2TB M.2 2230 PCIe 4.0 SSD | Up to 2TB M.2 2230 PCIe 4.0 SSD |
| **I/O** | 1x USB 4 Type-C, 1x USB 3.2 Gen 2, 1x Oculink, 1x UHS-II Micro SD Card reader, 1x 3.5mm headphone jack | 1x USB 4 Type-C, 1x USB 3.2 Gen 2, 1x Oculink, 1x UHS-II Micro SD Card reader, 1x 3.5mm headphone jack |
| **PHYSICAL KEYBOARD** | Customisable RGB backlit keyboard | N/A |
| **CONNECTIVITY** | [Wi-Fi 6E](https://droix.net/product-attribute/wi-fi/6e/), Bluetooth 5.2 | Wi-Fi 6E, [Bluetooth 5.2](https://droix.net/product-attribute/bluetooth/5-2/) |
| **BATTERY** | 45Wh | 45Wh |
| **SIZE** | 7.08 x 4.01 x 1.17 in (18.0 x 10.2 x 2.98 cm) | 7.08 x 4.01 x 1.17 in (18.0 x 10.2 x 2.98 cm) |
| **WEIGHT** | 650g (1.433 lbs) | 650g (1.433 lbs) |
...
We will now benchmark both models in our AYANEO Flip review, as well as compare them with other similar handhelds including the AYANEO Slide, [GPD Win Mini](https://droix.net/product/gpd-win-mini/) and [GPD WIN MAX 2 2023](https://droix.net/product/gpd-win-max-2-2023/) for their performance.
...
For single core we see strangely low performance for the [AYANEO Flip](https://droix.net/product/ayaneo-flip/) DS compared to the KB compact gaming PC. We rerun the test in case there was an issue and got the same score. But when compared with other models, the scores can vary quite a bit. For multi core, we do see the DS drop a little there.
...
Overall both [AYANEO Flip](https://droix.net/product/ayaneo-flip/) models do very well, with the best frames per second at 28W TDP both resolutions. We do see lower performance at low TDP but this can be how the power is set up.
...
Again the [AYANEO](http://product-attribute/brands/ayaneo/) performance on Battle Ground is lower than its GPD and ONEXPLAYER counterparts, and we see more comparable FPS on the other two tests.

## OcuLink Benchmarks

As the AYANEO Flip has an [OcuLink](https://droix.net/blogs/oculink-transforming-graphics-card-connectivity/) port, we are able to test the performance with an eGPU with the internal display and an external 4K monitor as part of our AYANEO Flip Review.

AYANEO Flip with GPD G1 eGPU docking station

We are testing this with the brand new [GPD G1 2024 eGPU docking station](https://droix.net/product/gpd-g1/), but it will also work equally as well with the [ONEXPLAYER ONEXGPU eGPU docking station](https://droix.net/product/onexplayer-onexgpu/).
...
But overall the [AYA NEO Flip](https://droix.net/product/ayaneo-flip/) models are decent performers. We did see one or two instances where performance is lower than others, and we did also see very good performance with OcuLink. Overall nothing much to complain about on the KB model, maybe a little performance issue with the DS model though.
...
Ryujinx with a video playing

## Final Thoughts

Lets wrap up our AYANEO Flip review with some of our thoughts on the [AYA NEO Flip](https://droix.net/product/ayaneo-flip/). Which mobile gaming PC is better? Here are my main takeaways after spending some time with the handhelds..
...
And if you have or plan to use an eGPU with the [AYANEO Flip](https://droix.net/product/ayaneo-flip/) then you can expect very good performance. The Internal graphics performance is higher than most other portable gaming computers, and we saw some of the best benchmark results for external display.
...
You can learn more and [buy the AYA NEO Flip here](https://droix.net/product/ayaneo-flip/). Use the discount code **FLIPPIN5OFF** for a 5% discount on the checkout. Code is valid from one month of this review posted and can not be used during store sales or promotions.

[BUY THE AYANEO FLIP KB/DS HERE](https://droix.net/product/ayaneo-flip/)
