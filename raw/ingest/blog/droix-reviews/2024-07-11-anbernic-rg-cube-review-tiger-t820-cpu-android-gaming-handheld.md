---
title: "Anbernic RG Cube Review: Tiger T820 CPU Android Gaming Handheld"
source_url: "https://droix.net/blogs/anbernic-rg-cube-review/"
source_site: droix.net
type: review-blog
date: 2024-07-11
---

The Anbernic RG Cube [Android gaming handheld](https://droix.net/product-category/gaming-handheld/android-gaming-handheld/) has been out for a bit now. The square screen is the first thing you will notice, it’s great for retro consoles, but how will this deal with wide screen consoles and handhelds? Let’s find out in our Anbernic RG Cube review.

Contents

[Anbernic RG Cube Review Video](#anbernic-rg-cube-review-video)

[Anbernic RG Cube Overview](#anbernic-rg-cube-overview)

[Anbernic RG Cube Technical Specifications](#anbernic-rg-cube-technical-specifications)

[Anbernic RG Cube System Benchmarks](#anbernic-rg-cube-system-benchmarksnbsp)
...
[Anbernic RG Cube Emulation Performance](#anbernic-rg-cube-emulation-performance)
...
[Final Thoughts on the Anbernic RG Cube](#final-thoughts-on-the-anbernic-rg-cube)
...
Beige White Radiant Purple Black and Grey
...
|  |  |
| --- | --- |
| **CPU** | Unisoc [T820](https://droix.net/product-attribute/processor-cpu-model/t820/) processor, 6nm EUV 5G SOC chip. 8 cores: 1\*[[email protected]](/cdn-cgi/l/email-protection), 3\*[[email protected]](/cdn-cgi/l/email-protection), 4\*[[email protected]](/cdn-cgi/l/email-protection) |
...
| **STORAGE** | 128G [UFS 2.2](https://droix.net/product-attribute/storage-technology/ufs-2-2/) |
| **DISPLAY** | 3.95-inch [IPS](https://droix.net/product-attribute/display-type/ips/) screen, OCA full lamination, multi-touch, resolution: 720\*720 |
| **ANDROID OS** | 13 |
| **COMMUNICATIONS** | 2.4/5G WIFI 802.11a/b/g/n/ac, [Bluetooth 5.0](https://droix.net/product-attribute/bluetooth/5/) |
...
For the system benchmarks we are comparing the [Anbernic RG Cube](https://droix.net/product/anbernic-rg-cube/) with lower as well as higher priced Android gaming devices to get a comparison of price versus performance for our Anbernic RG Cube review.

### Geekbench 5

Anbernic RG Cube Geekbench 5 Benchmark Comparison

First in our tests is Geekbench 5. We see fairly close scores to the Anbernic 556 model which uses the same CPU and GPU.  We are looking at around mid range performance, not far off the Retroid Pocket 4 model, read our [review here](https://droix.net/blogs/retroid-pocket-4-vs-retroid-pocket-4-pro-with-video/). Overall decent performance.

### Geekbench 6

Anbernic RG Cube Geekbench 6 Benchmark Comparison
...
Anbernic RG Cube Antutu Benchmark Comparison

On Antutu we see a bit lower than expected performance than the RG556 model. This could be down to benchmarking with different versions for example, as the 556 model was last tested a few months ago. The [AYANEO Pocket S](https://droix.net/product/ayaneo-pocket-s/) takes the lead here with its high end CPU and GPU combination.
...
Anbernic RG Cube 3DMARK Benchmark Comparison
...
TV Output to the DroiX PM14 portable monitor

Video output to an external display is supported via USB-C. You can use a USB-C to HDMI hub such as our [DroiX NH8](https://droix.net/product/droix-nh8-nvme-usb-hub/) or [NT8](https://droix.net/product/droix-nt8-clear-usb-hub/) models. Or if your display supports USB-C input, such as our [PM14 portable monitor](https://droix.net/product/droix-pm14-portable-monitor/), then you can use a USB-C to C cable. The video will initially show in the square aspect ratio but you can change to desktop mode in the settings for full screen display.
...
Let us know in the comments what you think of the [Anbernic RG Cube](https://droix.net/product/anbernic-rg-cube/). Do you like the 1:1 aspect ratio or prefer 16:9?
...
The [Anbernic RG Cube](https://droix.net/product/anbernic-rg-cube/) is comfortable to play on. The textured grips on the back help to keep your fingers from sliding whilst playing. The size is not too bad, it can fit in a jacket pocket quite easily. The battery life is a big plus here, depending on the usage, you can get up to several hours.
...
You can learn more about and [buy the Anbernic RG Cube here](https://droix.net/product/anbernic-rg-cube/).

[BUY THE ANBERNIC RG CUBE HERE](https://droix.net/product/anbernic-rg-cube/)
