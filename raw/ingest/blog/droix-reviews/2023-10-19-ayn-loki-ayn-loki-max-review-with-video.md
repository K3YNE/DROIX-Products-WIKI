---
title: AYN Loki & AYN Loki Max Review with video
source_url: "https://droix.net/blogs/ayn-loki-ayn-loki-max-review-with-video/"
source_site: droix.net
type: review-blog
date: 2023-10-19
---

In our [AYN Loki](https://droix.net/product/ayn-loki/) and AYN Loki Max review we compare the two models for their performance to see how much difference there is at various TDP’s, with some interesting results.

Contents

[AYN Loki & AYN Loki Max Review Video](#ayn-loki-amp-ayn-loki-max-review-video)

[Unboxing the AYN Loki MAX](#unboxing-the-ayn-loki-max)

[AYN Loki Overview](#ayn-loki-overview)

[AYN Loki and Loki Max technical specifications](#ayn-loki-and-loki-max-technical-specifications)

[AYN Loki and Loki Max System Benchmarks](#ayn-loki-and-loki-max-system-benchmarks)

[3DMark](#3dmark)

[Cinebench](#cinebench)

[AYN Loki and Loki Max Gaming benchmarks](#ayn-loki-and-loki-max-gaming-benchmarks)
...
Available for purchase separately is the official case for the [AYN Loki](https://droix.net/product/ayn-loki/). It is a hardshell case and keeps the device very well protected against bumps and scrapes. It has a handle for carrying and a dual zip design for ease of opening. It’s definitely worth buying for your Loki to keep it protected.

## AYN Loki Overview

Next in our [AYN Loki Max](https://droix.net/product/ayn-loki/) review we take a closer look at the device. The AYN Loki and AYN Loki Max measures around 9.7 x 3.7 x 1.5 inches (24.8 x 9.6 x 3.5) and weighs 573g. They are available in black or white colours.
...
On the front we have standard dual analogue joysticks, d-pad and gaming buttons, with two additional buttons either side of the display at the bottom. One for the Xbox home button and the other to bring up the [AYN Loki](https://droix.net/product/ayn-loki/) overlay.
...
So far the Loki and Loki Max have been the same, in our [AYN Loki Max](https://droix.net/product/ayn-loki/) review we compare the tech specs to see the differences.

|  |  |  |
| --- | --- | --- |
|  | **AYN LOKI** | **AYN LOKI MAX** |
| **CPU** | AMD Ryzen 5 [6600U](https://droix.net/product-attribute/processor-cpu-model/ayn-loki-ryzen-5-6600u-2/), 6 cores, 12 threads up to 4.5GHz @ 30W TDP | AMD Ryzen 7 [6800U](https://droix.net/product-attribute/processor-cpu-model/ryzen-7-6800u/), 8 cores, 16 threads up to 4.7GHz @ 30W TDP |
| **GPU** | AMD Radeon [660M](https://www.notebookcheck.net/AMD-Radeon-660M-GPU-Benchmarks-and-Specs.589879.0.html), 6 cores up to 1900Mhz | AMD Radeon [680M](https://www.techpowerup.com/gpu-specs/radeon-680m.c3871), 12 cores up to 2200Mhz |



|  |  |
| --- | --- |
| **DISPLAY** | 6″ LCD Touchscreen, 1080P resolution |
| **RAM** | 8GB/16GB LPDDR5 6400Mhz |
| **STORAGE** | 128GB/256GB/512GB M.2 2242 NVMe |
| **COMMUNICATIONS** | [Wi-Fi 6E](https://droix.net/product-attribute/wi-fi/6e/), Bluetooth 5.2 |
| **I/O** | Micro SD card reader, 3.5mm headphone jack, USB 4.0 |
...
And continuing the benchmarks we also include gaming benchmarks as part of our Loki and [AYN Loki Max](https://droix.net/product/ayn-loki/) review and comparison.
...
The [Loki Max](https://droix.net/product/ayn-loki/) takes the lead on all benchmarks here but as the TDP lowers we see the gap close between the two models. From 37% at 28W TDP, down to only 6% at 11%.
...
The [Loki Max](https://droix.net/product/ayn-loki/) clearly outperforms the Loki at the higher end of the TDP scale, but as you lower the TDP the performance difference gap does get closer.
...
We sum up our final thoughts in our AYN Loki and [AYN Loki Max](https://droix.net/product/ayn-loki/) review. The AYN Loki and Loki Max are at the lower end price range of handheld gaming PCs. To be honest there is not much difference in performance compared to the more expensive ones. The Loki Max is likely the right model to choose for most people. It has far greater performance at higher TDP than the Loki. But don’t discount the Loki, the performance at lower TDP is not far off the Max.
...
You can learn more about and buy the [AYN Loki](https://droix.net/product/ayn-loki/) and [Loki MAX](https://droix.net/product/ayn-loki/) here. Use the discount code **5OFFLOKI** for a 5% discount. Please note the code may expire after one month, and it can not be used while there is a sale or other promotion.

[BUY AYN LOKI & AYN LOKI MAX HERE](https://droix.net/product/ayn-loki/)
