---
title: Anbernic RG Nano Review with video – Do good things come in small retro gaming handhelds?
source_url: "https://droix.net/blogs/anbernic-rg-nano-review-with-video/"
source_site: droix.net
type: review-blog
date: 2023-07-06
---

They say good things come in small packages, let’s put that to the test with Anbernic’s smallest handheld to date, the [RG Nano](https://droix.net/product/anbernic-rg-nano/). Join us in our RG Nano review as we unbox, overview, test the emulators performance and see how the games look on this tiny [retro gaming handheld](https://droix.net/product-category/handhelds/retro-gaming-handheld/).

Contents

[Anbernic RG Nano Review Video](#anbernic-rg-nano-review-video)

[Unboxing the RG Nano](#unboxing-the-rg-nano)

[RG Nano Overview](#rg-nano-overview)

[RG Nano Technical Specifications](#rg-nano-technical-specifications)

[Operating System Overview](#operating-systemnbspoverview)

[Frontend](#frontend)

[Real Time Clock Function](#real-time-clock-function)

[Emulator Functions](#emulator-functions)

[Garlic OS Custom Firmware?](#garlic-os-custom-firmware)

[Emulator Performance](#emulator-performance)

[Gameboy, Gameboy Colour and Game Gear](#gameboy-gameboy-colour-and-game-gear)
...
[MegaDrive & SNES](#megadrive-amp-snes)

[PS1](#ps1)

[Final Thoughts](#final-thoughts)

[Where to buy the Anbenic RG Nano?](#where-to-buy-the-anbenic-rg-nano)

[The RG Nano getting started guide](#the-rg-nano-getting-started-guide)
...
Anbernic RG Nano Unboxed

There is a keychain which you can use with the [RG Nano](https://droix.net/product/anbernic-rg-nano/) to keep it on a zip, strap or keyring. Next there is a USB Type-C charge cable. And last but not least there is a Type-C to 3.5mm audio convertor cable which you can use to connect to headphones or speakers.

Anbernic RG Nano Unboxing

## RG Nano Overview

We continue our RG Nano review with an overview of the handheld game emulator. The [Anbernic RG Nano](https://droix.net/product/anbernic-rg-nano/) is available in three colours; Blue, Purple and Red. They measure 2.79 x 1.69 x 0.66 in (7.1 x 4.3 x 1.7cm) and weigh only 75 grams. The low weight is impressive with it being an aluminium alloy case, it’s not much heavier than an average sized Egg, or 2 slices of bread or 4 compact discs to put it into context.

Anbernic RG Nano Review Colours and Dimensions
...
Anbernic RG Nano Side View

The D-Pad is surprisingly comfortable to use, though a little inaccurate in the heat of the moment. The gaming buttons are quite small but after spending a bit of time using them, they are not that bad and are responsive. You can’t grip the [RG Nano](https://droix.net/product/anbernic-rg-nano/) portable game emulator, and instead rest it on your fingers which is quite comfortable for short periods of time.

## RG Nano Technical Specifications

|  |  |
| --- | --- |
| **CPU** | Allwinner V3s ARM [Cortex-A7](https://droix.net/product-attribute/processor-cpu-model/cortex-a7/) dual core processor running up to 1.2Ghz |
| **RAM** | 64MB [DDR2](https://droix.net/product-attribute/memory-ram-technology/ddr2/) |
| **STORAGE** | 64GB micro SD card, can use up to 512GB card |
| **DISPLAY** | 1.54” 60Hz [IPS](https://en.wikipedia.org/wiki/IPS_panel) display at 240×240 resolution |
| **OS** | Linux |
| **BATTERY** | [Polymer lithium-ion](https://en.wikipedia.org/wiki/Lithium_polymer_battery) battery 1050 mAh, lasting 2.5 hours |
...
We are basing our [RG Nano](https://droix.net/product/anbernic-rg-nano/) review on the latest version 1.0.1 of the firmware which has some improvements over the shipped firmware. It includes some retroarch emulator cores as well as ported games. We have a guide on [how to update the RG Nano firmware here](https://droix.co.uk/knowledge-base/article/how-to-update-the-rg-nano-firmware/).
...
Anbernic RG Nano Emulator Menu
...
It is worth mentioning that [Black Seraph](https://www.patreon.com/blackseraph) has hinted that the Garlic OS custom firmware may be coming to the [RG Nano](https://droix.net/product/anbernic-rg-nano/) vintage gaming emulator. No other details have been announced as yet. But we know from his previous releases on other handhelds that it should work very well and is definitely worth installing once it is released. We will make an install guide on our [Knowledge Base](https://droix.co.uk/knowledge-base/) when it is available.
...
We conclude our RG Nano review with our thoughts on the handheld game emulator. The RG Nano is an interesting retro emulator device. When the review samples arrived, everyone in the office was queuing up to try them. The initial feedback was *“I am going to buy one for my child”* or *“this is great for when on the train”* etc. We do get this feedback from other products but not as many as what the [RG Nano](https://droix.net/product/anbernic-rg-nano/) did.

GBC emulator on Anbernic RG Nano
...
You can learn more and [buy your Anbernic RG Nano here](https://droix.net/product/anbernic-rg-nano/). Use the code **RGNANO5OFF** for a 5% discount on the Checkout. Or browse our range of [retro gaming handhelds here](https://droix.net/product-category/handhelds/retro-gaming-handheld/).

[BUY THE ANBERNIC RG NANO HERE](https://droix.net/product/anbernic-rg-nano/)
...
If you are planning to [order the RG Nano](https://droix.net/product/anbernic-rg-nano/) or just got yours delivered, we have a handy [getting started guide here](https://droix.net/blogs/so-youve-just-bought-an-rg-nano/). It goes into detail covering topics such as changing the frontend, aspect ratio switching, firmware updating, adding files to the SD card and much more.

[azp\_custom\_product id=”7″]