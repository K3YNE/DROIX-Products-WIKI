---
title: "ONEXPLAYER ONEXFLY Apex Review: The Ultimate Strix Halo Handheld Gaming PC?"
source_url: "https://droix.net/blogs/onexplayer-onexfly-apex-review-pc/"
...
[ONEXPLAYER ONEXFLY Apex Review Video](#onexplayer-onexfly-apex-review-video)

[ONEXPLAYER ONEXFLY Apex Overview](#onexplayer-onexfly-apex-overview)

[Display and Controls](#display-and-controls)

[I/O Ports and Connectivity](#io-ports-and-connectivity)

[Cooling and Battery Design](#cooling-and-battery-design)

[ONEXPLAYER ONEXFLY Apex Technical Specifications](#onexplayer-onexfly-apex-technical-specifications)

[ONEXPLAYER ONEXFLY Apex Review Technical Specifications](#onexplayer-onexfly-apex-review-technical-specifications)

[CPU Differences](#cpu-differences)

[GPU Differences](#gpu-differences)

[ONEXPLAYER ONEXFLY Apex Technical Specifications](#onexplayer-onexfly-apex-technical-specifications)

[Battery Pack Techincial Specifications](#battery-pack-techincial-specifications)

[Battery Dock Technical Specifications](#battery-dock-technical-specifications)

[Battery Life, Fan Noise and Thermals Tests](#battery-life-fan-noise-and-thermals-tests)

[Addressing the External Battery Issue](#addressing-the-external-battery-issue)

[Mini SSD Support: Expanding your Library](#mini-ssd-support-expanding-your-library)

[Strix Halo System Benchmarks](#strix-halo-system-benchmarks)

[Cinebench 2024](#cinebench-2024)

[Geekbench 6](#geekbench-6)

[3DMARK Graphics Tests](#3dmark-graphics-tests)

[Gaming Benchmarks: RDNA 3.5 Performance](#gaming-benchmarks-rdna-35-performance)
...
[VITA3K (PS Vita)](#vita3k-ps-vita)

[Eden](#eden)

[XENIA (Xbox 360)](#xenia-xbox-360)

[Final Thoughts on our ONEXPLAYER ONEXFLY Apex review](#final-thoughts-on-our-onexplayer-onexfly-apex-review)
...
ONEXPLAYER ONEXFLY Apex Battery back



ONEXPLAYER ONEXFLY Apex Battery Kickstand
...
ONEXPLAYER ONEXFLY Apex Front View
...
ONEXPLAYER ONEXFLY Apex Bottom View



ONEXPLAYER ONEXFLY Apex Top View
...
ONEXPLAYER ONEXFLY Apex Back View
...
[ALREADY DECIDED ON THE ONEXPLAYER ONEXFLY APEX? BUY HERE](https://www.amazon.com/dp/B0GMJKHGCS)
...
| --- | --- | --- |
| **CPU** | AMD Ryzen AI MAX+ 395 | AMD [Ryzen AI MAX 385](https://droix.net/product-attribute/processor-cpu-model/ryzen-al-max-385-2/ "Ryzen AI MAX 385") |
...
|  | APEX VERSION 1 | APEX VERSION 2 |
| --- | --- | --- |
| **GPU** | AMD Radeon 8060S Graphics | AMD [Radeon 8050S Graphics](https://droix.net/product-attribute/graphics-gpu-model/ryzen-al-max-385-radeon-8050s-2/ "Radeon 8050S Graphics") |
...
| **STORAGE** | M.2 2280 [PCIe 4.0 x4 SSD](https://droix.net/product-attribute/storage-technology/nvme-pci-e-gen-4-0/ "PCIe 4.0 x4 SSD") Slot |
| **DISPLAY** | 8-inch Native Landscape Screen, 1920×1200, 120Hz (VRR Supported), 500 NITS, Colour Gamut: 100% sRGB, Aspect Ratio: [16:10](https://droix.net/product-attribute/aspect-ratio/1610/ "16:10") |
...
| **PORTS & EXPANSIONS** | [1x USB-C 4.0 Port](https://droix.net/product-attribute/i-o-video/1x-via-usb-4-0-type-c-40gb-s/ "1x USB-C 4.0 Port") 1x USB-C 3.2 Port [1x USB-A 3.2 Port](https://droix.net/product-attribute/i-o-usb/1x-usb-type-a-3-2-gen-2/ "1x USB-A 3.2 Port") [1x Mini SSD Slot](https://droix.net/product-attribute/storage-expansion/1x-mini-ssd-card-slot/ "1x Mini SSD Slot") [1x microSD Card Slot](https://droix.net/product-attribute/storage-expansion/1x-micro-sd-card-slot/ "1x microSD Card Slot") 1x 3.5mm Audio Jack 1x DC Power Jack |
| **WI-FI** | [6E](https://droix.net/product-attribute/wi-fi/6e/ "6E") |
| **BLUETOOTH** | [5.2](https://droix.net/product-attribute/bluetooth/5-2/ "5.2") |
...
ONEXPLAYER ONEXFLY APEX Thermals
...
Shortly before we received our unit for this [ONEXPLAYER ONEXFLY Apex](https://droix.net/product/onexplayer-onexfly-apex/ "ONEXPLAYER ONEXFLY Apex") review, it was made known that there is an issue with the supplied external battery. Once the battery reaches certain temperature conditions, the TDP will automatically lower to 20W.
...
Like the WIN 5, the Apex supports the relatively new [Biwin Mini SSD](https://droix.net/product/biwin-mini-ssd/ "Biwin Mini SSD") format. It is slightly larger than a micro SD card but offers far faster read and write speeds. The Apex supports 2 PCIe lanes, rather than just the 1 on the WIN 5.

ONEXPLAYER ONEXFLY Apex Mini SSD and Micro SD Compared



ONEXPLAYER ONEXFLY Apex Mini SSD supported

We get double the read and write speeds on the Apex, with 3,551 MB/s and 3,331 MB/s, compared with 1,785 MB/s and 1,745 MB/s on the WIN 5. Top marks here! Read more about it in our [BIWIN Mini SSD review here](https://droix.net/blogs/biwin-mini-ssd-review/ "BIWIN Mini SSD review here").
...
For the [Cinebench 2024](https://www.maxon.net/en/downloads/cinebench-downloads "Cinebench 2024") benchmark, we see around the expected score for single-core performance. However, for multi-core performance, we do see a very noticeable improvement over the GPD WIN 5’s score, showcasing the power of the Zen 5 cores.

ONEXPLAYER ONEXFLY Apex Cinebench 2024 Benchmark Results

### Geekbench 6

For Geekbench 6, we see a marginal difference in results for both single and multi-core performance between the Apex and [GPD WIN 5](https://droix.net/product/gpd-win-5/ "GPD WIN 5"). It is what we would expect to see from this generation of compact gaming PC.

ONEXPLAYER ONEXFLY Apex Geekbench 6 Benchmark Results
...
ONEXPLAYER ONEXFLY Apex 3DMARK Benchmark Results
...
ONEXPLAYER ONEXFLY Apex Forza Horizon 5 Benchmark Results
...
ONEXPLAYER ONEXFLY Apex Shadow of the Tomb Raider Benchmark Results
...
ONEXPLAYER ONEXFLY Apex Cyberpunk Benchmark Results
...
We know from the GPD WIN 5 that the Ryzen 395 processor is amazing for gaming. You can happily run many games at 1200P with higher settings on this handheld gaming computer. Let’s take a closer look at some as part of our [ONEXPLAYER ONEXFLY Apex](https://www.amazon.com/dp/B0GMJKHGCS "ONEXPLAYER ONEXFLY Apex") review, and what they can run at.

### Cyberpunk 2077

Cyberpunk 2077 on the ONEXPLAYER ONEXFLY Apex
...
Warhammer Space Marine 2 on the ONEXPLAYER ONEXFLY Apex
...
DOOM Dark Ages on the ONEXPLAYER ONEXFLY Apex
...
Everything up to the more modern console and handheld era is, of course, going to run great on this [handheld gaming PC](https://droix.net/product-category/gaming-handheld/handheld-gaming-pcs/ "handheld gaming PC"). You can enjoy increased rendering resolutions and improved graphics tweaks with no issues. A crucial part of any [ONEXPLAYER ONEXFLY Apex](https://droix.net/product/onexplayer-onexfly-apex/ "ONEXPLAYER ONEXFLY Apex") review is testing high-end emulators, so let’s take a look.

### RPCS3 (PS3)

RPCS3 emulator on the ONEXPLAYER ONEXFLY Apex
...
Eden emulator on the ONEXPLAYER ONEXFLY Apex
...
Xenia emulator on the ONEXPLAYER ONEXFLY Apex
...
ONEXPLAYER ONEXFLY Apex Shadow of the Tomb Raider Benchmark
...
ONEXPLAYER ONEXFLY Apex close up

Barring the battery issue, overall I have no major complaints about the [Apex](https://droix.net/product/onexplayer-onexfly-apex/ "Apex"). The size and weight may not be for everyone, and if this is a concern for you, then the [WIN 5](https://droix.net/product/gpd-win-5/ "WIN 5") is probably the best option for you. Otherwise, the Apex is an excellent choice for handheld gaming.

[PRE-ORDER THE ONEXPLAYER ONEXFLY APEX HERE](https://droix.net/product/onexplayer-onexfly-apex/)

You can learn more about and [buy the ONEXPLAYER ONEXFLY Apex here](https://droix.net/product/onexplayer-onexfly-apex/ "buy the ONEXPLAYER ONEXFLY Apex here"). That wraps up our ONEXPLAYER ONEXFLY Apex review. We hope you found it useful. If you have any q