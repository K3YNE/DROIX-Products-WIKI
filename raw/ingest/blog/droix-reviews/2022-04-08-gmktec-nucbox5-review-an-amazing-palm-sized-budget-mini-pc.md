---
title: GMKtec NUCBOX5 Review – An amazing palm sized budget mini PC!
source_url: "https://droix.net/blogs/gmktec-nucbox5-review/"
source_site: droix.net
type: review-blog
date: 2022-04-08
---

You may have seen a sneak peek of the [GMKtec NUCBOX5 mini PC](https://droix.net/product/gmk-nucbox/) in our recent [best budget mini PC](https://droix.net/blogs/best-budget-mini-pcs/) article, if you haven’t already, read it to find out who won! In our GMKtec NUCBOX5 review we take a closer look at the device then after we run some benchmarks to see its performance. We then try some games and emulators to see its how well it can run them.

Contents

[GMKtec NUCBOX5 Review Video](#gmktec-nucbox5-review-video)

[Unboxing the GMKtec NUCBOX5](#unboxing-the-gmktec-nucbox5)

[GMKtec NUCBOX5 Overview](#gmktec-nucbox5-overview)

[GMKtec NUCBOX5 Technical Specifications](#gmktec-nucbox5-technical-specifications)
...
[Summary – Is the NUCBOX5 worth buying?](#summary-is-the-nucbox5-worth-buying)

[Where can I buy the GMKtec NUCBOX5?](#where-can-i-buy-the-gmktec-nucbox5)
...
The [GMKtec NUCBOX5](https://droix.net/product/gmk-nucbox/) is our smallest reviewed PC, measuring just 2.8 x 2.8 x 1.7 inches (7.2 x 7.2 x 4.4 cm) and weighing only 204 grams!
...
And on the back you can find a USB Type-C port used for the power. Two [HDMI 2.0](https://en.wikipedia.org/wiki/HDMI#Version_2.0) ports supporting dual monitor up to 4K 60Hz, a 3.5mm headphone port, a gigabit ethernet port and a USB 3.2 port.

## GMKtec NUCBOX5 Technical Specifications

|  |  |
| --- | --- |
| **CPU** | Intel 11th generation Jasper Lake N5105 |
| **CORE / THREAD** | 4 / 4 |
| **FREQUENCY (Base / MAX)** | 2.0GHz / 2.9GHz |
| **GPU** | Intel UHD Graphics |
| **RAM** | 8GB DDR4 LPDDR4x @ 2933MHz (Max 12GB( |
| **STORAGE** | 256GB / 512GB SSD (Max 1TB) |
| **SLOT** | 3x USB-A 3.2 2x HDMI 2.0 1x Type-C (Power only) Gigabit LAN RJ45 1x 3.5mm Headphone Jack Micro SD Card slot (Max 128GB) |
| **WI-FI** | 802.11 a/b/g/n/ac/ax WiFi 6 |
| **BLUETOOTH** | 5.2 |
| **OS** | Windows 11 Home |
| **SIZE / WIGHT** | 2.8 x 2.8 x 1.7 inches (7.2 x 7.2 x 4.4 cm) / 204 grams. |
...
|  |  |
| --- | --- |
| **MODEL** | **PASSMARK RESULT** |
| **Beelink U59** | 1455.6 |
| **Beelink GK Mini** | 912.7 |
| **Beelink GK35** | 590 |
| **Beelink GK35** | 765.5 |
...
As we recently completed our [best budget mini PC comparison](https://droix.net/blogs/best-budget-mini-pcs/), we can compare the scores with those. The NUCBOX5 mini PC for work comes out on top with 1,749. It’s the highest performer in our range of budget mini PC’s of less than £250.

### PCMark

Next we are running PCMark to see the day to day performance when using the [NUCBOX5 mini PC](https://droix.net/product/gmk-nucbox/) for work and home. These include everything from web browsing, working with office documents, media consumption and some light image editing.

|  |  |
| --- | --- |
| **MINI PC MODEL** | **PCMARK RESULT** |
| **Beelink U59** | 2349 |
| **Beelink GK Mini** | 1852 |
| **Beelink GK35** | 1071 |
| **Beelink GK35** | 1345 |
...
The NUCBOX5 scores 2,522, again putting it just ahead of the [Beelink U59](https://droix.net/product/beelink-u59/) followed by the [Minisforum JB95](https://droix.net/product/minisforum-jb95/) office mini PC’s.

### 3DMark

3DMark tests the CPU and GPU together to see how they perform for video related tasks such as image or video editing through to gaming. The NUCBOX is not a [gaming mini pc](https://droix.net/blogs/product-category/mini-pcs/mini-pcs-for-gaming/), far from it, with a score of just 355. You would not be able to play any AAA high end games, but older ones and classic console emulators will be just fine as we will see shortly.
...
|  |  |
| --- | --- |
| **MODEL** | **CRYSTALDISKMARK DISK READ / WRITE MB/s** |
| **Beelink U59** | 540 / 401 |
| **Beelink GK Mini** | 515 / 491 |
| **Beelink GK35** | 244 / 130 |
| **Beelink GK35** | 559 / 487 |
...
Here is a summary of the benchmark results compared to other [mini PC’s](https://droix.net/blogs/product-category/mini-pcs/) in the sub £250 price range.
...
The SEGA Dreamcast is next and I was happy to see all of the games I tried running at full speed. I did not have any problems with lag or having to change settings. It simply works on the [NUCBOX5](https://droix.net/product/gmk-nucbox/)!
...
We can’t test the PlayStation Portable and [PPSSPP](https://www.ppsspp.org/) without God of War. I am pleased to say it pretty much runs at 60 frames per second. There were a couple of drops to 50 or so while playing but they were a rare occurrence and did not affect the gameplay too much. Other less demanding games work amazingly well!
...
You can learn more about and [buy the GMKtec NUCBOX5 here](https://droix.net/product/gmk-nucbox/). You can also [browse our range of mini PC’s here](https://droix.net/blogs/product-category/mini-pcs/).

[BUY NOW](https://droix.net/product/gmk-nucbox/)
