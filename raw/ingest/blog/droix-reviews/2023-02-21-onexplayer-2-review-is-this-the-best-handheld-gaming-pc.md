---
title: ONEXPLAYER 2 Review – Is this the best handheld gaming PC?
source_url: "https://droix.net/blogs/onexplayer-2-review/"
source_site: droix.net
type: review-blog
date: 2023-02-21
---

In our ONEXPLAYER 2 review we learn how it stacks up with the other AMD 6800U based [handheld gaming PC’s](https://droix.net/product-category/handhelds/handheld-gaming-pcs/). We will do all the usual unboxing and overview, followed by system and games benchmarks, then play some games and emulators at playable settings. And finish up with my thoughts on the [ONEXPLAYER 2](https://droix.net/product/onexplayer-2/).

Contents

[ONEXPLAYER 2 Review Video](#onexplayer-2-review-video)

[ONEXPLAYER 2 Unboxing](#onexplayer-2-unboxing)

[ONEXPLAYER 2 Overview](#onexplayer-2-overview)

[ONEXPLAYER 2 Technical Specifications](#onexplayer-2-technical-specifications)

[OXP Software](#oxp-software)
...
[Gaming Benchmarks Summary](#gaming-benchmarks-summary)

[Game Performance](#game-performance)

[FIFA 23](#fifa-23)

[Wanted Dead](#wanted-deadnbsp)
...
[Feel and useability](#feel-and-useability)

[Screen size](#screen-size)

[Performance](#performance)

[Should you buy the ONEXPLAYER 2?](#should-you-buy-the-onexplayer-2)

[Where to buy the ONEXPLAYER 2?](#where-to-buy-the-onexplayer-2)
...
First we have the [ONEXPLAYER 2 handheld gaming PC](https://droix.net/product/onexplayer-2/) itself which we will take a closer look at shortly.

ONEXPLAYER 2 Unboxed

Inside the first box we have the two detachable controllers.
...
The [ONEXPLAYER 2](https://droix.net/product/onexplayer-2/) handheld gaming PC is available in two colours; Midnight Black and Snow White.

It measures around 12.2 x 5 x 0.9 inches (31 x 12.7 x 2.3 cm) with the controllers connected, and weighs around 848g.

Snow White Midnight Black ONEXPLAYER 2 models
...
ONEXPLAYER 2 with controllers attached
...
When both controllers are connected the LED lighting around the analogue sticks and bottom of the controls are lit up. Unlike the very colourful [ONEXPLAYER Mini Pro](https://droix.net/product/onexplayer-mini-pro/), you can not customise the colours so it’s just the orange lighting unfortunately.

ONEXPLAYER 2 Top View
...
| **STORAGE** | 1TB / 2TB PCIe 3.0 [M.2](https://en.wikipedia.org/wiki/M.2) 2280 |
| **DISPLAY** | 8.4” Touchscreen 2560×1600 resolution |
| **COMMUNICATIONS** | [WiFi 6E](https://uk.pcmag.com/networking/131082/what-is-wi-fi-6e) Bluetooth 5.2 |
| **BATTERY** | 65.5 Wh battery |
...
|  |  |
| --- | --- |
| **TEST METHOD** | **TIME UNTIL ONEXPLAYER SWITCHED OFF** |
| 28W TDP 1600P full load | 1 hour 40 minutes |
| 28W TDP 1600P idle | 9 hours 30 minutes |
| 15W 800P full load | 2 hours 46 minutes |

Onexplayer 2 battery life times
...
PCMark10 Benchmark Comparison

The [ONEXPLAYER 2](https://droix.net/product/onexplayer-2/) gaming handheld scores 5,847.  We can see that the score is a little lower than the average, but not the lowest which is the [GPD WIN 4](https://droix.net/product/gpd-win-4/).
...
The ONEXPLAYER 2 scores very well, with just its smaller brother the [ONEXPLAYER Mini Pro](https://droix.net/product/onexplayer-mini-pro/) beating it.
...
Forza Horizon 5 ONEXPLAYER 2 Benchmark Results

And for our comparisons we are using 1200P and 800P at 28W TDP results. The results are fairly close to each other with around the early 90’s FPS at 1200P and 110-120 area for 800P. The ONEXPLAYER 2 gaming handheld takes the highest position along with the [GPD WIN MAX 2](https://droix.net/product/gpd-win-max-2/).

Forza Horizon 5 Benchmark Comparison

### Shadow of the Tomb Raider

We are running Shadow of the Tomb Raider on the Lowest graphics settings. And compared to the other 6800U based handhelds we again get very similar results. The [ONEXPLAYER 2](https://droix.net/product/onexplayer-2/) is in the higher range of frames per second.
...
Shadow of the Tomb Raider ONEXPLAYER 2 Benchmark Results
...
Call of Duty Modern Warfare 2 ONEXPLAYER 2 Benchmark Results
...
ONEXPLAYER 2 running Wanted Dead
...
ONEXPLAYER 2 running Call of Duty Modern Warfare 2
...
PS3 emulator RPCS3 with WipeOut HD
...
Yuzu emulator with Cruisn Blast
...
ONEXPLAYER 2 running Overwatch 2

The analogue joysticks are OK to play on and I had no issues reaching any gaming buttons. Although I would not have minded slightly larger joystick caps to match the size of the handheld. To put it in comparison, they are exactly the same size as the ones used on the [GPD Win 4](https://droix.net/product/gpd-win-4/). You could put some thumb caps on them to increase the size.
...
You can learn more and [buy the ONEXPLAYER 2 here](https://droix.net/product/onexplayer-2/). Use the discount **OXP25OFF** on the checkout for a 5% discount. Note, that discount codes are disabled during store sales or promotions. You can find our range of [handheld gaming PC’s here](https://droix.net/blogs/product-category/handhelds/handheld-gaming-pcs/).

[BUY ONEXPLAYER 2 HERE](https://droix.net/product/onexplayer-2/)
