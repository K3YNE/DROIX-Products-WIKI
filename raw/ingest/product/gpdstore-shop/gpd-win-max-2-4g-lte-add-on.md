---
title: GPD WIN MAX 2 / 2024 4G LTE Add-on
source_url: "https://gpdstore.net/product/gpd-win-max-2-4g-lte-add-on"
...
* Official GPD WIN MAX 2 2024 LTE Module
* Supporting – 4G TD-LTE, FDD-LTE, 3G CDMA.
* 4G TD-LTE, FDD-LTE, and 3G CDMA Support
* Nano-SIM Slot For Easy Use
* Quectel EG25-G Model

```
IMPORTANT
INSTALLATION REQUIRES OPENING DEVICE
COMPONENTS ARE SMALL & DELICATE
WE ARE NOT RESPONSIBLE FOR ANY CUSTOMER DAMAGE
```
