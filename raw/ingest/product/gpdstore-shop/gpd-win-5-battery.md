---
title: GPD WIN 5 Battery
source_url: "https://gpdstore.net/product/gpd-win-5-battery"
...
* **80.04Wh Capacity:** Provides extended, high-power portable gaming time.
* **5170mAh Rated Capacity:** Ensures long-lasting, reliable use on the go.
* **Modular Design:** Quick-attach mechanism for easy swapping and removal.
* **High Voltage Power:** Built to support the GPD WIN 5’s powerful APU.
* **Official GPD Accessory:** Guarantees perfect fit, compatibility, and safety.
