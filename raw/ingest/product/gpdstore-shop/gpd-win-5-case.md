---
title: GPD WIN 5 Case
source_url: "https://gpdstore.net/product/gpd-win-5-case"
...
* **Official Fit:** Designed specifically for the GPD WIN 5 handheld PC.
* **Secure Straps:** Holds the device and its external battery pack firmly in place.
* **Soft Lining:** Prevents scratches and protects the 7-inch 120Hz display.
* **Hand Strap:** Allows for easy and secure carrying on the go.
* **Hard Shell:** Provides durable, rigid protection for your high-performance gaming PC.
